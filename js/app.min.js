...
!function(){"use strict";angular.module("contractor").controller("modalInstanceCtrl",["$scope","$state","$uibModalInstance","toastr","items","FileUploader","$location","$anchorScroll","Contractors","CurrentUser","TaskTypes","Tasks","ngDialog",function(t,e,o,a,s,n,c,r,i,l,u,d,f){console.log("sulod"),t.task={},t.data={},t.task.contractors=[],t.taskTypes=[],t.priorities=[],t.items=s,t.selected={item:t.items[0]},t.totalItems=64,t.currentPage=1,t.maxSize=3,t.bigTotalItems=175,t.bigCurrentPage=1,t.contractorData=[],t.contractors=[],t.contractor=[],t.taskTypes=u.all(),t.priorities=u.priorities(),s.quoteId&&(console.log(s.quoteId),d.findById(s.taskId).then(function(e){t.task=e[0]}),t.$watch("task",function(e){t.task=e,t.data=_.find(t.task.quotes,{_id:s.quoteId}),t.data.totalMisc=parseFloat(t.data.parking_fee)+parseFloat(t.data.travel_fee),console.log("$scope.qoute: ",t.data)})),t.showConfirm=function(o){f.openConfirm({title:"",templateUrl:"./modules/main/dialog/submitQuote.html",className:"ngdialog-theme-default",scope:t}).then(function(){console.log("YES"),_.each(t.task.quotes,function(t){t._id==o._id&&(t.approved=!0)}),d.findByIdAndUpdate(s.taskId,t.task).then(function(t){console.log(t),t&&(a.success("Quote Successfully Approved."),e.go("main.admintask"))})},function(){console.log("NO")})},t.setPage=function(e){t.currentPage=e},t.scrollTo=function(t){c.hash(t),console.log(c.hash()),r()},t.pageChanged=function(){$log.log("Page changed to: "+t.currentPage)},t.myVar=!1,t.toggle=function(){t.myVar=!t.myVar};var g=t.uploader=new n({});g.filters.push({name:"customFilter",fn:function(t,e){return this.queue.length<10}}),t.ok=function(){o.close(t.selected.item)},t.cancel=function(){o.dismiss("cancel")},t.addContractoTask=function(e){console.log("con: ",e),e.checked?t.task.contractors.push(e):_.remove(t.task.contractors,function(t){return t._id==e._id}),console.log("$scope.task.contractors: ",t.task.contractors)},t.createTask=function(o){o.$valid&&(_.isEmpty(t.task)||(t.task.reporter=l.user(),_.isUndefined(t.task.priority&&t.task.tasktype&&t.task.deadline&&t.task.date_requested)?a.error("Please complete the fields."):d.create(t.task).then(function(o){o&&(a.success("Task Successfully Sent."),t.ok(),e.go("main.admindash"))})))}}])}();
