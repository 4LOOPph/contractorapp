...
!function(){"use strict";angular.module("contractor").factory("Contractors",["$q","localStorageService",function(e,r){function t(){function e(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e()}return{findAll:function(t){var o=e.defer(),n=[];if(r.isSupported){var s=JSON.parse(r.get("contactor"))||[];s&&s.length>0?_.isEmpty(t)?(n=s,o.resolve(n)):(n=_.filter(s,t),o.resolve(n)):o.resolve(n)}else o.reject("localStorage is not supported");return o.promise},create:function(o){var n=e.defer();if(r.isSupported){o._id=t();var s=JSON.parse(r.get("contactor"))||[];if(s&&s.length>0){s.push(o);var i=JSON.stringify(s),a=r.set("contactor",i);n.resolve(a)}else{var i=JSON.stringify([o]),a=r.set("contactor",i);n.resolve(a)}}else n.reject("localStorage is not supported");return n.promise},remove:function(){var t=e.defer();if(r.isSupported){var o=r.remove("contactor");t.resolve(o)}else t.reject("localStorage is not supported");return t.promise},findById:function(t){var o=e.defer(),n=[];if(r.isSupported){var s=JSON.parse(r.get("contactor"))||[];s&&s.length>0?(n=_.filter(s,{_id:t}),o.resolve(n)):o.resolve(n)}else o.reject("localStorage is not supported");return o.promise},findByIdAndRemove:function(t){var o=e.defer(),n=[];if(r.isSupported){var s=JSON.parse(r.get("contactor"))||[];s&&s.length>0?(n=_.filter(s,function(e){return e._id!==quotes._id}),o.resolve(n)):o.resolve(n)}else o.reject("localStorage is not supported");return o.promise},findByIdAndUpdate:function(t,o){var n=e.defer();if(r.isSupported){var s=JSON.parse(r.get("contactor"))||[];if(s&&s.length>0){_.each(s,function(e){e._id==t&&(e=o)});var i=JSON.stringify(s),a=r.set("contactor",i);n.resolve(a)}else n.resolve([])}else n.reject("localStorage is not supported");return n.promise},login:function(e,t){if(r.isSupported){var o=JSON.parse(r.get("contactor"))||[],n=_.find(o,{username:e,password:t});return _.isEmpty(n)?null:(delete n.password,r.set("user",JSON.stringify(n)),n)}return null}}}])}();
...
!function(){"use strict";angular.module("contractor").factory("Tasks",["$q","localStorageService",function(e,r){function t(){function e(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e()}return{find:function(t){var s=e.defer(),o=[];if(r.isSupported){var i=JSON.parse(r.get("tasks"))||[];i&&i.length>0?_.isEmpty(t)?(o=i,s.resolve(o)):(o=_.filter(i,t),s.resolve(o)):s.resolve(o)}else s.reject("localStorage is not supported");return s.promise},create:function(s){var o=e.defer();if(r.isSupported){s._id=t();var i=JSON.parse(r.get("tasks"))||[];if(i&&i.length>0){i.push(s);var n=JSON.stringify(i),a=r.set("tasks",n);o.resolve(a)}else{var n=JSON.stringify([s]),a=r.set("tasks",n);o.resolve(a)}}else o.reject("localStorage is not supported");return o.promise},remove:function(){var t=e.defer();if(r.isSupported){var s=r.remove("tasks");t.resolve(s)}else t.reject("localStorage is not supported");return t.promise},findById:function(t){var s=e.defer(),o=[];if(r.isSupported){var i=JSON.parse(r.get("tasks"))||[];i&&i.length>0?(o=_.filter(i,{_id:t}),s.resolve(o)):s.resolve(o)}else s.reject("localStorage is not supported");return s.promise},findByIdAndRemove:function(t){var s=e.defer(),o=[];if(r.isSupported){var i=JSON.parse(r.get("tasks"))||[];i&&i.length>0?(o=_.filter(i,function(e){return e._id!==quotes._id}),s.resolve(o)):s.resolve(o)}else s.reject("localStorage is not supported");return s.promise},findByIdAndUpdate:function(t,s){var o=e.defer(),i=[];if(r.isSupported){var n=JSON.parse(r.get("tasks"))||[];if(n&&n.length>0){i=_.filter(n,function(e){return e._id!==t}),i.push(s);var a=JSON.stringify(i),l=r.set("tasks",a);o.resolve(l)}else o.resolve([])}else o.reject("localStorage is not supported");return o.promise}}}])}();
...
!function(){"use strict";angular.module("contractor").controller("admindashCtrl",["$scope","$state","$uibModal","$log","FileUploader","$timeout","$location","$anchorScroll","Upload","Tasks","CurrentUser","Reports","$stateParams","Contractors","ngDialog","toastr",function(t,a,e,o,n,s,r,i,c,d,l,u,f,h,p,m){t.newdate=new Date,t.showstartCard=!0,t.showsecondCard=!1,t.showthirdCard=!1,t.items=["item1","item2","item3"],t.animationsEnabled=!0,t.toggle=!0,t.toggle2=!0,t.totalItems=64,t.currentPage=1,t.maxSize=5,t.bigTotalItems=175,t.bigCurrentPage=1,t.loading=!0,t.task={},t.progressData=[],t.pendingData=[],t.completedData=[],t.newTaskData=[],t.reportsData=[],t.tasklist=[],f.taskId?(d.findById(f.taskId).then(function(a){t.task=a[0]}),t.$watch("task",function(a){t.task=a,console.log("$scope.quotes: ",t.task.quotes),_.each(t.task.quotes,function(t){var a=0;_.each(t.descriptions,function(t){a+=parseFloat(t.rate)}),t.grossothers=a,t.totalothers=parseFloat(t.material_fee)+parseFloat(t.parking_fee)+parseFloat(t.travel_fee)+parseFloat(t.grossothers)})})):(t.task={},t.task.contractors=[],t.contractorData=[],t.contractors=[],h.findAll().then(function(a){t.contractorData=a,_.each(t.contractorData,function(t){t.checked=!1});for(var e=0;e<=2;e++)_.isUndefined(t.contractorData[e])||t.contractors.push(t.contractorData[e])},function(t){console.log("error: ",t)})),d.find().then(function(a){_.each(a,function(a){a.reporter.id==l.user().id&&(t.tasklist.push(a),console.log("row: ",a._id))})}),t.$watch("tasklist",function(a){t.newTaskData=a,_.each(t.newTaskData,function(a){var e=0,o=0,n=0;_.each(a.quotes,function(t){t.approved&&"progress"!=t.status&&"completed"!=t.status&&e++,t.approved&&"progress"==t.status&&n++,t.approved&&"completed"==t.status&&o++,_.isUndefined(t.check)||"in"!=t.check?_.isUndefined(t.check)||"out"!=t.check||(a.checkStatus="out"):a.checkStatus="in"}),e>0&&(t.pendingData.push(a),e=0),n>0&&(t.progressData.push(a),n=0),o>0&&(t.completedData.push(a),o=0)}),_.each(t.pendingData,function(a){_.remove(t.newTaskData,function(t){return t._id==a._id})}),_.each(t.progressData,function(a){_.remove(t.newTaskData,function(t){return t._id==a._id}),_.remove(t.pendingData,function(t){return t._id==a._id}),_.remove(t.completedData,function(t){return t._id==a._id})}),_.each(t.completedData,function(a){_.remove(t.newTaskData,function(t){return t._id==a._id})}),t.$broadcast("scroll.refreshComplete")}),t.reportsData=u.all(),console.log(t.reportsData),t.scrollTo=function(t){r.hash(t),console.log(r.hash()),i()},s(function(){t.loading=!1},1500),t.setPage=function(a){t.currentPage=a},t.pageChanged=function(){o.log("Page changed to: "+t.currentPage)},t.$watch("toggle",function(){t.toggleText=t.toggle?"More":"Less"}),t.$watch("toggle2",function(){t.toggleText2=t.toggle2?"More":"Less"});var g=t.uploader=new n({});g.filters.push({name:"customFilter",fn:function(t,a){return this.queue.length<10}}),t.deTails=function(t){console.log(t),a.go("main.forapprovaltask",{taskId:t._id})},t.showConfirm=function(e){p.openConfirm({title:"",templateUrl:"modules/main/dialog/submitQuote.html",className:"ngdialog-theme-default",scope:t}).then(function(){console.log("YES"),_.each(t.task.quotes,function(t){t._id==e._id&&(t.approved=!0)}),d.findByIdAndUpdate(f.taskId,t.task).then(function(t){console.log(t),t&&(m.success("Quote Successfully Approved."),a.go("main.admintask"))})},function(){console.log("NO")})},t.openListMod=function(a){var n=e.open({animation:t.animationsEnabled,size:"lg",templateUrl:"modules/admin/modal/quotelist.html",controller:"modalInstanceCtrl",resolve:{items:function(){return{quoteId:a._id,taskId:t.task._id}}}});n.result.then(function(a){t.selected=a},function(){o.info("Modal dismissed at: "+new Date)})},t.cancel=function(){$uibModalInstance.dismiss("cancel")},t.openMod=function(){var a=e.open({animation:t.animationsEnabled,size:"lg",templateUrl:"modules/admin/modal/addtask.html",controller:"modalInstanceCtrl",resolve:{items:function(){return t.items}}});a.result.then(function(a){t.selected=a},function(){o.info("Modal dismissed at: "+new Date)})},t.cancel=function(){$uibModalInstance.dismiss("cancel")},t.toggleAnimation=function(){t.animationsEnabled=!t.animationsEnabled},t.hideCard=function(){t.showstartCard=!1,t.showsecondCard=!0,t.showthirdCard=!1},t.hideCard1=function(){t.showsecondCard=!1,t.showstartCard=!0,t.showthirdCard=!1},t.hideC=function(){t.showsecondCard=!1},t.hideCard3=function(){t.showthirdCard=!0,t.showsecondCard=!1,t.showstartCard=!1},t.uploadPic=function(a){a.upload=c.upload({url:"https://angular-file-upload-cors-srv.appspot.com/upload",data:{username:t.username,file:a}}),a.upload.then(function(t){s(function(){a.result=t.data})},function(a){a.status>0&&(t.errorMsg=a.status+": "+a.data)},function(t){a.progress=Math.min(100,parseInt(100*t.loaded/t.total))})}}])}();
!function(){"use strict";angular.module("contractor").controller("modalInstanceCtrl",["$scope","$state","$uibModalInstance","toastr","items","FileUploader","$location","$anchorScroll","Contractors","CurrentUser","TaskTypes","Tasks","ngDialog",function(t,o,e,a,n,s,c,r,i,l,u,d,f){console.log("sulod"),t.task={},t.data={},t.task.contractors=[],t.taskTypes=[],t.priorities=[],t.items=n,t.selected={item:t.items[0]},t.totalItems=64,t.currentPage=1,t.maxSize=3,t.bigTotalItems=175,t.bigCurrentPage=1,t.contractorData=[],t.contractors=[],t.contractor=[],t.taskTypes=u.all(),t.priorities=u.priorities(),n.quoteId&&(console.log(n.quoteId),d.findById(n.taskId).then(function(o){t.task=o[0]}),t.$watch("task",function(o){t.task=o,t.data=_.find(t.task.quotes,{_id:n.quoteId}),t.data.totalMisc=parseFloat(t.data.parking_fee)+parseFloat(t.data.travel_fee),console.log("$scope.qoute: ",t.data)})),i.findAll().then(function(o){t.contractorData=o,_.each(t.contractorData,function(t){t.checked=!1});for(var e=0;e<=2;e++)_.isUndefined(t.contractorData[e])||t.contractors.push(t.contractorData[e]);for(var e=3;e<=o.length;e++)_.isUndefined(t.contractorData[e])||t.contractor.push(t.contractorData[e])}),t.showConfirm=function(e){f.openConfirm({title:"",templateUrl:"./modules/main/dialog/submitQuote.html",className:"ngdialog-theme-default",scope:t}).then(function(){console.log("YES"),_.each(t.task.quotes,function(t){t._id==e._id&&(t.approved=!0)}),d.findByIdAndUpdate(n.taskId,t.task).then(function(t){console.log(t),t&&(a.success("Quote Successfully Approved."),o.go("main.admintask"))})},function(){console.log("NO")})},t.setPage=function(o){t.currentPage=o},t.scrollTo=function(t){c.hash(t),console.log(c.hash()),r()},t.pageChanged=function(){$log.log("Page changed to: "+t.currentPage)},t.myVar=!1,t.toggle=function(){t.myVar=!t.myVar};var g=t.uploader=new s({});g.filters.push({name:"customFilter",fn:function(t,o){return this.queue.length<10}}),t.ok=function(){e.close(t.selected.item)},t.cancel=function(){e.dismiss("cancel")},t.addContractoTask=function(o){console.log("con: ",o),o.checked?t.task.contractors.push(o):_.remove(t.task.contractors,function(t){return t._id==o._id}),console.log("$scope.task.contractors: ",t.task.contractors)},t.createTask=function(e){e.$valid&&(_.isEmpty(t.task)||(t.task.reporter=l.user(),_.isUndefined(t.task.priority&&t.task.tasktype&&t.task.deadline&&t.task.date_requested)?a.error("Please complete the fields."):d.create(t.task).then(function(e){e&&(a.success("Task Successfully Sent."),t.ok(),o.go("main.admindash"))})))}}])}();
!function(){"use strict";function t(t,a,o,e,s,r,n){t.showstartCard=!0,t.showsecondCard=!1,t.showthirdCard=!1,t.task={},t.task.contractors=[],t.completeTask=!1,t.taskTypes=[],t.priorities=[],t.progressData=[],t.pendingData=[],t.completedData=[],t.newTaskData=[],t.reportsData=[],t.tasklist=[],s.taskId?a.findById(s.taskId).then(function(a){t.task=a[0]}):(t.task={},t.task.contractors=[],t.taskTypes=r.all(),t.priorities=r.priorities(),t.contractorData=[],t.contractors=[],t.contractor=[],o.findAll().then(function(a){t.contractorData=a,_.each(t.contractorData,function(t){t.checked=!1});for(var o=0;o<=2;o++)_.isUndefined(t.contractorData[o])||t.contractors.push(t.contractorData[o]);for(var o=2;o<=a.length;o++)_.isUndefined(t.contractorData[o])||t.contractor.push(t.contractorData[o])})),a.find().then(function(a){console.log(a),_.each(a,function(a){a.reporter.id==n.user().id&&(t.tasklist.push(a),console.log("row: ",a._id))})}),t.$watch("tasklist",function(a){t.newTaskData=a,_.each(t.newTaskData,function(a){var o=0,e=0,s=0;_.each(a.quotes,function(t){t.approved&&"progress"!=t.status&&"completed"!=t.status&&o++,t.approved&&"progress"==t.status&&s++,t.approved&&"completed"==t.status&&e++,_.isUndefined(t.check)||"in"!=t.check?_.isUndefined(t.check)||"out"!=t.check||(a.checkStatus="out"):a.checkStatus="in"}),o>0&&(t.pendingData.push(a),o=0),s>0&&(t.progressData.push(a),s=0),e>0&&(t.completedData.push(a),e=0)}),_.each(t.pendingData,function(a){_.remove(t.newTaskData,function(t){return t._id==a._id})}),_.each(t.progressData,function(a){_.remove(t.newTaskData,function(t){return t._id==a._id}),_.remove(t.pendingData,function(t){return t._id==a._id}),_.remove(t.completedData,function(t){return t._id==a._id})}),_.each(t.completedData,function(a){_.remove(t.newTaskData,function(t){return t._id==a._id})}),t.$broadcast("scroll.refreshComplete")}),s.taskId&&(a.findById(s.taskId).then(function(a){t.task=a[0]}),t.$watch("task",function(a){t.task=a,console.log("$scope.quotes: ",t.task.quotes),_.each(t.task.quotes,function(t){var a=0;_.each(t.descriptions,function(t){a+=parseFloat(t.rate)}),t.grossothers=a,t.totalothers=parseFloat(t.material_fee)+parseFloat(t.parking_fee)+parseFloat(t.travel_fee)+parseFloat(t.grossothers)})})),t.deTails=function(t){console.log(t),e.go("main.forapprovaltask",{taskId:t._id})},t.qowlist=function(t){console.log(t),e.go("main.qowlist",{taskId:t._id})},t.hideCard=function(){t.showstartCard=!1,t.showsecondCard=!0,t.showthirdCard=!1},t.hideCard1=function(){t.showsecondCard=!1,t.showstartCard=!0,t.showthirdCard=!1},t.hideC=function(){t.showsecondCard=!1},t.hideCard3=function(){t.showthirdCard=!0,t.showsecondCard=!1,t.showstartCard=!1}}angular.module("contractor").controller("admintaskCtrl",t),t.$inject=["$scope","Tasks","Contractors","$state","$stateParams","TaskTypes","CurrentUser"]}();
...
!function(){"use strict";function a(a,e,t,i,o,n,r,l,d,c){a.input=[],a.inputs=[],a.test={},a.data={},a.showstartCard=!0,a.showsecondCard=!1,a.showthirdCard=!1,a.location={},a.ratesList=[],a.rates={},a.settings={"default":function(){console.log("asdasd");var a=new Date;return a}},a.data.availabilityArr=[],a.data.coverageArr=[],a.avail={},a.area={},a.countries=n.all(),a.cities=[],a.citiesCopy=[],a.clickToCancel=function(){console.log("clickToCancel"),o.openConfirm({templateUrl:"modules/main/dialog/cancel.html",className:"ngdialog-theme-default",scope:a}).then(function(){console.log("YES"),c.remove("tmpvendor")},function(){console.log("NO")})},a.onApplyTimePicker=function(a){console.log("Time range applied."),a.preventDefault()},a.onClearTimePicker=function(){console.log("Time range current operation cancelled.")},a.baseRate=[{id:0,value:"Monday"},{id:1,value:"Tuesday"},{id:2,value:"Wednesday"},{id:3,value:"Thursday"},{id:4,value:"Friday"},{id:5,value:"Saturday"},{id:"6",value:"Sunday"}],a.getCountryState=function(e){"AUS"==e?a.states=l.all():a.states=[]},a.getCityState=function(e){console.log("getCityState: ",e),r.all(e).then(function(e){a.cities=e.data;var t=0;_.each(a.cities,function(e){a.citiesCopy.push({id:t,name:e.place_name,view:e.place_name}),t++}),console.log("$scope.citiesCopy:",a.citiesCopy)})},a.hideCard=function(){a.showstartCard=!1,a.showsecondCard=!0},a.hideCard1=function(){a.showsecondCard=!1,a.showstartCard=!0},a.hideC=function(){a.showsecondCard=!1},a.showCard3=function(){a.showthirdCard=!0},a.addSched=function(e){e&&(a.data.availabilityArr.push({availability:e.availability,start:e.start,end:e.end}),a.avail.availability="",a.avail.start="",a.avail.end="")},a.addLocation=function(e){console.log("item: ",e),e&&(a.data.coverageArr.push({area:e}),console.log(a.data.coverageArr),a.area.coverage="")},a.onApplyTimePicker=function(){console.log("Time range applied.")},a.onClearTimePicker=function(){console.log("Time range current operation cancelled.")},a.addArea=function(e){e&&(a.data.coverageArr.push({area:e}),a.area.coverage="")},a.uploadPic=function(e){e.upload=t.upload({url:"https://angular-file-upload-cors-srv.appspot.com/upload",data:{username:a.username,file:e}}),e.upload.then(function(a){i(function(){e.result=a.data})},function(e){e.status>0&&(a.errorMsg=e.status+": "+e.data)},function(a){e.progress=Math.min(100,parseInt(100*a.loaded/a.total))})},a.vendorinfo=function(){return _.isUndefined(a.area.coverage)&&a.data.coverageArr.length<1?void d.error("Some field are required!"):_.isUndefined(a.avail.availability)&&a.data.availabilityArr.length<1?void d.error("Some field are required!"):(a.avail.availability&&(a.data.availabilityArr.push({availability:a.avail.availability,start:a.avail.start,end:a.avail.end}),a.avail.availability="",a.avail.start="",a.avail.end="",e.go("payment")),a.area.coverage&&(a.data.coverageArr.push({area:a.area.coverage}),a.area.coverage="",e.go("payment")),a.data.username=_.trim(_.lowerCase(a.data.lname))+"."+_.trim(_.lowerCase(a.data.fname)),a.data.password="123456",void c.set("tmpvendor",JSON.stringify(a.data)))}}angular.module("contractor").controller("VendorInfoCtrl",a),a.$inject=["$scope","$state","Upload","$timeout","ngDialog","Country","CityState","States","toastr","localStorageService"]}();
!function(){"use strict";function a(a,t,e,o,n,c,i,s,d){console.log("vendorRatetCtrl: "),a.data={},a.rate={},a.billAdd=!1,a.inputs=[],a.test={},a.data={},a.showstartCard=!0,a.showsecondCard=!1,a.showthirdCard=!1,a.ratesList=[],a.rates={},a.countries=c.all(),a.cities=[],a.citiesCopy=[],a.banks=[],a.banksCopy=[],a.baseRate=[{id:0,value:"Base Rate"},{id:1,value:"After Hours"},{id:"2",value:"Weekend"}],a.clickToOpen=function(){console.log("clickToOpen"),t.openConfirm({templateUrl:"modules/main/dialog/submit.html",className:"ngdialog-theme-default",scope:a}).then(function(){console.log("YES")},function(){console.log("NO")})},a.clickToCancel=function(){console.log("clickToCancel"),t.openConfirm({templateUrl:"modules/main/dialog/cancel.html",className:"ngdialog-theme-default",scope:a}).then(function(){console.log("YES")},function(){console.log("NO")})},a.hideCard=function(){a.showstartCard=!1,a.showsecondCard=!0},a.hideCard1=function(){a.showsecondCard=!1,a.showstartCard=!0},a.hideC=function(){a.showsecondCard=!1},a.showCard3=function(){a.showthirdCard=!0},a.addSched=function(){a.inputs.push({})},a.removeOther=function(t){a.ratesList.splice(t,1)},n.all().then(function(t){a.banks=t.data,_.each(a.banks,function(t){a.banksCopy.push({id:t.id,name:t.name,view:t.name})})}),a.selectedCountry=function(t){console.log(t.description.id),console.log(t.originalObject),a.data.bankname=t.originalObject.name},a.getCountryState=function(t){"AUS"==t?a.states=s.all():a.states=[]},a.getCityState=function(t){console.log("getCityState: ",t),i.all(t).then(function(t){a.cities=t.data;var e=0;_.each(a.cities,function(t){a.citiesCopy.push({id:e,name:t.place_name,view:t.place_name}),e++}),console.log("$scope.citiesCopy:",a.citiesCopy)})},a.vendorRate=function(){a.data.standard||(a.data.ratestandard=""),a.data.other||(a.data.other_base_hours="",a.data.other_after_hours="",a.data.other_weekends=""),a.data.direct||(a.data.bankaccount="",a.data.bankaccountnum="",a.data.bankbranch="",a.data.bankbsb="",a.data.bankname=""),a.data.check||a.data.check_prefer_info||(a.data.check_country="",a.data.check_state="",a.data.check_city="",a.data.check_address="",a.data.check_postcode=""),console.log(a.data.bankname),d.set("tmpvendorrate",JSON.stringify(a.data)),o.go("qualification")}}angular.module("contractor").controller("vendorRatetCtrl",a),a.$inject=["$scope","ngDialog","$filter","$state","Banks","Country","CityState","States","localStorageService"]}();
!function(){"use strict";function e(e,t,o,n,l,i){e.othersList=[],e.others={},e.clickToCancel=function(){console.log("clickToCancel"),n.openConfirm({title:"sdsdsd",templateUrl:"modules/main/dialog/cancel.html",className:"ngdialog-theme-default",scope:e}).then(function(){console.log("YES")},function(){console.log("NO")})},e.clickToOpen=function(){console.log("clickToOpen"),n.openConfirm({title:"",templateUrl:"modules/main/dialog/submit.html",className:"ngdialog-theme-default",scope:e}).then(function(){console.log("YES");var o=JSON.parse(l.get("tmpvendor"))||{},n=JSON.parse(l.get("tmpvendorrate"))||{},a=_.extend(o,n,e.data);e.data=a,l.set("tmpqualification",JSON.stringify(e.data)),i.create(e.data).then(function(e){console.log("resp: ",e),e&&(l.remove("tmpvendor"),l.remove("tmpvendorrate"),t.go("applicsent",{id:o._id}))})},function(){console.log("NO")})},e.addOthers=function(t){_.isEmpty(t)||(e.othersList.push(t),e.others={})},e.removeOther=function(t){e.othersList.splice(t,1)};var a=e.uploader=new o({});a.filters.push({name:"customFilter",fn:function(e,t){return this.queue.length<10}});var c=e.uploader1=new o({});c.filters.push({name:"customFilter",fn:function(e,t){return this.queue.length<10}})}angular.module("contractor").controller("vendorQualificationCtrl",e),e.$inject=["$scope","$state","FileUploader","ngDialog","localStorageService","Contractors"]}();
