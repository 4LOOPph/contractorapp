...
!function(){"use strict";angular.module("contractor").factory("Contractors",["$q","localStorageService",function(e,r){return{findAll:function(t){var o=e.defer(),s=[];if(r.isSupported){var n=JSON.parse(r.get("contactor"))||[];n&&n.length>0?_.isEmpty(t)?(s=n,o.resolve(s)):(s=_.filter(n,t),o.resolve(s)):o.resolve(s)}else o.reject("localStorage is not supported");return o.promise},create:function(t){var o=e.defer();if(r.isSupported){t._id=guid();var s=JSON.parse(r.get("contactor"))||[];if(s&&s.length>0){s.push(t);var n=JSON.stringify(s),i=r.set("contactor",n);o.resolve(i)}else{var n=JSON.stringify([t]),i=r.set("contactor",n);o.resolve(i)}}else o.reject("localStorage is not supported");return o.promise},remove:function(){var t=e.defer();if(r.isSupported){var o=r.remove("contactor");t.resolve(o)}else t.reject("localStorage is not supported");return t.promise},findById:function(t){var o=e.defer(),s=[];if(r.isSupported){var n=JSON.parse(r.get("contactor"))||[];n&&n.length>0?(s=_.filter(n,{_id:t}),o.resolve(s)):o.resolve(s)}else o.reject("localStorage is not supported");return o.promise},findByIdAndRemove:function(t){var o=e.defer(),s=[];if(r.isSupported){var n=JSON.parse(r.get("contactor"))||[];n&&n.length>0?(s=_.filter(n,function(e){return e._id!==quotes._id}),o.resolve(s)):o.resolve(s)}else o.reject("localStorage is not supported");return o.promise},findByIdAndUpdate:function(t,o){var s=e.defer();if(r.isSupported){var n=JSON.parse(r.get("contactor"))||[];if(n&&n.length>0){_.each(n,function(e){e._id==t&&(e=o)});var i=JSON.stringify(n),a=r.set("contactor",i);s.resolve(a)}else s.resolve([])}else s.reject("localStorage is not supported");return s.promise},login:function(e,t){if(r.isSupported){var o=JSON.parse(r.get("contactor"))||[],s=_.find(o,{username:e,password:t});return _.isEmpty(s)?null:(delete s.password,r.set("user",JSON.stringify(s)),s)}return null}}}])}();
