...
!function(){"use strict";angular.module("app",["ng.deviceDetector"]).run(["$window","deviceDetector",function(e,i){var i=i;i.isDesktop()?e.location.href="./desktop.html":i.isMobile()&&!i.isTablet()?e.location.href="./mobile/index.html":i.isMobile()&&i.isTablet()&&(e.location.href="./mobile/index.html")}])}();