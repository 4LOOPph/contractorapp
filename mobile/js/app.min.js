...
!function(){"use strict";function a(a,e,t,i,r,o,n,s,c,l,u,m,d,v,f,p){a.data={},a.data.availabilityArr=[],a.data.coverageArr=[],a.avail={},a.area={},a.weekdays=r.all(),a.countries=n.all(),a.cities=[],a.citiesCopy=[],a.groups=[],a.othersList=[],a.$on("$ionicView.afterEnter",function(e,t){var i=JSON.parse(v.get("tmpvendor"))||{};_.isEmpty(i)?(a.data.username=_.trim(_.lowerCase(a.data.lname))+"."+_.trim(_.lowerCase(a.data.fname)),a.data.password="123456"):(a.data=i,a.data.username=_.trim(_.lowerCase(a.data.lname))+"."+_.trim(_.lowerCase(a.data.fname)),a.data.password="123456")}),a.goBackLogin=function(){m.nextViewOptions({disableBack:!0}),d.nextDirection("back"),u.go("login")},a.getCountryState=function(e){"AUS"==e?a.states=o.all():a.states=[]},a.getCityState=function(e){console.log("getCityState: ",e),s.all(e).then(function(e){a.cities=e.data;var t=0;_.each(a.cities,function(e){a.citiesCopy.push({id:t,name:e.place_name,view:e.place_name}),t++})})},a.callbackMethod=function(e){if(e){var t=f("filter")(a.citiesCopy,e);return{items:t}}return{items:[]}},a.itemsClicked=function(e){a.data.check_city=e.item.name},a.addArea=function(e){console.log("item: ",e),e&&(a.data.coverageArr.push({area:e}),a.area.coverage="")},a.increaseHours=function(){a.time.hours=Number(a.time.hours),12==a.mainObj.format&&(12!=a.time.hours?a.time.hours+=1:a.time.hours=1),24==a.mainObj.format&&(a.time.hours=(a.time.hours+1)%24),a.time.hours=a.time.hours<10?"0"+a.time.hours:a.time.hours},a.openTime=function(e){a.data.created=new Date,l.openTimePicker({callback:function(e){var t=Math.floor(e/60/60),i=e/60%60;a.data.created.setHours(t,i);var r=(a.data.created.getHours(),t>=12?"PM":"AM");t%=12,t=t?t:12,i=i<10?"0"+i:i,a.avail.start=t+":"+i+" "+r},inputTime:60*a.data.created.getHours()*60+60*a.data.created.getMinutes(),format:12})},a.openTime2=function(){var e=new Date;l.openTimePicker({callback:function(t){var i=Math.floor(t/60/60),r=t/60%60;e.setHours(i,r);var o=(e.getHours(),i>=12?"PM":"AM");i%=12,i=i?i:12,r=r<10?"0"+r:r,a.avail.end=i+":"+r+" "+o},inputTime:60*e.getHours()*60+60*e.getMinutes(),format:12})},a.openTime3=function(a){var e=new Date;l.openTimePicker({callback:function(t){var i=Math.floor(t/60/60),r=t/60%60;e.setHours(i,r);var o=(e.getHours(),i>=12?"PM":"AM");i%=12,i=i?i:12,r=r<10?"0"+r:r,a.start=i+":"+r+" "+o},inputTime:60*e.getHours()*60+60*e.getMinutes(),format:12})},a.openTime4=function(a){var e=new Date;l.openTimePicker({callback:function(t){var i=Math.floor(t/60/60),r=t/60%60;e.setHours(i,r);var o=(e.getHours(),i>=12?"PM":"AM");i%=12,i=i?i:12,r=r<10?"0"+r:r,a.end=i+":"+r+" "+o},inputTime:60*e.getHours()*60+60*e.getMinutes(),format:12})},a.addSched=function(e){e&&(a.data.availabilityArr.push({availability:e.availability,start:e.start,end:e.end}),a.avail.availability="",a.avail.start="",a.avail.end="")},a.showCancel=function(){t.confirm({title:"",template:"Are you sure you want to cancel application?"}).then(function(a){a&&(m.nextViewOptions({disableBack:!0}),d.nextDirection("back"),v.remove("tmpvendor"),u.go("login"))})},a.vendorinf=function(e){e.$valid&&(a.avail.availability&&(a.data.availabilityArr.push({availability:a.avail.availability,start:a.avail.start,end:a.avail.end}),a.avail.availability="",a.avail.start="",a.avail.end=""),a.area.coverage&&(a.data.coverageArr.push({area:a.area.coverage}),a.area.coverage=""),a.data.username=_.trim(_.lowerCase(a.data.lname))+"."+_.trim(_.lowerCase(a.data.fname)),a.data.password="123456",console.log("data: ",a.data),v.set("tmpvendor",JSON.stringify(a.data)),u.go("vendorRate"))}}angular.module("starter").controller("VendorInfoCtrl",a),a.$inject=["$scope","$ionicModal","$ionicPopup","$timeout","WeekDays","States","Country","CityState","Dummy","ionicTimePicker","$state","$ionicHistory","$ionicViewSwitcher","localStorageService","$filter","ionicToast"]}();
...
!function(){"use strict";function t(t,o,e,n,a,c,i,r,s,u,l,p,k,d,m){t.task={},t.task.contractors=[],t.completeTask=!1,t.taskTypes=[],t.priorities=[],t.contractorData=[],t.contractors=[],r.find().then(function(o){t.contractorData=o,_.each(t.contractorData,function(t){t.checked=!1}),t.contractors.push(t.contractorData[0]),t.contractors.push(t.contractorData[1]),t.contractors.push(t.contractorData[2])}),m.fromTemplateUrl("../mobile/templates/dialog/contractor.list.modal.html",{scope:t,animation:"slide-in-up"}).then(function(o){t.modalcontractor=o}),t.$on("$ionicView.afterEnter",function(o,e){s.taskId&&n.findById(s.taskId).then(function(o){t.task=o[0]})}),t.qowlist=function(t){k.nextDirection("forward"),o(function(){e.go("quotelist",{taskId:t._id})},250)},t.$watch("task",function(o){t.task=o,t.task.reporter=i.user(),_.isUndefined(t.task.completed)||(t.completeTask=!0),console.log("$scope.task: ",t.task)}),t.openContractorModal=function(){t.modalcontractor.show()},t.closeContractorModal=function(){t.modalcontractor.hide()},t.addContractoTask=function(o){console.log("con: ",o.checked),o.checked?t.task.contractors.push(o):_.remove(t.task.contractors,function(t){return t._id==o._id}),console.log("$scope.task.contractors: ",t.task.contractors)},t.attachedFile=function(){},t.openDatePicker=function(){u.openDatePicker({callback:function(o){console.log("Return value from the datepicker popup is sssss: "+o,new Date(o));var e=new Date(o);t.task.deadline=moment(e).format("MM-DD-YYYY")},inputDate:new Date,mondayFirst:!0,closeOnSelect:!1,templateType:"popup"})},t.openTime=function(){var o=new Date;l.openTimePicker({callback:function(e){var n=Math.floor(e/60/60),a=e/60%60;o.setHours(n,a);var c=(o.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,a=a<10?"0"+a:a,t.task.start=n+":"+a+" "+c},inputTime:60*o.getHours()*60+60*o.getMinutes(),format:12})},t.openTime2=function(){var o=new Date;l.openTimePicker({callback:function(e){var n=Math.floor(e/60/60),a=e/60%60;o.setHours(n,a);var c=(o.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,a=a<10?"0"+a:a,t.task.end=n+":"+a+" "+c},inputTime:60*o.getHours()*60+60*o.getMinutes(),format:12})},t.cancelCreateTask=function(){p.confirm({title:"",template:"Are you sure you want to cancel creating task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(n){n&&(d.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),o(function(){d.hide(),t.task={},k.nextDirection("back"),e.go("tab-procure.admintasks")},1e3))}}]})},t.createTask=function(a){_.isEmpty(t.task)||(d.show({template:'<p>Sending...</p><ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),o(function(){d.hide(),t.task.reporter=i.user(),n.create(t.task).then(function(t){t&&p.alert({title:"",template:"Your task has been sent"}).then(function(t){k.nextDirection("back"),e.go("tab-procure.admintasks")})})},1e3))},t.closeTask=function(t){p.confirm({title:"",template:"Are you sure you want to close task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(t){t&&(d.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),o(function(){d.hide(),p.alert({title:"",template:"Task has been closed"}).then(function(){e.reload()})},1e3))}}]})}}angular.module("starter").controller("ProcurementTaskCtrl",t),t.$inject=["$scope","$timeout","$state","Tasks","TaskTypes","Dummy","CurrentUser","Contractor","$stateParams","ionicDatePicker","ionicTimePicker","$ionicPopup","$ionicViewSwitcher","$ionicLoading","$ionicModal"]}();
