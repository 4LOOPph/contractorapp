...
!function(){"use strict";function t(t,n,e,o,i,a,s){console.log("ContractorReportsCtrl");var r,l;t.task={},t.assignee={},t.tasklist=[],t.currentDate=new Date,t.signature=void 0,t.filter1={yes:!1,no:!1,na:!1},t.filter2={yes:!1,no:!1,na:!1},t.filter3={yes:!1,no:!1,na:!1},t.filter4={yes:!1,no:!1,na:!1},t.filter5={yes:!1,no:!1,na:!1},t.filter6={yes:!1,no:!1,na:!1},t.filter7={yes:!1,no:!1,na:!1},t.filter8={yes:!1,no:!1,na:!1},t.filter9={yes:!1,no:!1,na:!1},t.outstandingissue="",t.test1={pass:!1,fail:!1},t.test1={pass:!1,fail:!1},t.$on("$ionicView.beforeEnter",function(n,e){i.taskId&&o.findById(i.taskId).then(function(n){t.task=n[0],_.each(t.task.quotes,function(n){n.contractor._id==a.user()._id&&(t.assignee=n.contractor)})})}),t.$watch("task",function(n){t.task=n,console.log("$scope.task: ",t.task)}),t.$watch("filter1",function(t){console.log("$scope.filter1: ",t)}),s.fromTemplateUrl("./templates/dialog/signature.modal.html",{scope:t,animation:"slide-in-up"}).then(function(n){t.signatureModal=n}),t.openSignatureModal=function(){t.signatureModal.show(),r=document.getElementById("signatureCanvas"),l=new SignaturePad(r),l.minWidth=1,l.maxWidth=1.5,l.dotSize=3,l.backgroundColor="rgb(255, 255, 255)"},t.closeSignatureModal=function(){t.signatureModal.hide()},t.clearCanvas=function(){l.clear()},t.saveCanvas=function(){if(void 0!=l){var n=l.toDataURL("image/png");t.signature=n}},t.$on("$destroy",function(){t.signatureModal.remove(),t.signature=void 0}),t.$on("modal.hidden",function(){t.signature=void 0}),t.complete=function(){result&&$ionicPopup.confirm({title:"",template:"Send report?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(t){t&&($ionicLoading.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),n(function(){$ionicLoading.hide()},1e3))}}]})}}angular.module("starter").controller("ContractorReportsCtrl",t),t.$inject=["$scope","$timeout","$state","Tasks","$stateParams","CurrentUser","$ionicModal"]}();
