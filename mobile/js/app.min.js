...
!function(){"use strict";function t(t,e,n,o,i,s,c,a,r){t.selectedTask={},t.toggle=!0,t.$on("$ionicView.afterEnter",function(e,n){t.$parent.doAllTaskRefresh()}),t.$on("showTaskInfo",function(e,n){t.$parent.closependingModal(),t.$parent.closenewtaskModal(),t.$parent.closecompleted_ContractorModal(),t.deTails(n.type,n.taskId)}),t.$on("startTaskPending",function(e,n){t.startTask(n.taskId)}),t.checkInOut=function(o){console.log("task: ",o),t.selectedTask=o;var l=_.filter(t.tasklist,function(t){return"in"==t.checkStatus});if("in"==o.checkStatus)i.confirm({title:"<h4>Check-out to pause task</h4>",templateUrl:"./templates/dialog/checkout.html",scope:t,buttons:[{text:"Cancel"},{text:"OK",type:"button-positive",onTap:function(l){l&&(console.log("$scope.toggle: ",t.toggle),c.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),s.closeOptionButtons(),_.each(o.quotes,function(e){e.contractor._id==a.user()._id&&e.approved&&(e.status="progress",t.toggle&&(e.check="out"))}),r.findByIdAndUpdate(o._id,o).then(function(t){t&&n(function(){c.hide(),i.alert({title:"",template:"Task checked out"}).then(function(t){e.go(e.current,null,{reload:!0})})},1e3)}))}}]});else{if(l.length>=1)return s.closeOptionButtons(),void i.alert({template:"You are currently check-in to other task. <br> Please check-out."});i.confirm({title:"<h4>Check-in to resume task</h4>",templateUrl:"../mobile/templates/dialog/checkin.html",scope:t,buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(l){l&&(c.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),s.closeOptionButtons(),_.each(o.quotes,function(e){e.contractor._id==a.user()._id&&e.approved&&(e.status="progress",t.toggle?e.check="out":e.check="in")}),r.findByIdAndUpdate(o._id,o).then(function(t){t&&n(function(){c.hide(),i.alert({title:"",template:"Task checked in"}).then(function(t){e.go(e.current,null,{reload:!0})})},1e3)}))}}]})}},t.completeTask=function(o){t.selectedTask=o,i.show({title:"<h4>Check-out to complete task</h4>",templateUrl:"../mobile/templates/dialog/checkout.html",scope:t,buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(t){t&&(c.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),s.closeOptionButtons(),_.each(o.quotes,function(t){t.contractor._id==a.user()._id&&t.approved&&(t.status="completed",t.check="out")}),o.completed=new Date,r.findByIdAndUpdate(o._id,o).then(function(t){t&&n(function(){c.hide(),i.alert({title:"",template:"Task successfully completed"}).then(function(t){"High"==o.priority?e.go("installationreport",{taskId:o._id}):"Medium"==o.priority?e.go("reporting",{taskId:o._id}):"Low"==o.priority&&e.go("sitesurvey",{taskId:o._id})})},1e3)}))}}]})},t.completedTask=function(t){o.nextDirection("forward"),n(function(){e.go("completedtask")},100)},t.showConfirm=function(){i.confirm({title:"",template:"Are you sure you want to assign the task to Lorem Impatsu?"}).then(function(t){t&&(o.nextDirection("forward"),e.go("approve"))})},t.clickDecline=function(t){i.confirm({title:"Decline Task?",template:"Are you sure you want to decline on this task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(o){if(o){c.show({template:'<p>Declining...</p><ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),s.closeOptionButtons();var l=0;_.each(t.quotes,function(e){e.contractor._id==a.user()._id&&(t.quotes.splice(l,1),l++)}),r.findByIdAndUpdate(t._id,t).then(function(t){t&&n(function(){c.hide(),i.alert({title:"",template:"Task successfully declined"}).then(function(t){e.reload()})},600)})}}}]})},t.deTails=function(t,i){s.closeOptionButtons(),o.nextDirection("forward"),n(function(){"progress"==t?e.go("task-detail-progress",{taskId:i._id}):"pending"==t?e.go("task-detail-pending",{taskId:i._id}):"new"==t?e.go("task-detail-new",{taskId:i._id}):"completed"==t&&e.go("task-detail",{taskId:i._id})},250)},t.toggleCheckInOut=function(){t.toggle=!t.toggle},t.startTask=function(o){t.selectedTask=o;var l=0;return _.each(t.$parent.pendingData,function(t){_.each(t.quotes,function(t){t.contractor._id==a.user()._id&&t.approved&&l++})}),l>=3?void i.alert({template:"You are currently check-in to 3 task. <br> Please check-out."}):void i.confirm({title:"<h4>Check-in to start task</h4>",templateUrl:"./templates/dialog/checkin.html",scope:t,buttons:[{text:"Cancel"},{text:"OK",type:"button-positive",onTap:function(l){if(l){var u=_.filter(t.tasklist,function(t){return"in"==t.checkStatus});if(u.length>=1)return s.closeOptionButtons(),void i.alert({template:"You are currently check-in to other task. <br> Please check-out."});c.show({template:'<p>Starting...</p><ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),s.closeOptionButtons(),_.each(o.quotes,function(e){e.contractor._id==a.user()._id&&e.approved&&(e.status="progress",t.toggle?e.check="out":e.check="in")}),r.findByIdAndUpdate(o._id,o).then(function(t){t&&n(function(){c.hide(),i.alert({title:"",template:"Task checked in"}).then(function(t){e.go(e.current,null,{reload:!0})})},1e3)})}}}]})},t.newTaskqow=function(i){t.$parent.closenewtaskModal(),o.nextDirection("forward"),s.closeOptionButtons(),n(function(){e.go("qow",{taskId:i._id})},250)},t.$on("submitQOW",function(e,n){t.$parent.closependingModal(),t.newTaskqow(n.taskId)}),t.$on("declineTaskOW",function(e,n){t.clickDecline(n.taskId)}),t.doTaskRefresh=function(){n(function(){t.$broadcast("scroll.refreshComplete")},2e3)}}angular.module("starter").controller("ContractorTasksCtrl",t),t.$inject=["$scope","$state","$timeout","$ionicViewSwitcher","$ionicPopup","$ionicListDelegate","$ionicLoading","CurrentUser","Tasks"]}();
...
!function(){"use strict";function t(t,e,n,o,i,a,s,r,c,l,p,u,k,d){t.task={},t.task.contractors=[],t.completeTask=!1,t.taskTypes=[],t.priorities=[],d.fromTemplateUrl("../mobile/templates/dialog/contractor.list.modal.html",{scope:t,animation:"slide-in-up"}).then(function(e){t.modalcontractor=e}),t.$on("$ionicView.afterEnter",function(e,n){r.taskId?o.findById(r.taskId).then(function(e){t.task=e[0]}):(t.task=a.task(),t.taskTypes=i.all(),t.priorities=i.priorities())}),t.qowlist=function(t){u.nextDirection("forward"),e(function(){n.go("quotelist",{taskId:t._id})},250)},t.$watch("task",function(e){t.task=e,t.task.reporter=s.user(),_.isUndefined(t.task.completed)||(t.completeTask=!0),console.log("$scope.task: ",t.task)}),t.openContractorModal=function(){t.modalcontractor.show()},t.closeContractorModal=function(){t.modalcontractor.hide()},t.addContractoTask=function(e){e.checked?t.task.contractors.push(e):_.remove(t.task.contractors,function(t){return t._id==e._id}),console.log("$scope.task.contractors: ",t.task.contractors)},t.attachedFile=function(){},t.openDatePicker=function(){c.openDatePicker({callback:function(e){console.log("Return value from the datepicker popup is sssss: "+e,new Date(e));var n=new Date(e);t.task.deadline=moment(n).format("MM-DD-YYYY")},inputDate:new Date,mondayFirst:!0,closeOnSelect:!1,templateType:"popup"})},t.openTime=function(){var e=new Date;l.openTimePicker({callback:function(n){var o=Math.floor(n/60/60),i=n/60%60;e.setHours(o,i);var a=(e.getHours(),o>=12?"PM":"AM");o%=12,o=o?o:12,i=i<10?"0"+i:i,t.task.start=o+":"+i+" "+a},inputTime:60*e.getHours()*60+60*e.getMinutes(),format:12})},t.openTime2=function(){var e=new Date;l.openTimePicker({callback:function(n){var o=Math.floor(n/60/60),i=n/60%60;e.setHours(o,i);var a=(e.getHours(),o>=12?"PM":"AM");o%=12,o=o?o:12,i=i<10?"0"+i:i,t.task.end=o+":"+i+" "+a},inputTime:60*e.getHours()*60+60*e.getMinutes(),format:12})},t.cancelCreateTask=function(){k.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),e(function(){k.hide(),t.task={},u.nextDirection("back"),n.go("tab-procure.admintasks")},1e3)},t.createTask=function(i){_.isEmpty(t.task)||(k.show({template:'<p>Sending...</p><ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),e(function(){k.hide(),t.task.reporter=s.user(),o.create(t.task).then(function(t){t&&p.alert({title:"",template:"Your task has been sent"}).then(function(t){u.nextDirection("back"),n.go("tab-procure.admintasks")})})},1e3))},t.closeTask=function(t){p.confirm({title:"",template:"Are you sure you want to close task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(t){t&&(k.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),e(function(){k.hide(),p.alert({title:"",template:"Task has been closed"}).then(function(){n.reload()})},1e3))}}]})}}angular.module("starter").controller("ProcurementTaskCtrl",t),t.$inject=["$scope","$timeout","$state","Tasks","TaskTypes","Dummy","CurrentUser","$stateParams","ionicDatePicker","ionicTimePicker","$ionicPopup","$ionicViewSwitcher","$ionicLoading","$ionicModal"]}();
