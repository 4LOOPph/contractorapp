...
!function(){"use strict";function t(t,e,n,o,i,s,c,a,r){t.selectedTask={},t.toggle=!0,t.$on("$ionicView.afterEnter",function(e,n){t.$parent.doAllTaskRefresh()}),t.$on("showTaskInfo",function(e,n){t.$parent.closependingModal(),t.$parent.closenewtaskModal(),t.$parent.closecompleted_ContractorModal(),t.deTails(n.type,n.taskId)}),t.$on("startTaskPending",function(e,n){t.startTask(n.taskId)}),t.checkInOut=function(e){console.log("task: ",e),t.selectedTask=e;var o=_.filter(t.$parent.tasklist,function(t){return"in"==t.checkStatus});if("in"==e.checkStatus)i.confirm({title:"<h4>Check-out to pause task</h4>",templateUrl:"./templates/dialog/checkout.html",scope:t,buttons:[{text:"Cancel",onTap:function(t){s.closeOptionButtons()}},{text:"OK",type:"button-positive",onTap:function(o){o?(console.log("$scope.toggle: ",t.toggle),c.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),s.closeOptionButtons(),_.each(e.quotes,function(e){e.contractor._id==a.user()._id&&e.approved&&(e.status="progress",t.toggle&&(e.check="out"))}),r.findByIdAndUpdate(e._id,e).then(function(e){e&&n(function(){c.hide(),i.alert({title:"",template:"Task checked out"}).then(function(e){t.$parent.doAllTaskRefresh()})},1e3)})):s.closeOptionButtons()}}]});else{if(o.length>=1)return s.closeOptionButtons(),void i.alert({template:"You are currently check-in to other task. <br> Please check-out."});i.confirm({title:"<h4>Check-in to resume task</h4>",templateUrl:"../mobile/templates/dialog/checkin.html",scope:t,buttons:[{text:"NO",onTap:function(t){s.closeOptionButtons()}},{text:"YES",type:"button-positive",onTap:function(o){o?(c.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),s.closeOptionButtons(),_.each(e.quotes,function(e){e.contractor._id==a.user()._id&&e.approved&&(e.status="progress",t.toggle?e.check="out":e.check="in")}),r.findByIdAndUpdate(e._id,e).then(function(e){e&&n(function(){c.hide(),i.alert({title:"",template:"Task checked in"}).then(function(e){t.$parent.doAllTaskRefresh()})},1e3)})):s.closeOptionButtons()}}]})}},t.completeTask=function(o){t.selectedTask=o,i.show({title:"<h4>Check-out to complete task</h4>",templateUrl:"../mobile/templates/dialog/checkout.html",scope:t,buttons:[{text:"NO",onTap:function(t){s.closeOptionButtons()}},{text:"YES",type:"button-positive",onTap:function(t){t?(c.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),s.closeOptionButtons(),_.each(o.quotes,function(t){t.contractor._id==a.user()._id&&t.approved&&(t.status="completed",t.check="out")}),o.completed=new Date,r.findByIdAndUpdate(o._id,o).then(function(t){t&&n(function(){c.hide(),i.alert({title:"",template:"Task successfully completed"}).then(function(t){"High"==o.priority?e.go("installationreport",{taskId:o._id}):"Medium"==o.priority?e.go("reporting",{taskId:o._id}):"Low"==o.priority&&e.go("sitesurvey",{taskId:o._id})})},1e3)})):s.closeOptionButtons()}}]})},t.completedTask=function(t){o.nextDirection("forward"),n(function(){e.go("completedtask")},100)},t.showConfirm=function(){i.confirm({title:"",template:"Are you sure you want to assign the task to Lorem Impatsu?"}).then(function(t){t&&(o.nextDirection("forward"),e.go("approve"))})},t.clickDecline=function(t){i.confirm({title:"Decline Task?",template:"Are you sure you want to decline on this task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(o){if(o){c.show({template:'<p>Declining...</p><ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),s.closeOptionButtons();var l=0;_.each(t.quotes,function(e){e.contractor._id==a.user()._id&&(t.quotes.splice(l,1),l++)}),r.findByIdAndUpdate(t._id,t).then(function(t){t&&n(function(){c.hide(),i.alert({title:"",template:"Task successfully declined"}).then(function(t){e.reload()})},600)})}}}]})},t.deTails=function(t,i){s.closeOptionButtons(),o.nextDirection("forward"),n(function(){"progress"==t?e.go("task-detail-progress",{taskId:i._id}):"pending"==t?e.go("task-detail-pending",{taskId:i._id}):"new"==t?e.go("task-detail-new",{taskId:i._id}):"completed"==t&&e.go("task-detail",{taskId:i._id})},250)},t.toggleCheckInOut=function(){t.toggle=!t.toggle},t.startTask=function(o){t.selectedTask=o;var l=0;return _.each(t.$parent.pendingData,function(t){_.each(t.quotes,function(t){t.contractor._id==a.user()._id&&t.approved&&l++})}),l>=3?void i.alert({template:"You are currently check-in to 3 task. <br> Please check-out."}):void i.confirm({title:"<h4>Check-in to start task</h4>",templateUrl:"./templates/dialog/checkin.html",scope:t,buttons:[{text:"Cancel",onTap:function(t){s.closeOptionButtons()}},{text:"OK",type:"button-positive",onTap:function(l){if(l){var u=_.filter(t.tasklist,function(t){return"in"==t.checkStatus});if(u.length>=1)return s.closeOptionButtons(),void i.alert({template:"You are currently check-in to other task. <br> Please check-out."});c.show({template:'<p>Starting...</p><ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),s.closeOptionButtons(),_.each(o.quotes,function(e){e.contractor._id==a.user()._id&&e.approved&&(e.status="progress",t.toggle?e.check="out":e.check="in")}),r.findByIdAndUpdate(o._id,o).then(function(t){t&&n(function(){c.hide(),i.alert({title:"",template:"Task checked in"}).then(function(t){e.go(e.current,null,{reload:!0})})},1e3)})}else s.closeOptionButtons()}}]})},t.newTaskqow=function(i){t.$parent.closenewtaskModal(),o.nextDirection("forward"),s.closeOptionButtons(),n(function(){e.go("qow",{taskId:i._id})},250)},t.$on("submitQOW",function(e,n){t.$parent.closependingModal(),t.newTaskqow(n.taskId)}),t.$on("declineTaskOW",function(e,n){t.clickDecline(n.taskId)}),t.doTaskRefresh=function(){n(function(){t.$broadcast("scroll.refreshComplete")},2e3)}}angular.module("starter").controller("ContractorTasksCtrl",t),t.$inject=["$scope","$state","$timeout","$ionicViewSwitcher","$ionicPopup","$ionicListDelegate","$ionicLoading","CurrentUser","Tasks"]}();
...
!function(){"use strict";function n(n,t,e,o,i,a,s){console.log("ContractorReportsCtrl");var r,c;n.task={},n.assignee={},n.tasklist=[],n.currentDate=new Date,n.signature=void 0,n.filter1={yes:!1,no:!1,na:!1},n.filter2={yes:!1,no:!1,na:!1},n.filter3={yes:!1,no:!1,na:!1},n.filter4={yes:!1,no:!1,na:!1},n.filter5={yes:!1,no:!1,na:!1},n.filter6={yes:!1,no:!1,na:!1},n.filter7={yes:!1,no:!1,na:!1},n.filter8={yes:!1,no:!1,na:!1},n.filter9={yes:!1,no:!1,na:!1},n.$on("$ionicView.beforeEnter",function(t,e){i.taskId&&o.findById(i.taskId).then(function(t){n.task=t[0],_.each(n.task.quotes,function(t){t.contractor._id==a.user()._id&&(n.assignee=t.contractor)})})}),n.$watch("task",function(t){n.task=t,console.log("$scope.task: ",n.task)}),n.$watch("filter1",function(n){console.log("$scope.filter1: ",n)}),s.fromTemplateUrl("./templates/dialog/signature.modal.html",{scope:n,animation:"slide-in-up"}).then(function(t){n.signatureModal=t}),n.openSignatureModal=function(){n.signatureModal.show(),r=document.getElementById("signatureCanvas"),c=new SignaturePad(r),c.minWidth=1,c.maxWidth=1.5,c.dotSize=3,c.backgroundColor="rgb(255, 255, 255)"},n.closeSignatureModal=function(){n.signatureModal.hide()},n.clearCanvas=function(){c.clear()},n.saveCanvas=function(){if(void 0!=c){var t=c.toDataURL("image/png");n.signature=t}},n.$on("$destroy",function(){n.signatureModal.remove(),n.signature=void 0}),n.$on("modal.hidden",function(){n.signature=void 0}),n.complete=function(){result&&$ionicPopup.confirm({title:"",template:"Send report?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(n){n&&($ionicLoading.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),t(function(){$ionicLoading.hide()},1e3))}}]})}}angular.module("starter").controller("ContractorReportsCtrl",n),n.$inject=["$scope","$timeout","$state","Tasks","$stateParams","CurrentUser","$ionicModal"]}();
!function(){"use strict";function t(t,a,e,o,n,i,r,s,l,d){function c(){function t(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return t()+t()+"-"+t()+"-"+t()+"-"+t()+"-"+t()+t()+t()}t.contacts=[],t.newUser={},t.data={},t.data.totalrate=0,t.data.numhours=0,t.data.totalqoute=0,t.data.material_fee=0,t.data.parking_fee=0,t.data.material_fee=0,t.data.travel_fee=0,t.data.descriptions=[],t.data.contractor={},t.data.approved=!1,t.task={},t.task.quotes=[],i.fromTemplateUrl("./templates/dialog/addmaterial.html",{scope:t,animation:"slide-in-up"}).then(function(a){t.modal=a}),t.$on("modal.hidden",function(){t.newUser={},t.calculateTotal()}),i.fromTemplateUrl("./templates/dialog/qow.modal.html",{scope:t,animation:"slide-in-up"}).then(function(a){t.previewModal=a}),n.taskId&&o.findById(n.taskId).then(function(a){t.task=a[0]}),t.$watch("task",function(a){t.task=a}),t.openModal=function(){t.modal.show()},t.closeModal=function(){t.modal.hide()},t.calculateRate=function(a){t.data.totalrate=45*a,t.calculateTotal()},t.calculateTotal=function(){var a=0,e=parseFloat(t.data.totalrate)+parseFloat(t.data.material_fee)+parseFloat(t.data.parking_fee)+parseFloat(t.data.travel_fee);_.each(t.data.descriptions,function(t){a+=parseFloat(t.rate)}),t.data.totalqoute=e+a},t.createContact=function(a){a&&(t.data.descriptions.push({name:a.itemName,description:a.description,rate:a.rate}),t.modal.hide())},t.previewQoute=function(a){t.previewModal.show()},t.quotsub=function(){r.confirm({title:"",template:"Submit Quote?"}).then(function(i){i&&(d.show({template:'<p>Sending...</p><ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),t.data._id=c(),t.data.contractor=l.user(),t.task.quotes.push(t.data),console.log("$scope.task: ",t.task),o.findByIdAndUpdate(n.taskId,t.task).then(function(t){t&&a(function(){d.hide(),r.alert({title:"",template:"Quote successfully send.."}).then(function(t){s.nextDirection("back"),e.go("tab.tasks")})},600)}))})}}angular.module("starter").controller("ContractorQOWCtrl",t),t.$inject=["$scope","$timeout","$state","Tasks","$stateParams","$ionicModal","$ionicPopup","$ionicViewSwitcher","CurrentUser","$ionicLoading"]}();
...
!function(){"use strict";angular.module("starter").factory("Tasks",["$q","localStorageService",function(r,e){function t(){function r(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return r()+r()+"-"+r()+"-"+r()+"-"+r()+"-"+r()+r()+r()}var s=this;return s.find=function(t){var s=r.defer(),o=[];if(e.isSupported){var n=JSON.parse(e.get("tasks"))||[];return n&&n.length>0?_.isEmpty(t)?(o=n,s.resolve(o)):(o=_.filter(n,t),s.resolve(o)):s.resolve(o),s.promise}return new Error("localStorage is not supported")},s.create=function(s){var o=r.defer();if(e.isSupported){s._id=t();var n=JSON.parse(e.get("tasks"))||[];if(n&&n.length>0){n.push(s);var i=JSON.stringify(n),a=e.set("tasks",i);o.resolve(a)}else{var i=JSON.stringify([s]),a=e.set("tasks",i);o.resolve(a)}return o.promise}return new Error("localStorage is not supported")},s.remove=function(){var t=r.defer();if(!e.isSupported)return new Error("localStorage is not supported");var s=e.remove("tasks");return t.resolve(s),t.promise},s.findById=function(t){var s=r.defer(),o=[];if(e.isSupported){var n=JSON.parse(e.get("tasks"))||[];return n&&n.length>0?(o=_.filter(n,{_id:t}),s.resolve(o)):s.resolve(o),s.promise}return new Error("localStorage is not supported")},s.findByIdAndRemove=function(t){var s=r.defer(),o=[];if(e.isSupported){var n=JSON.parse(e.get("tasks"))||[];return n&&n.length>0?(o=_.filter(n,function(r){return r._id!==quotes._id}),s.resolve(o)):s.resolve(o),s.promise}return new Error("localStorage is not supported")},s.findByIdAndUpdate=function(t,s){var o=r.defer(),n=[];if(e.isSupported){var i=JSON.parse(e.get("tasks"))||[];if(i&&i.length>0){n=_.filter(i,function(r){return r._id!==t}),n.push(s);var a=JSON.stringify(n),u=e.set("tasks",a);o.resolve(u)}else o.resolve([]);return o.promise}return new Error("localStorage is not supported")},s}])}();
