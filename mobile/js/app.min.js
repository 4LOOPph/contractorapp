...
!function(){"use strict";function o(o,i,e,t,r,c,n,a,s,d,l){i.ready(function(){window.cordova&&window.cordova.plugins&&window.cordova.plugins.Keyboard&&(cordova.plugins.Keyboard.hideKeyboardAccessoryBar(!0),cordova.plugins.Keyboard.disableScroll(!0)),window.StatusBar&&StatusBar.styleDefault()});var t=t;t.isDesktop()&&(e.location.href="../desktop.html"),o.showPopoveredit=function(i){o.popover1.show(i)},o.myGoBack=function(){console.log("myGoBack"),c.nextDirection("back"),e.history.back()},o.signOut=function(){o.$broadcast("closeProfilePopover"),c.nextDirection("back"),n.remove("user"),a(function(){s.go("login")},100)}}angular.module("starter").run(o),o.$inject=["$rootScope","$ionicPlatform","$window","deviceDetector","$ionicHistory","$ionicViewSwitcher","localStorageService","$timeout","$state","$ionicNavBarDelegate","$ionicPopup"]}();
