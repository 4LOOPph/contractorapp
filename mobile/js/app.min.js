...
!function(){"use strict";function o(o,n,e,i,t,s,r,c,u,a){o.data={},o.others={},o.groups=[],o.othersList=[],o.filenames=[],u.showBackButton(!0);for(var l=0;l<1;l++){o.groups[l]={name:l,items:[]};for(var p=0;p<1;p++)o.groups[l].items.push(l+"-"+p)}o.toggleGroup=function(n){o.isGroupShown(n)?o.shownGroup=null:o.shownGroup=n},o.isGroupShown=function(n){return o.shownGroup===n},o.removeOther=function(n){o.othersList.splice(n,1)},o.addOthers=function(n){_.isEmpty(n)||(o.othersList.push(n),o.others={})},o.uploadFiles=function(n){var i=n.files,t=[];for(l=0;l<i.length;l++)t.push(i[l].name);o.files=i,e(function(){o.$apply(function(){o.filenames=t})},10),console.log(i,t)},o.removetest=function(n){o.filenames.splice(n,1)},o.showCancel=function(){n.confirm({title:"",template:"Are you sure you want to cancel application?"}).then(function(o){o?(t.nextViewOptions({disableBack:!0}),s.nextDirection("back"),i.go("login")):console.log("You are not sure")})},o.showConfirm=function(){n.confirm({title:"",template:"Are you sure you want to submit application?"}).then(function(o){o?(a.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),t.nextViewOptions({disableBack:!0}),s.nextDirection("forward"),e(function(){a.hide(),i.go("sent")},1e3)):console.log("You are not sure")})}}angular.module("starter").controller("VendorQualificationCtrl",o),o.$inject=["$scope","$ionicPopup","$timeout","$state","$ionicHistory","$ionicViewSwitcher","localStorageService","$filter","$ionicNavBarDelegate","$ionicLoading"]}();
