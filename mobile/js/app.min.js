...
!function(){"use strict";function e(e,r){e.profile={},e.$on("$ionicView.beforeEnter",function(n,o){e.profile=r.user()})}angular.module("starter").controller("UserProfileCtrl",e),e.$inject=["$scope","CurrentUser"]}();
