...
!function(){"use strict";function e(e,t,n,i,o,a,r,s,d,c){e.data={username:"",password:"",usertype:""},e.$on("$ionicView.beforeEnter",function(t,n){e.data={username:"",password:"",usertype:""},r.showBackButton(!1)}),e.inputType="password",e.showStr="show",e.hideShowPassword=function(){"password"==e.inputType?(e.inputType="text",e.showStr="hide"):(e.inputType="password",e.showStr="show")},e.login=function(a){if(t.nextDirection("forward"),s.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),_.isEmpty(e.data.username)&&_.isEmpty(e.data.password))s.hide(),i.alert({title:"Invalid Account",template:"Username and Password are required!!!"});else if(_.isEmpty(e.data.username)||_.isEmpty(e.data.password))s.hide(),i.alert({title:"Invalid Account",template:"Username and Password are required!!!"});else{var r=d.login(e.data.username,e.data.password),l=c.login(e.data.username,e.data.password);if(!_.isNull(r))return void o(function(){s.hide(),a.$setPristine(),n.go("tab-procure.admindash")},1e3);if(!_.isNull(l))return void o(function(){s.hide(),a.$setPristine(),n.go("tab.dash")},1e3);_.isNull(r)?o(function(){s.hide(),i.alert({title:"Invalid Account",template:"Username and Password not match!!!"})},600):_.isNull(l)&&o(function(){s.hide(),i.alert({title:"Invalid Account",template:"Username and Password not match!!!"})},600)}},e.applyAsContractor=function(){console.log("applyAsContractor"),t.nextDirection("forward"),n.go("vendorInfo")}}function t(e,t,n,i){e.sent=function(){i.nextViewOptions({disableBack:!0}),t.nextDirection("forward"),n.go("login")}}angular.module("starter").controller("LoginCtrl",e).controller("sentCtrl",t),t.$inject=["$scope","$ionicViewSwitcher","$state","$ionicHistory"],e.$inject=["$scope","$ionicViewSwitcher","$state","$ionicPopup","$timeout","$ionicHistory","$ionicNavBarDelegate","$ionicLoading","ProcurementManager","Contractor"]}();
...
!function(){"use strict";function t(t,e,o,n,a,c,r,i,s,u,p,l,k,d,f){t.task={},t.task.contractors=[],t.completeTask=!1,t.taskTypes=[],t.priorities=[],t.contractorData=[],t.contractors=[],i.find().then(function(e){t.contractorData=e,_.each(t.contractorData,function(t){t.checked=!1}),t.contractors.push(t.contractorData[0]),t.contractors.push(t.contractorData[1]),t.contractors.push(t.contractorData[2])}),f.fromTemplateUrl("../mobile/templates/dialog/contractor.list.modal.html",{scope:t,animation:"slide-in-up"}).then(function(e){t.modalcontractor=e}),t.$on("$ionicView.afterEnter",function(e,o){s.taskId?n.findById(s.taskId).then(function(e){t.task=e[0]}):(t.task={},t.task.contractors=[],t.taskTypes=a.all(),t.priorities=a.priorities(),i.find().then(function(e){t.contractorData=e,_.each(t.contractorData,function(t){t.checked=!1}),t.contractors.push(t.contractorData[0]),t.contractors.push(t.contractorData[1]),t.contractors.push(t.contractorData[2])}))}),t.qowlist=function(t){k.nextDirection("forward"),e(function(){o.go("quotelist",{taskId:t._id})},250)},t.$watch("task",function(e){t.task=e,t.task.reporter=r.user(),_.isUndefined(t.task.completed)||(t.completeTask=!0),console.log("$scope.task: ",t.task)}),t.openContractorModal=function(){t.modalcontractor.show()},t.closeContractorModal=function(){t.modalcontractor.hide()},t.addContractoTask=function(e){console.log("con: ",e.checked),e.checked?t.task.contractors.push(e):_.remove(t.task.contractors,function(t){return t._id==e._id}),console.log("$scope.task.contractors: ",t.task.contractors)},t.attachedFile=function(){},t.openDatePicker=function(){u.openDatePicker({callback:function(e){console.log("Return value from the datepicker popup is sssss: "+e,new Date(e));var o=new Date(e);t.task.deadline=moment(o).format("MM-DD-YYYY")},inputDate:new Date,mondayFirst:!0,closeOnSelect:!1,templateType:"popup"})},t.openTime=function(){var e=new Date;p.openTimePicker({callback:function(o){var n=Math.floor(o/60/60),a=o/60%60;e.setHours(n,a);var c=(e.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,a=a<10?"0"+a:a,t.task.start=n+":"+a+" "+c},inputTime:60*e.getHours()*60+60*e.getMinutes(),format:12})},t.openTime2=function(){var e=new Date;p.openTimePicker({callback:function(o){var n=Math.floor(o/60/60),a=o/60%60;e.setHours(n,a);var c=(e.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,a=a<10?"0"+a:a,t.task.end=n+":"+a+" "+c},inputTime:60*e.getHours()*60+60*e.getMinutes(),format:12})},t.openDateRequestedPicker=function(){u.openDatePicker({callback:function(e){console.log("Return value from the datepicker popup is sssss: "+e,new Date(e));var o=new Date(e);t.task.date_requested=moment(o).format("MM-DD-YYYY")},inputDate:new Date,mondayFirst:!0,closeOnSelect:!1,templateType:"popup"})},t.cancelCreateTask=function(){l.confirm({title:"",template:"Are you sure you want to cancel creating task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(n){n&&(d.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),e(function(){d.hide(),t.task={},k.nextDirection("back"),o.go("tab-procure.admintasks")},1e3))}}]})},t.createTask=function(a){a.$valid&&(_.isEmpty(t.task)||(d.show({template:'<p>Sending...</p><ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),e(function(){d.hide(),t.task.reporter=r.user(),a.$setPristine(),n.create(t.task).then(function(t){t&&l.alert({title:"",template:"Your task has been sent"}).then(function(t){k.nextDirection("back"),o.go("tab-procure.admintasks",null,{reload:!0})})})},1e3)))},t.closeTask=function(t){l.confirm({title:"",template:"Are you sure you want to close task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(t){t&&(d.show({template:'<ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),e(function(){d.hide(),l.alert({title:"",template:"Task has been closed"}).then(function(){o.reload()})},1e3))}}]})}}angular.module("starter").controller("ProcurementTaskCtrl",t),t.$inject=["$scope","$timeout","$state","Tasks","TaskTypes","Dummy","CurrentUser","Contractor","$stateParams","ionicDatePicker","ionicTimePicker","$ionicPopup","$ionicViewSwitcher","$ionicLoading","$ionicModal"]}();
