...
!function(){"use strict";function t(t,o,e,n,i,a,s,r,c,u,d,l,f){t.$on("$ionicView.beforeEnter",function(o,e){d.taskId&&(u.findById(d.taskId).then(function(o){t.task=o[0]}),t.$watch("task",function(o){t.task=o,console.log("$scope.task: ",t.task.quotes),_.each(t.task.quotes,function(t){var o=0;_.each(t.descriptions,function(t){o+=parseFloat(t.rate)}),t.totalothers=o})}))}),t.showConfirm=function(o){s.confirm({title:"",template:"Are you sure you want to assign the task to "+o.contractor.fname+" "+o.contractor.lname+" ?"}).then(function(a){a?(f.show({template:'<p>Approving...</p><ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),_.each(t.task.quotes,function(t){t._id==o._id&&(t.approved=!0)}),u.findByIdAndUpdate(d.taskId,t.task).then(function(a){a&&n(function(){f.hide(),s.alert({title:"",template:"Quote successfully approved"}).then(function(n){i.nextDirection("forward"),e.go("approve",{quoteId:o._id,taskId:t.task._id})})},1e3)})):console.log("You are not sure")})},t.viewApproval=function(o){i.nextDirection("forward"),e.go("approve",{quoteId:o._id,taskId:t.task._id})},t.gotToProfile=function(t){console.log("user: ",t._id),i.nextDirection("forward"),e.go("userprofile",{userId:t._id})}}function o(t,o,e,n,i){t.task={},t.data={},t.$on("$ionicView.beforeEnter",function(o,i){n.quoteId&&(e.findById(n.taskId).then(function(o){t.task=o[0]}),t.$watch("task",function(o){t.task=o,t.data=_.find(t.task.quotes,{_id:n.quoteId}),t.data.totalMisc=parseFloat(t.data.parking_fee)+parseFloat(t.data.travel_fee),console.log("$scope.qoute: ",t.data)}))}),t.gotToProfile=function(t){console.log("user: ",t._id),i.nextDirection("forward"),o.go("userprofile",{userId:t._id})}}angular.module("starter").controller("ProcurementQoutesCtrl",t).controller("ProcurementQoutesDetailsCtrl",o),t.$inject=["$scope","$ionicPopover","$state","$timeout","$ionicViewSwitcher","$ionicModal","$ionicPopup","$filter","localStorageService","Tasks","$stateParams","$ionicListDelegate","$ionicLoading"],o.$inject=["$scope","$state","Tasks","$stateParams","$ionicViewSwitcher"]}();
