...
!function(){"use strict";function a(a,t,e,i,o,r,n,c,s,l,u,m,d,v,f,p){a.data={},a.data.availabilityArr=[],a.data.coverageArr=[],a.avail={},a.area={},a.weekdays=o.all(),a.countries=n.all(),a.cities=[],a.citiesCopy=[],a.groups=[],a.othersList=[],a.$on("$ionicView.afterEnter",function(t,e){var i=JSON.parse(v.get("tmpvendor"))||{};_.isEmpty(i)?(a.data.username=a.data.lname+"."+a.data.fname,a.data.password="123456"):a.data=i}),a.goBackLogin=function(){m.nextViewOptions({disableBack:!0}),d.nextDirection("back"),u.go("login")},a.getCountryState=function(t){"AUS"==t?a.states=r.all():a.states=[]},a.getCityState=function(t){console.log("getCityState: ",t),c.all(t).then(function(t){a.cities=t.data;var e=0;_.each(a.cities,function(t){a.citiesCopy.push({id:e,name:t.place_name,view:t.place_name}),e++})})},a.callbackMethod=function(t){if(t){var e=f("filter")(a.citiesCopy,t);return{items:e}}return{items:[]}},a.itemsClicked=function(t){a.data.check_city=t.item.name},a.addArea=function(t){console.log("item: ",t),t&&(a.data.coverageArr.push({area:t}),a.area.coverage="")},a.increaseHours=function(){a.time.hours=Number(a.time.hours),12==a.mainObj.format&&(12!=a.time.hours?a.time.hours+=1:a.time.hours=1),24==a.mainObj.format&&(a.time.hours=(a.time.hours+1)%24),a.time.hours=a.time.hours<10?"0"+a.time.hours:a.time.hours},a.openTime=function(t){a.data.created=new Date,l.openTimePicker({callback:function(t){var e=Math.floor(t/60/60),i=t/60%60;a.data.created.setHours(e,i);var o=(a.data.created.getHours(),e>=12?"PM":"AM");e%=12,e=e?e:12,i=i<10?"0"+i:i,a.avail.start=e+":"+i+" "+o},inputTime:60*a.data.created.getHours()*60+60*a.data.created.getMinutes(),format:12})},a.openTime2=function(){var t=new Date;l.openTimePicker({callback:function(e){var i=Math.floor(e/60/60),o=e/60%60;t.setHours(i,o);var r=(t.getHours(),i>=12?"PM":"AM");i%=12,i=i?i:12,o=o<10?"0"+o:o,a.avail.end=i+":"+o+" "+r},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},a.openTime3=function(a){var t=new Date;l.openTimePicker({callback:function(e){var i=Math.floor(e/60/60),o=e/60%60;t.setHours(i,o);var r=(t.getHours(),i>=12?"PM":"AM");i%=12,i=i?i:12,o=o<10?"0"+o:o,a.start=i+":"+o+" "+r},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},a.openTime4=function(a){var t=new Date;l.openTimePicker({callback:function(e){var i=Math.floor(e/60/60),o=e/60%60;t.setHours(i,o);var r=(t.getHours(),i>=12?"PM":"AM");i%=12,i=i?i:12,o=o<10?"0"+o:o,a.end=i+":"+o+" "+r},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},a.addSched=function(t){t&&(a.data.availabilityArr.push({availability:t.availability,start:t.start,end:t.end}),a.avail.availability="",a.avail.start="",a.avail.end="")},a.showCancel=function(){e.confirm({title:"",template:"Are you sure you want to cancel application?"}).then(function(a){a&&(m.nextViewOptions({disableBack:!0}),d.nextDirection("back"),v.remove("tmpvendor"),u.go("login"))})},a.vendorinf=function(t){t.$valid&&(a.avail.availability&&(a.data.availabilityArr.push({availability:a.avail.availability,start:a.avail.start,end:a.avail.end}),a.avail.availability="",a.avail.start="",a.avail.end=""),a.area.coverage&&(a.data.coverageArr.push({area:a.area.coverage}),a.area.coverage=""),v.set("tmpvendor",JSON.stringify(a.data)),u.go("vendorRate"))}}angular.module("starter").controller("VendorInfoCtrl",a),a.$inject=["$scope","$ionicModal","$ionicPopup","$timeout","WeekDays","States","Country","CityState","Dummy","ionicTimePicker","$state","$ionicHistory","$ionicViewSwitcher","localStorageService","$filter","ionicToast"]}();
