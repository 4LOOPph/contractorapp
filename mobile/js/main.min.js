...
!function(){"use strict";angular.module("starter",["ionic","ionic-timepicker","ng.deviceDetector","ngMask","ngDialog","ngFileUpload","angularFileUpload","ionic-datepicker"]).run(["$ionicPlatform","$window","deviceDetector",function(t,e,l){t.ready(function(){window.cordova&&window.cordova.plugins&&window.cordova.plugins.Keyboard&&(cordova.plugins.Keyboard.hideKeyboardAccessoryBar(!0),cordova.plugins.Keyboard.disableScroll(!0)),window.StatusBar&&StatusBar.styleDefault()});var l=l;console.log("deviceDetector: ",l),l.isDesktop()&&(e.location.href="../desktop.html")}]).config(["$stateProvider","$urlRouterProvider","ionicTimePickerProvider","$ionicConfigProvider",function(t,e,l,a){var r={inputTime:60*(new Date).getHours()*60+60*(new Date).getMinutes(),format:12,step:15,setLabel:"Set",closeLabel:"Close"};l.configTimePicker(r),a.backButton.text("").icon("ion-ios-arrow-left"),a.tabs.position("bottom"),t.state("login",{url:"/login",templateUrl:"templates/login.html",controller:"LoginCtrl"}).state("vendorInfo",{url:"/vendorInfo",templateUrl:"templates/vendorInfo.html",controller:"AccountCtrl"}).state("vendorcontactInfo",{url:"/vendorcontactinfo",templateUrl:"templates/vendorcontactinfo.html"}).state("vendorRate",{url:"/vendorrate",templateUrl:"templates/vendorRate.html",controller:"AccountCtrl"}).state("sent",{url:"/sent",templateUrl:"templates/sent.html",controller:"sentCtrl"}).state("qualification",{url:"/qualification",templateUrl:"templates/qualification.html",controller:"AccountCtrl"}).state("certification",{url:"/certification",templateUrl:"templates/certification.html"}).state("certifications",{url:"/certifications",templateUrl:"templates/certifications.html"}).state("tab",{url:"/tab","abstract":!0,templateUrl:"templates/tabs.html",controller:"MainCtrl"}).state("tab.dash",{url:"/dash",views:{"tab-dash":{templateUrl:"templates/tab-dash.html",controller:"DashCtrl"}}}).state("tab.tasks",{url:"/tasks",views:{"tab-tasks":{templateUrl:"templates/tab-tasks.html",controller:"ChatsCtrl"}}}).state("newdetails",{url:"/newdetails",templateUrl:"templates/newdetails.html",controller:"ChatsCtrl"}).state("progress",{url:"/progress",templateUrl:"templates/progress.html",controller:"ChatsCtrl"}).state("pendingtask",{url:"/pendingtask",templateUrl:"templates/pendingtask.html",controller:"ChatsCtrl"}).state("qow",{url:"/qow",templateUrl:"templates/qow.html",controller:"ChatsCtrl"}).state("userprofile",{url:"/userprofile",templateUrl:"templates/profile.html",controller:"ChatsCtrl"}).state("adminprofile",{url:"/adminprofile",templateUrl:"templates/adminprofile.html",controller:"ChatsCtrl"}).state("editpro",{url:"/editpro",templateUrl:"templates/editvendorinfo.html",controller:"ChatsCtrl"}).state("editavailability",{url:"/editavailability",templateUrl:"templates/editavailability.html",controller:"ChatsCtrl"}).state("editrate",{url:"/editrate",templateUrl:"templates/editrate.html",controller:"ChatsCtrl"}).state("reporting",{url:"/supportreport",templateUrl:"templates/supportreport.html",controller:"ChatsCtrl"}).state("installationreport",{url:"/installationreport",templateUrl:"templates/installationreport.html",controller:"ChatsCtrl"}).state("sitesurvey",{url:"/sitesurvey",templateUrl:"templates/sitesurvey.html",controller:"ChatsCtrl"}).state("tab.task-detail",{url:"/tasks/:chatId",views:{"tab-tasks":{templateUrl:"templates/task-detail.html",controller:"ChatDetailCtrl"}}}).state("tab.account",{url:"/account",views:{"tab-account":{templateUrl:"templates/tab-account.html",controller:"DashCtrl"}}}).state("tab.admindash",{url:"/admindash",views:{"tab-admindash":{templateUrl:"templates/tab-admindash.html",controller:"DashCtrl"}}}).state("tab.admintasks",{url:"/admintasks",views:{"tab-admintasks":{templateUrl:"templates/tab-admintask.html",controller:"DashCtrl"}}}).state("tab.adminreport",{url:"/adminreport",views:{"tab-adminreport":{templateUrl:"templates/tab-adminreport.html",controller:"DashCtrl"}}}).state("tab.createtask",{url:"/createtask",views:{"tab-create-task":{templateUrl:"templates/tab-createtask.html",controller:"DashCtrl"}}}),e.otherwise("/login")}])}();
!function(){"use strict";angular.module("starter").controller("DashCtrl",["$scope","$ionicPopover","$state","$timeout","$ionicViewSwitcher","ngDialog","ionicDatePicker","ionicTimePicker","$ionicModal",function(e,o,n,t,i,c,l,a,r){e.filter={direct:!1,check:!0,check1:!1},e.showModerate=function(){e.filter={direct:!0,check:!1,check1:!1}},e.showHigh=function(){e.filter={direct:!1,check:!0,check1:!1}},e.showLow=function(){e.filter={direct:!1,check:!1,check1:!0}},r.fromTemplateUrl("../mobile/templates/dialog/contractorlist.html",{scope:e,animation:"slide-in-up"}).then(function(o){e.modal=o}),e.openModal=function(){e.modal.show()},e.closeModal=function(){e.modal.hide()},e.createContact=function(o){e.contacts.push({name:o.firstName+" "+o.lastName}),e.modal.hide()};var p={callback:function(e){console.log("Return value from the datepicker popup is : "+e,new Date(e))},disabledDates:[new Date(2016,2,16),new Date(2015,3,16),new Date(2015,4,16),new Date(2015,5,16),new Date("Wednesday, August 12, 2015"),new Date("08-16-2016"),new Date(1439676e6)],from:new Date(2012,1,1),to:new Date(2016,10,30),inputDate:new Date,mondayFirst:!0,disableWeekdays:[0],closeOnSelect:!1,templateType:"popup"};e.openDatePicker=function(){l.openDatePicker(p)};e.openTime=function(){a.openTimePicker(p)},o.fromTemplateUrl("../mobile/templates/dialog/submit.html",{scope:e}).then(function(o){e.popover=o}),e.showPopover=function(o){e.popover.show(o)},o.fromTemplateUrl("../mobile/templates/dialog/popadmin.html",{scope:e}).then(function(o){e.popover2=o}),e.showPopoveradmin=function(o){e.popover2.show(o)},e.signOut=function(o){e.popover.hide(),i.nextDirection("back"),t(function(){n.go("login")},100)},e.proFile=function(o){e.popover.hide(),i.nextDirection("forward"),t(function(){n.go("userprofile")},100)},e.adminproFile=function(o){e.popover.hide(),i.nextDirection("forward"),t(function(){n.go("adminprofile")},100)},e.pendingDetails=function(o){e.popover.hide(),i.nextDirection("forward"),t(function(){n.go("pendingtask")},100)},e.clickToCheckout2=function(){console.log("clickToCancel"),c.openConfirm({templateUrl:"../mobile/templates/dialog/checkout2.html",className:"ngdialog-theme-default",scope:e}).then(function(){i.nextDirection("forward"),t(function(){n.go("installationreport")},100),console.log("YES")},function(){console.log("NO")})},e.clickToCheckout3=function(){console.log("clickToCancel"),c.openConfirm({templateUrl:"../mobile/templates/dialog/checkout3.html",className:"ngdialog-theme-default",scope:e}).then(function(){i.nextDirection("forward"),t(function(){n.go("sitesurvey")},100),console.log("YES")},function(){console.log("NO")})},e.clickToCheckout=function(){console.log("clickToCancel"),c.openConfirm({templateUrl:"../mobile/templates/dialog/checkout.html",className:"ngdialog-theme-default",scope:e}).then(function(){i.nextDirection("forward"),t(function(){n.go("reporting"),e.popover.remove()},100),console.log("YES")},function(){console.log("NO")})},e.$on("$destroy",function(){e.popover.remove()})}])}();
!function(){"use strict";function t(t,i,n){t.login=function(){i.nextDirection("forward"),n.go("tab.dash")}}function i(t,i,n,o){t.sent=function(){o.nextViewOptions({disableBack:!0}),i.nextDirection("forward"),n.go("login")}}angular.module("starter").controller("LoginCtrl",t).controller("sentCtrl",i),i.$inject=["$scope","$ionicViewSwitcher","$state","$ionicHistory"],t.$inject=["$scope","$ionicViewSwitcher","$state"]}();
!function(){"use strict";function o(o,t,e,n,i,s,a,l,c,u){o.data={},o.inputs=[],o.input=[],o.rates=[],o.weekdays=i.all(),o.rate={},o.groups=[],o.othersList=[],o.others={};for(var r=0;r<1;r++){o.groups[r]={name:r,items:[]};for(var m=0;m<1;m++)o.groups[r].items.push(r+"-"+m)}null==localStorage.getItem("mytodos")?(o.todoList=[{todoText:"Create app",done:!1}],localStorage.setItem("mytodos",angular.toJson(o.todoList))):o.todoList=angular.fromJson(localStorage.getItem("mytodos")),o.clickToCancel=function(){console.log("clickToCancel"),a.openConfirm({templateUrl:"../mobile/templates/dialog/cancel.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},o.clickToterm=function(){console.log("clickToterm"),a.openConfirm({templateUrl:"../mobile/templates/dialog/termandcondition.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},t.fromTemplateUrl("../mobile/templates/dialog/termandcondition.html",{scope:o,animation:"slide-in-up"}).then(function(t){o.modal=t}),o.openModal=function(){o.modal.show()},o.closeModal=function(){o.modal.hide()},o.clickToSubmit=function(){console.log("clickToSubmit"),a.openConfirm({templateUrl:"../mobile/templates/dialog/submit.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},o.signOut=function(){u.nextDirection("back"),n(function(){l.go("login")},100)},o.addOthers=function(t){_.isEmpty(t)||(o.othersList.push(t),o.others={})},o.proFile=function(t){o.popover.hide(),u.nextDirection("forward"),n(function(){l.go("userprofile")},100)},o.removeOther=function(t){o.othersList.splice(t,1)},o.addArea=function(){o.input.push({})},o.addSched=function(){o.inputs.push({})},o.showPopup=function(){var o=e.alert({title:"Terms and Conditions",content:"",buttons:[{text:"Close",type:"button-positive",onTap:function(o){return!0}}]});o.then(function(o){console.log("Thank you for not eating my delicious ice cream cone")})},o.showCancel=function(){e.confirm({title:"",template:"Are you sure you want to cancel application?"}).then(function(o){o?(c.nextViewOptions({disableBack:!0}),u.nextDirection("back"),l.go("login")):console.log("You are not sure")})},o.showConfirm=function(){e.confirm({title:"",template:"Are you sure you want to submit application?"}).then(function(o){o?(c.nextViewOptions({disableBack:!0}),u.nextDirection("forward"),l.go("sent")):console.log("You are not sure")})},o.todoAdd=function(){o.todoList.push({todoText:o.todoInput,done:!1}),o.todoInput="",localStorage.setItem("mytodos",angular.toJson(o.todoList))},o.remove=function(){var t=o.todoList;o.todoList=[],angular.forEach(t,function(t){t.done||o.todoList.push(t)}),localStorage.setItem("mytodos",angular.toJson(o.todoList))},o.update=function(){setTimeout(function(){localStorage.setItem("mytodos",angular.toJson(o.todoList))},100)},o.toggleGroup=function(t){o.isGroupShown(t)?o.shownGroup=null:o.shownGroup=t},o.isGroupShown=function(t){return o.shownGroup===t},null==localStorage.getItem("mytodos")?(o.todoList=[{todoText:"Create app",done:!1}],localStorage.setItem("mytodos",angular.toJson(o.todoList))):o.todoList=angular.fromJson(localStorage.getItem("mytodos")),t.fromTemplateUrl("termcon.html",{scope:o,animation:"slide-in-up"}).then(function(t){o.modal=t}),o.openModal=function(){o.modal.show()},o.closeModal=function(){o.modal.hide()},o.increaseHours=function(){o.time.hours=Number(o.time.hours),12==o.mainObj.format&&(12!=o.time.hours?o.time.hours+=1:o.time.hours=1),24==o.mainObj.format&&(o.time.hours=(o.time.hours+1)%24),o.time.hours=o.time.hours<10?"0"+o.time.hours:o.time.hours};var d={callback:function(t){if("undefined"==typeof t)console.log("Time not selected");else{var e=new Date(1e3*t),n=e.getHours(),i="0"+e.getMinutes(),s="0"+e.getSeconds();o.rate.start=n+":"+i.substr(-2)+":"+s.substr(-2)}},inputTime:50400,format:12,step:15,setLabel:"Set Start"},p={callback:function(t){if("undefined"==typeof t)console.log("Time not selected");else{var e=new Date(1e3*t),n=e.getHours(),i="0"+e.getMinutes(),s="0"+e.getSeconds();o.rate.end=n+":"+i.substr(-2)+":"+s.substr(-2)}},inputTime:50400,format:12,step:15,setLabel:"Set End"};o.openTime=function(){s.openTimePicker(d)},o.openTime2=function(){s.openTimePicker(p)},o.openTime3=function(){s.openTimePicker(d)},o.openTime4=function(){s.openTimePicker(p)},o.addRate=function(t){console.log("rate: ",t),_.isUndefined(t)||o.rates.push({amount:t.amount,weekday:t.weekday,note:t.note})}}angular.module("starter").controller("AccountCtrl",o),o.$inject=["$scope","$ionicModal","$ionicPopup","$timeout","WeekDays","ionicTimePicker","ngDialog","$state","$ionicHistory","$ionicViewSwitcher"]}();
!function(){"use strict";function t(t){t.user={},t.user.type="con"}angular.module("starter").controller("MainCtrl",t),t.$inject=["$scope"]}();
!function(){"use strict";angular.module("starter").controller("ChatsCtrl",["$scope","Chats","$ionicPopover","$state","$timeout","$ionicViewSwitcher","ngDialog","$ionicModal",function(o,e,n,t,i,c,l,a){o.$on("$ionicView.enter",function(r){o.progressData=[],o.pendingData=[],o.completedData=[],o.contacts=[{name:""}],o.chats=e.all(),n.fromTemplateUrl("../mobile/templates/dialog/submit.html",{scope:o}).then(function(e){o.popover=e}),o.showPopover=function(e){o.popover.show(e)},n.fromTemplateUrl("../mobile/templates/dialog/editpro.html",{scope:o}).then(function(e){o.popover1=e}),o.showPopoveredit=function(e){o.popover1.show(e)},n.fromTemplateUrl("../mobile/templates/dialog/popadmin.html",{scope:o}).then(function(e){o.popover2=e}),o.showPopoveradmin=function(e){o.popover2.show(e)},o.signOut=function(e){o.popover.hide(),c.nextDirection("back"),i(function(){t.go("login")},100)},o.pendingDetails=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("pendingtask")},100)},o.newTask=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("newdetails")},100)},o.clickDecline=function(e){o.popover.hide(),c.nextDirection("back"),i(function(){t.go("tab.tasks")},100)},o.proFile=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("userprofile")},100)},o.adminproFile=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("adminprofile")},100)},o.supportreport=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("reporting"),o.popover.remove()},100)},o.editpro=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("editpro"),o.popover.remove()},100)},o.editavailability=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("editavailability"),o.popover.remove()},100)},o.editrate=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("editrate"),o.popover.remove()},100)},o.sitesurvey=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("sitesurvey")},100)},o.clickToCheckout=function(){console.log("clickToCancel"),l.openConfirm({templateUrl:"../mobile/templates/dialog/checkout.html",className:"ngdialog-theme-default",scope:o}).then(function(){t.go("reporting"),console.log("YES")},function(){console.log("NO")})},o.clickToCheckout3=function(){console.log("clickToCancel"),l.openConfirm({templateUrl:"../mobile/templates/dialog/checkout3.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},o.clickToCheckin=function(){console.log("clickToCheckin"),l.openConfirm({templateUrl:"../mobile/templates/dialog/checkin.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},o.clickToCurrentin=function(){console.log("clickToCurrentin"),l.openConfirm({templateUrl:"../mobile/templates/dialog/currentin.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},o.$on("$destroy",function(){o.popover.remove()}),a.fromTemplateUrl("../mobile/templates/dialog/addmaterial.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.modal=e}),o.openModal=function(){o.modal.show()},o.closeModal=function(){o.modal.hide()},o.createContact=function(e){o.contacts.push({name:e.firstName+" "+e.lastName}),o.modal.hide()},_.each(o.chats,function(e){"progress"==e.status?o.progressData.push(e):"pending"==e.status?o.pendingData.push(e):"completed"==e.status&&o.completedData.push(e)}),console.log("$scope.progressData: ",o.progressData),console.log("$scope.pendingData: ",o.pendingData),console.log("$scope.completedData: ",o.completedData)})}])}();
