...
<<<<<<< HEAD
!function(){"use strict";angular.module("starter",["ionic","ionic-timepicker","ng.deviceDetector","ngMask","ngDialog","ngFileUpload","angularFileUpload","ionic-datepicker","LocalStorageModule"]).run(["$rootScope","$ionicPlatform","$window","deviceDetector","$ionicHistory","$ionicViewSwitcher","localStorageService","$timeout","$state",function(t,e,l,a,r,o,i,s,n){e.ready(function(){window.cordova&&window.cordova.plugins&&window.cordova.plugins.Keyboard&&(cordova.plugins.Keyboard.hideKeyboardAccessoryBar(!0),cordova.plugins.Keyboard.disableScroll(!0)),window.StatusBar&&StatusBar.styleDefault()});var a=a;console.log("deviceDetector: ",a),a.isDesktop()&&(l.location.href="../desktop.html"),t.showPopover=function(e){t.mainPopover.show(e)},t.myGoBack=function(){o.nextDirection("back"),r.goBack()},t.signOut=function(){t.mainPopover.hide(),o.nextDirection("back"),i.remove("user"),s(function(){n.go("login")},100)},t.gotToProfile=function(){t.mainPopover.hide(),o.nextDirection("forward"),n.go("userprofile")}}]).config(["$stateProvider","$urlRouterProvider","ionicTimePickerProvider","$ionicConfigProvider","localStorageServiceProvider",function(t,e,l,a,r){var o={inputTime:60*(new Date).getHours()*60+60*(new Date).getMinutes(),format:12,step:15,setLabel:"Set",closeLabel:"Close"};l.configTimePicker(o),a.backButton.text("").icon("ion-ios-arrow-left"),a.tabs.position("bottom"),r.setStorageType("sessionStorage"),t.state("login",{url:"/login",templateUrl:"templates/login.html",controller:"LoginCtrl"}).state("vendorInfo",{url:"/vendorInfo",templateUrl:"templates/vendorInfo.html",controller:"AccountCtrl"}).state("vendorcontactInfo",{url:"/vendorcontactinfo",templateUrl:"templates/vendorcontactinfo.html"}).state("vendorRate",{url:"/vendorrate",templateUrl:"templates/vendorRate.html",controller:"AccountCtrl"}).state("sent",{url:"/sent",templateUrl:"templates/sent.html",controller:"sentCtrl"}).state("qualification",{url:"/qualification",templateUrl:"templates/qualification.html",controller:"AccountCtrl"}).state("certification",{url:"/certification",templateUrl:"templates/certification.html"}).state("certifications",{url:"/certifications",templateUrl:"templates/certifications.html"}).state("tab",{url:"/tab","abstract":!0,templateUrl:"templates/tabs.html",controller:"MainCtrl"}).state("tab.dash",{url:"/dash",views:{"tab-dash":{templateUrl:"templates/tab-dash.html",controller:"DashCtrl"}}}).state("tab.tasks",{url:"/tasks",views:{"tab-tasks":{templateUrl:"templates/tab-tasks.html",controller:"ChatsCtrl"}}}).state("newdetails",{url:"/newdetails",templateUrl:"templates/newdetails.html",controller:"ChatsCtrl"}).state("progress",{url:"/progress",templateUrl:"templates/progress.html",controller:"ChatsCtrl"}).state("pendingtask",{url:"/pendingtask",templateUrl:"templates/pendingtask.html",controller:"ChatsCtrl"}).state("qow",{url:"/qow",templateUrl:"templates/qow.html",controller:"ChatsCtrl"}).state("userprofile",{url:"/userprofile",templateUrl:"templates/profile.html",controller:"ChatsCtrl"}).state("adminprofile",{url:"/adminprofile",templateUrl:"templates/adminprofile.html",controller:"ChatsCtrl"}).state("editpro",{url:"/editpro",templateUrl:"templates/editvendorinfo.html",controller:"ChatsCtrl"}).state("editavailability",{url:"/editavailability",templateUrl:"templates/editavailability.html",controller:"ChatsCtrl"}).state("editrate",{url:"/editrate",templateUrl:"templates/editrate.html",controller:"ChatsCtrl"}).state("reporting",{url:"/supportreport",templateUrl:"templates/supportreport.html",controller:"ChatsCtrl"}).state("installationreport",{url:"/installationreport",templateUrl:"templates/installationreport.html",controller:"ChatsCtrl"}).state("sitesurvey",{url:"/sitesurvey",templateUrl:"templates/sitesurvey.html",controller:"ChatsCtrl"}).state("tab.task-detail",{url:"/tasks/:chatId",views:{"tab-tasks":{templateUrl:"templates/task-detail.html",controller:"ChatDetailCtrl"}}}).state("tab.account",{url:"/account",views:{"tab-account":{templateUrl:"templates/tab-account.html",controller:"DashCtrl"}}}).state("tab.admindash",{url:"/admindash",views:{"tab-admindash":{templateUrl:"templates/tab-admindash.html",controller:"DashCtrl"}}}).state("tab.admintasks",{url:"/admintasks",views:{"tab-admintasks":{templateUrl:"templates/tab-admintask.html",controller:"DashCtrl"}}}).state("tab.adminreport",{url:"/adminreport",views:{"tab-adminreport":{templateUrl:"templates/tab-adminreport.html",controller:"DashCtrl"}}}).state("tab.createtask",{url:"/createtask",views:{"tab-create-task":{templateUrl:"templates/tab-createtask.html",controller:"DashCtrl"}}}),e.otherwise("/login")}])}();
!function(){"use strict";angular.module("starter").controller("DashCtrl",["$scope","$ionicPopover","$state","$timeout","$ionicViewSwitcher","ngDialog","ionicDatePicker","ionicTimePicker","$ionicModal",function(e,o,n,t,i,c,l,a,r){e.filter={direct:!1,check:!0,check1:!1},e.showModerate=function(){e.filter={direct:!0,check:!1,check1:!1}},e.showHigh=function(){e.filter={direct:!1,check:!0,check1:!1}},e.showLow=function(){e.filter={direct:!1,check:!1,check1:!0}},r.fromTemplateUrl("../mobile/templates/dialog/contractorlist.html",{scope:e,animation:"slide-in-up"}).then(function(o){e.modal=o}),e.openModal=function(){e.modal.show()},e.closeModal=function(){e.modal.hide()},e.createContact=function(o){e.contacts.push({name:o.firstName+" "+o.lastName}),e.modal.hide()};var p={callback:function(e){console.log("Return value from the datepicker popup is : "+e,new Date(e))},disabledDates:[new Date(2016,2,16),new Date(2015,3,16),new Date(2015,4,16),new Date(2015,5,16),new Date("Wednesday, August 12, 2015"),new Date("08-16-2016"),new Date(1439676e6)],from:new Date(2012,1,1),to:new Date(2016,10,30),inputDate:new Date,mondayFirst:!0,disableWeekdays:[0],closeOnSelect:!1,templateType:"popup"};e.openDatePicker=function(){l.openDatePicker(p)};e.openTime=function(){a.openTimePicker(p)},o.fromTemplateUrl("../mobile/templates/dialog/popadmin.html",{scope:e}).then(function(o){e.popover2=o}),e.showPopoveradmin=function(o){e.popover2.show(o)},e.proFile=function(o){e.popover.hide(),i.nextDirection("forward"),t(function(){n.go("userprofile")},100)},e.adminproFile=function(o){e.popover.hide(),i.nextDirection("forward"),t(function(){n.go("adminprofile")},100)},e.pendingDetails=function(o){e.popover.hide(),i.nextDirection("forward"),t(function(){n.go("pendingtask")},100)},e.clickToCheckout2=function(){console.log("clickToCancel"),c.openConfirm({templateUrl:"../mobile/templates/dialog/checkout2.html",className:"ngdialog-theme-default",scope:e}).then(function(){i.nextDirection("forward"),t(function(){n.go("installationreport")},100),console.log("YES")},function(){console.log("NO")})},e.clickToCheckout3=function(){console.log("clickToCancel"),c.openConfirm({templateUrl:"../mobile/templates/dialog/checkout3.html",className:"ngdialog-theme-default",scope:e}).then(function(){i.nextDirection("forward"),t(function(){n.go("sitesurvey")},100),console.log("YES")},function(){console.log("NO")})},e.clickToCheckout=function(){console.log("clickToCancel"),c.openConfirm({templateUrl:"../mobile/templates/dialog/checkout.html",className:"ngdialog-theme-default",scope:e}).then(function(){i.nextDirection("forward"),t(function(){n.go("reporting"),e.popover.remove()},100),console.log("YES")},function(){console.log("NO")})}}])}();
!function(){"use strict";function t(t,e,n,a,o,i){t.data={username:"",password:""},t.$on("$ionicView.beforeEnter",function(e,n){t.data={username:"",password:"",usertype:""}}),t.login=function(){"proc"==t.data.username&&"123456"==t.data.password?(t.data.usertype="proc",a.set("user",JSON.stringify(t.data)),e.nextDirection("forward"),i(function(){n.go("tab.admindash")},300)):"con"==t.data.username&&"123456"==t.data.password?(t.data.usertype="con",a.set("user",JSON.stringify(t.data)),e.nextDirection("forward"),i(function(){n.go("tab.dash")},300)):o.alert({title:"Invalid Account",template:"Username and Password not match!!!"})}}function e(t,e,n,a){t.sent=function(){a.nextViewOptions({disableBack:!0}),e.nextDirection("forward"),n.go("login")}}angular.module("starter").controller("LoginCtrl",t).controller("sentCtrl",e),e.$inject=["$scope","$ionicViewSwitcher","$state","$ionicHistory"],t.$inject=["$scope","$ionicViewSwitcher","$state","localStorageService","$ionicPopup","$timeout"]}();
!function(){"use strict";function o(o,t,e,n,i,s,a,l,c,r){o.data={},o.inputs=[],o.input=[],o.rates=[],o.weekdays=i.all(),o.rate={},o.groups=[],o.othersList=[],o.others={};for(var u=0;u<1;u++){o.groups[u]={name:u,items:[]};for(var m=0;m<1;m++)o.groups[u].items.push(u+"-"+m)}null==localStorage.getItem("mytodos")?(o.todoList=[{todoText:"Create app",done:!1}],localStorage.setItem("mytodos",angular.toJson(o.todoList))):o.todoList=angular.fromJson(localStorage.getItem("mytodos")),o.clickToCancel=function(){console.log("clickToCancel"),a.openConfirm({templateUrl:"../mobile/templates/dialog/cancel.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},o.clickToterm=function(){console.log("clickToterm"),a.openConfirm({templateUrl:"../mobile/templates/dialog/termandcondition.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},t.fromTemplateUrl("../mobile/templates/dialog/termandcondition.html",{scope:o,animation:"slide-in-up"}).then(function(t){o.modal=t}),o.openModal=function(){o.modal.show()},o.closeModal=function(){o.modal.hide()},o.clickToSubmit=function(){console.log("clickToSubmit"),a.openConfirm({templateUrl:"../mobile/templates/dialog/submit.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},o.addOthers=function(t){_.isEmpty(t)||(o.othersList.push(t),o.others={})},o.proFile=function(t){o.popover.hide(),r.nextDirection("forward"),n(function(){l.go("userprofile")},100)},o.removeOther=function(t){o.othersList.splice(t,1)},o.addArea=function(){o.input.push({})},o.addSched=function(){o.inputs.push({})},o.showPopup=function(){var o=e.alert({title:"Terms and Conditions",content:"",buttons:[{text:"Close",type:"button-positive",onTap:function(o){return!0}}]});o.then(function(o){console.log("Thank you for not eating my delicious ice cream cone")})},o.showCancel=function(){e.confirm({title:"",template:"Are you sure you want to cancel application?"}).then(function(o){o?(c.nextViewOptions({disableBack:!0}),r.nextDirection("back"),l.go("login")):console.log("You are not sure")})},o.showConfirm=function(){e.confirm({title:"",template:"Are you sure you want to submit application?"}).then(function(o){o?(c.nextViewOptions({disableBack:!0}),r.nextDirection("forward"),l.go("sent")):console.log("You are not sure")})},o.todoAdd=function(){o.todoList.push({todoText:o.todoInput,done:!1}),o.todoInput="",localStorage.setItem("mytodos",angular.toJson(o.todoList))},o.remove=function(){var t=o.todoList;o.todoList=[],angular.forEach(t,function(t){t.done||o.todoList.push(t)}),localStorage.setItem("mytodos",angular.toJson(o.todoList))},o.update=function(){setTimeout(function(){localStorage.setItem("mytodos",angular.toJson(o.todoList))},100)},o.toggleGroup=function(t){o.isGroupShown(t)?o.shownGroup=null:o.shownGroup=t},o.isGroupShown=function(t){return o.shownGroup===t},null==localStorage.getItem("mytodos")?(o.todoList=[{todoText:"Create app",done:!1}],localStorage.setItem("mytodos",angular.toJson(o.todoList))):o.todoList=angular.fromJson(localStorage.getItem("mytodos")),t.fromTemplateUrl("termcon.html",{scope:o,animation:"slide-in-up"}).then(function(t){o.modal=t}),o.openModal=function(){o.modal.show()},o.closeModal=function(){o.modal.hide()},o.increaseHours=function(){o.time.hours=Number(o.time.hours),12==o.mainObj.format&&(12!=o.time.hours?o.time.hours+=1:o.time.hours=1),24==o.mainObj.format&&(o.time.hours=(o.time.hours+1)%24),o.time.hours=o.time.hours<10?"0"+o.time.hours:o.time.hours};var d={callback:function(t){if("undefined"==typeof t)console.log("Time not selected");else{var e=new Date(1e3*t),n=e.getHours(),i="0"+e.getMinutes(),s="0"+e.getSeconds();o.rate.start=n+":"+i.substr(-2)+":"+s.substr(-2)}},inputTime:50400,format:12,step:15,setLabel:"Set Start"},p={callback:function(t){if("undefined"==typeof t)console.log("Time not selected");else{var e=new Date(1e3*t),n=e.getHours(),i="0"+e.getMinutes(),s="0"+e.getSeconds();o.rate.end=n+":"+i.substr(-2)+":"+s.substr(-2)}},inputTime:50400,format:12,step:15,setLabel:"Set End"};o.openTime=function(){s.openTimePicker(d)},o.openTime2=function(){s.openTimePicker(p)},o.openTime3=function(){s.openTimePicker(d)},o.openTime4=function(){s.openTimePicker(p)},o.addRate=function(t){console.log("rate: ",t),_.isUndefined(t)||o.rates.push({amount:t.amount,weekday:t.weekday,note:t.note})}}angular.module("starter").controller("AccountCtrl",o),o.$inject=["$scope","$ionicModal","$ionicPopup","$timeout","WeekDays","ionicTimePicker","ngDialog","$state","$ionicHistory","$ionicViewSwitcher"]}();
!function(){"use strict";function e(e,o,r,t){e.user={};var i=JSON.parse(o.get("user"));e.user=i,r.fromTemplateUrl("../mobile/templates/dialog/submit.html",{scope:e}).then(function(e){t.mainPopover=e})}angular.module("starter").controller("MainCtrl",e),e.$inject=["$scope","localStorageService","$ionicPopover","$rootScope"]}();
!function(){"use strict";angular.module("starter").controller("ChatsCtrl",["$scope","Chats","$ionicPopover","$state","$timeout","$ionicViewSwitcher","ngDialog","$ionicModal",function(o,e,n,t,i,c,l,a){o.$on("$ionicView.enter",function(r){o.progressData=[],o.pendingData=[],o.completedData=[],o.contacts=[{name:""}],o.chats=e.all(),n.fromTemplateUrl("../mobile/templates/dialog/editpro.html",{scope:o}).then(function(e){o.popover1=e}),o.showPopoveredit=function(e){o.popover1.show(e)},n.fromTemplateUrl("../mobile/templates/dialog/popadmin.html",{scope:o}).then(function(e){o.popover2=e}),o.showPopoveradmin=function(e){o.popover2.show(e)},o.signOut=function(e){o.popover.hide(),c.nextDirection("back"),i(function(){t.go("login")},100)},o.pendingDetails=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("pendingtask")},100)},o.newTask=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("newdetails")},100)},o.clickDecline=function(e){o.popover.hide(),c.nextDirection("back"),i(function(){t.go("tab.tasks")},100)},o.proFile=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("userprofile")},100)},o.adminproFile=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("adminprofile")},100)},o.supportreport=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("reporting"),o.popover.remove()},100)},o.editpro=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("editpro"),o.popover.remove()},100)},o.editavailability=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("editavailability"),o.popover.remove()},100)},o.editrate=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("editrate"),o.popover.remove()},100)},o.sitesurvey=function(e){o.popover.hide(),c.nextDirection("forward"),i(function(){t.go("sitesurvey")},100)},o.clickToCheckout2=function(){console.log("clickToCancel"),l.openConfirm({templateUrl:"../mobile/templates/dialog/checkout2.html",className:"ngdialog-theme-default",scope:o}).then(function(){c.nextDirection("forward"),i(function(){t.go("installationreport")},100),console.log("YES")},function(){console.log("NO")})},o.clickToCheckout3=function(){console.log("clickToCancel"),l.openConfirm({templateUrl:"../mobile/templates/dialog/checkout3.html",className:"ngdialog-theme-default",scope:o}).then(function(){c.nextDirection("forward"),i(function(){t.go("sitesurvey")},100),console.log("YES")},function(){console.log("NO")})},o.clickToCheckout=function(){console.log("clickToCancel"),l.openConfirm({templateUrl:"../mobile/templates/dialog/checkout.html",className:"ngdialog-theme-default",scope:o}).then(function(){c.nextDirection("forward"),i(function(){t.go("reporting"),o.popover.remove()},100),console.log("YES")},function(){console.log("NO")})},o.clickToCheckin=function(){console.log("clickToCheckin"),l.openConfirm({templateUrl:"../mobile/templates/dialog/checkin.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},o.clickToCurrentin=function(){console.log("clickToCurrentin"),l.openConfirm({templateUrl:"../mobile/templates/dialog/currentin.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},a.fromTemplateUrl("../mobile/templates/dialog/addmaterial.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.modal=e}),o.openModal=function(){o.modal.show()},o.closeModal=function(){o.modal.hide()},o.createContact=function(e){o.contacts.push({name:e.firstName+" "+e.lastName}),o.modal.hide()},_.each(o.chats,function(e){"progress"==e.status?o.progressData.push(e):"pending"==e.status?o.pendingData.push(e):"completed"==e.status&&o.completedData.push(e)}),console.log("$scope.progressData: ",o.progressData),console.log("$scope.pendingData: ",o.pendingData),console.log("$scope.completedData: ",o.completedData)})}])}();
=======
!function(){"use strict";angular.module("starter",["ionic","ionic-timepicker","ng.deviceDetector","ngMask","ngDialog","ngFileUpload","angularFileUpload","ionic-datepicker","LocalStorageModule","angularMoment"]).config(["$stateProvider","$urlRouterProvider","ionicTimePickerProvider","$ionicConfigProvider","localStorageServiceProvider",function(t,e,l,a,r){var o={inputTime:60*(new Date).getHours()*60+60*(new Date).getMinutes(),format:12,step:1,setLabel:"Set",closeLabel:"Close"};l.configTimePicker(o),a.backButton.text(""),a.backButton.icon("ion-ios-arrow-left"),a.backButton.previousTitleText(""),a.scrolling.jsScrolling(!0),a.tabs.position("bottom"),r.setStorageType("sessionStorage"),t.state("login",{url:"/login",templateUrl:"templates/login.html",controller:"LoginCtrl"}).state("vendorInfo",{url:"/vendorInfo",templateUrl:"templates/vendorInfo.html",controller:"AccountCtrl"}).state("vendorcontactInfo",{url:"/vendorcontactinfo",templateUrl:"templates/vendorcontactinfo.html"}).state("vendorRate",{url:"/vendorrate",templateUrl:"templates/vendorRate.html",controller:"AccountCtrl"}).state("sent",{url:"/sent",templateUrl:"templates/sent.html",controller:"sentCtrl"}).state("qualification",{url:"/qualification",templateUrl:"templates/qualification.html",controller:"AccountCtrl"}).state("certification",{url:"/certification",templateUrl:"templates/certification.html"}).state("certifications",{url:"/certifications",templateUrl:"templates/certifications.html"}).state("tab",{url:"/tab","abstract":!0,templateUrl:"templates/tabs.html",controller:"MainCtrl"}).state("tab.dash",{url:"/dash",views:{"tab-dash":{templateUrl:"templates/tab-dash.html",controller:"DashCtrl"}}}).state("tab.tasks",{url:"/tasks",views:{"tab-tasks":{templateUrl:"templates/tab-tasks.html",controller:"ChatsCtrl"}}}).state("newdetails",{url:"/newdetails",templateUrl:"templates/newdetails.html",controller:"ChatsCtrl"}).state("progress",{url:"/progress",templateUrl:"templates/progress.html",controller:"ChatsCtrl"}).state("adminprogress",{url:"/adminprogress",templateUrl:"templates/adminprogress.html",controller:"ChatsCtrl"}).state("pendingtask",{url:"/pendingtask",templateUrl:"templates/pendingtask.html",controller:"ChatsCtrl"}).state("forapproval",{url:"/forapproval",templateUrl:"templates/forapproval.html",controller:"ChatsCtrl"}).state("completedtask",{url:"/completedtask",templateUrl:"templates/completedtask.html",controller:"ChatsCtrl"}).state("comptask",{url:"/comptask",templateUrl:"templates/comptask.html",controller:"ChatsCtrl"}).state("reportdone",{url:"/reportdone",templateUrl:"templates/reportdone.html",controller:"ChatsCtrl"}).state("reportdone2",{url:"/reportdone2",templateUrl:"templates/reportdone2.html",controller:"ChatsCtrl"}).state("qow",{url:"/qow",templateUrl:"templates/qow.html",controller:"ChatsCtrl"}).state("userprofile",{url:"/userprofile",templateUrl:"templates/profile.html",controller:"ChatsCtrl"}).state("quotelist",{url:"/quotelist",templateUrl:"templates/quotelist.html",controller:"ChatsCtrl"}).state("quotedetails",{url:"/quotedetails",templateUrl:"templates/qowlist.html",controller:"ChatsCtrl"}).state("approve",{url:"/approve",templateUrl:"templates/approve.html",controller:"ChatsCtrl"}).state("adminprofile",{url:"/adminprofile",templateUrl:"templates/adminprofile.html",controller:"ChatsCtrl"}).state("editpro",{url:"/editpro",templateUrl:"templates/editvendorinfo.html",controller:"ChatsCtrl"}).state("editavailability",{url:"/editavailability",templateUrl:"templates/editavailability.html",controller:"ChatsCtrl"}).state("editrate",{url:"/editrate",templateUrl:"templates/editrate.html",controller:"ChatsCtrl"}).state("reporting",{url:"/supportreport",templateUrl:"templates/supportreport.html",controller:"ChatsCtrl"}).state("installationreport",{url:"/installationreport",templateUrl:"templates/installationreport.html",controller:"ChatsCtrl"}).state("sitesurvey",{url:"/sitesurvey",templateUrl:"templates/sitesurvey.html",controller:"ChatsCtrl"}).state("tab.task-detail",{url:"/tasks/:chatId",views:{"tab-tasks":{templateUrl:"templates/task-detail.html",controller:"ChatDetailCtrl"}}}).state("tab.account",{url:"/account",views:{"tab-account":{templateUrl:"templates/tab-account.html",controller:"DashCtrl"}}}).state("tab.admindash",{url:"/admindash",views:{"tab-admindash":{templateUrl:"templates/tab-admindash.html",controller:"DashCtrl"}}}).state("tab.admintasks",{url:"/admintasks",views:{"tab-admintasks":{templateUrl:"templates/tab-admintask.html",controller:"DashCtrl"}}}).state("tab.adminreport",{url:"/adminreport",views:{"tab-adminreport":{templateUrl:"templates/tab-adminreport.html",controller:"DashCtrl"}}}).state("tab.createtask",{url:"/createtask",views:{"tab-create-task":{templateUrl:"templates/tab-createtask.html",controller:"DashCtrl"}}}),e.otherwise("/login")}])}();
!function(){"use strict";function o(o,e,t,n,c,r,i,l,a,s,d,u){e.ready(function(){window.cordova&&window.cordova.plugins&&window.cordova.plugins.Keyboard&&(cordova.plugins.Keyboard.hideKeyboardAccessoryBar(!0),cordova.plugins.Keyboard.disableScroll(!0)),window.StatusBar&&StatusBar.styleDefault()});var n=n;console.log("deviceDetector: ",n),n.isDesktop()&&(t.location.href="../desktop.html"),o.showPopover=function(e){o.mainPopover.show(e)},o.showPopoveredit=function(e){o.popover1.show(e)},o.myGoBack=function(){console.log("myGoBack"),r.nextDirection("back"),c.goBack()},o.signOut=function(){o.mainPopover.hide(),r.nextDirection("back"),i.remove("user"),l(function(){a.go("login")},100)},o.sign=function(){c.nextViewOptions({disableBack:!0}),r.nextDirection("back"),l(function(){a.go("login")},100)},o.gotToProfile=function(){o.mainPopover.hide(),r.nextDirection("forward"),a.go("userprofile")},o.gotToProf=function(){c.nextViewOptions({disableBack:!0}),r.nextDirection("forward"),a.go("userprofile")},o.comptask=function(){o.$broadcast("closecompletedModal"),r.nextDirection("forward"),a.go("comptask")},o.reportdone=function(){o.$broadcast("closerecentreportModal"),r.nextDirection("forward"),a.go("reportdone")},o.reportdone2=function(){o.$broadcast("closerecentreportModal"),r.nextDirection("forward"),a.go("reportdone2")},o.myreportdone=function(){o.$broadcast("closemyreportModal"),r.nextDirection("forward"),a.go("reportdone")},o.gotoprog=function(e){var t=JSON.parse(i.get("user"));console.log("user: ",t.usertype),o.$broadcast("closetaskinprogressModal"),r.nextDirection("forward"),l(function(){"proc"===t.usertype?(console.log("proc: "),a.go("adminprogress")):(console.log("con: "),a.go("progress"))},100)},o.newTask=function(e){o.$broadcast("closetaskmodal"),r.nextDirection("forward"),l(function(){a.go("newdetails")},100)},o.pendingDetails=function(e){var t=JSON.parse(i.get("user"));console.log("user: ",t.usertype),o.$broadcast("closependingModal"),r.nextDirection("forward"),l(function(){"proc"===t.usertype?(console.log("proc: "),a.go("forapproval")):(console.log("con: "),a.go("pendingtask"))},100)},o.gotToadminProfile=function(){o.mainPopover.hide(),r.nextDirection("forward"),a.go("adminprofile")},o.editProfile=function(){o.popover1.hide(),r.nextDirection("forward"),a.go("editpro")},o.clickToCheckout2=function(){console.log("clickToCancel"),s.openConfirm({templateUrl:"../mobile/templates/dialog/checkout2.html",className:"ngdialog-theme-default",rootScope:o}).then(function(){r.nextDirection("forward"),l(function(){a.go("installationreport")},100),console.log("YES")},function(){console.log("NO")})},o.showCheck=function(){u.confirm({templateUrl:"../mobile/templates/dialog/checkout.html",rootScope:o}).then(function(e){e?(o.$broadcast("closeModal"),o.$broadcast("closetaskinprogressModal"),r.nextDirection("forward"),a.go("installationreport")):console.log("You are not sure")})},o.showCheck2=function(){u.confirm({templateUrl:"../mobile/templates/dialog/checkout.html",rootScope:o}).then(function(e){e?(o.$broadcast("closeModal"),o.$broadcast("closetaskinprogressModal"),r.nextDirection("forward"),a.go("reporting")):console.log("You are not sure")})},o.showCheck3=function(){u.confirm({templateUrl:"../mobile/templates/dialog/checkout.html",rootScope:o}).then(function(e){e?(o.$broadcast("closeModal"),o.$broadcast("closetaskinprogressModal"),r.nextDirection("forward"),a.go("sitesurvey")):console.log("You are not sure")})},o.clickCurrentin=function(){u.alert({templateUrl:"../mobile/templates/dialog/currentin.html",rootScope:o})},o.clickToCheckout=function(){console.log("clickToCancel"),s.openConfirm({templateUrl:"../mobile/templates/dialog/checkout.html",className:"ngdialog-theme-default",rootScope:o}).then(function(){r.nextDirection("forward"),l(function(){a.go("reporting")},100),console.log("YES")},function(){console.log("NO")})},o.clickToCheckout3=function(){console.log("clickToCancel"),s.openConfirm({templateUrl:"../mobile/templates/dialog/checkout3.html",className:"ngdialog-theme-default",rootScope:o}).then(function(){r.nextDirection("forward"),l(function(){a.go("sitesurvey")},100),console.log("YES")},function(){console.log("NO")})},o.clickToCheckout2mod=function(){console.log("clickToCancel"),s.openConfirm({templateUrl:"../mobile/templates/dialog/checkout2.html",className:"ngdialog-theme-default",rootScope:o}).then(function(){c.nextViewOptions({disableBack:!0}),r.nextDirection("forward"),l(function(){a.go("installationreport")},100),console.log("YES")},function(){console.log("NO")})}}angular.module("starter").run(o),o.$inject=["$rootScope","$ionicPlatform","$window","deviceDetector","$ionicHistory","$ionicViewSwitcher","localStorageService","$timeout","$state","ngDialog","$ionicModal","$ionicPopup"]}();
!function(){"use strict";angular.module("starter").controller("DashCtrl",["$scope","$ionicPopover","$state","$timeout","$ionicViewSwitcher","ngDialog","ionicDatePicker","ionicTimePicker","$ionicModal",function(e,o,t,n,c,i,a,l,r){e.clickme=function(){e.model=!0},e.filter={direct:!1,check:!0,check1:!1},e.showModerate=function(){e.filter={direct:!0,check:!1,check1:!1}},e.showHigh=function(){e.filter={direct:!1,check:!0,check1:!1}},e.showLow=function(){e.filter={direct:!1,check:!1,check1:!0}},e.completedTask=function(e){c.nextDirection("forward"),n(function(){t.go("completedtask")},100)},r.fromTemplateUrl("../mobile/templates/dialog/contractorlist.html",{scope:e,animation:"slide-in-up"}).then(function(o){e.modal=o}),e.openModal=function(){e.modal.show()},e.closeModal=function(){e.modal.hide()},e.createContact=function(o){e.contacts.push({name:o.firstName+" "+o.lastName}),e.modal.hide()};({callback:function(e){console.log("Return value from the datepicker popup is : "+e,new Date(e))},disabledDates:[new Date(2016,2,16),new Date(2015,3,16),new Date(2015,4,16),new Date(2015,5,16),new Date("Wednesday, August 12, 2015"),new Date("08-16-2016"),new Date(1439676e6)],from:new Date(2012,1,1),to:new Date(2016,10,30),inputDate:new Date,mondayFirst:!0,disableWeekdays:[0],closeOnSelect:!1,templateType:"popup"});e.openDatePicker=function(){a.openDatePicker({callback:function(o){console.log("Return value from the datepicker popup is sssss: "+o,new Date(o));var t=new Date(o);e.newDate=moment(t).format("MM-DD-YYYY")},disabledDates:[new Date(2016,2,16),new Date(2015,3,16),new Date(2015,4,16),new Date(2015,5,16),new Date("Wednesday, August 12, 2015"),new Date("08-16-2016"),new Date(1439676e6)],from:new Date(2012,1,1),to:new Date(2016,10,30),inputDate:new Date,mondayFirst:!0,disableWeekdays:[0],closeOnSelect:!1,templateType:"popup"})};e.openTime=function(){var o=new Date;l.openTimePicker({callback:function(t){var n=Math.floor(t/60/60),c=t/60%60;o.setHours(n,c);var i=(o.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,c=c<10?"0"+c:c,e.start=n+":"+c+" "+i},inputTime:60*o.getHours()*60+60*o.getMinutes(),format:12})},e.openTime2=function(){var o=new Date;l.openTimePicker({callback:function(t){var n=Math.floor(t/60/60),c=t/60%60;o.setHours(n,c);var i=(o.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,c=c<10?"0"+c:c,e.end=n+":"+c+" "+i},inputTime:60*o.getHours()*60+60*o.getMinutes(),format:12})},e.forApproval=function(e){c.nextDirection("forward"),n(function(){t.go("forapproval")},100)},e.pendingDetails=function(o){e.popover.hide(),c.nextDirection("forward"),n(function(){t.go("pendingtask")},100)},e.clickToCheckout2=function(){console.log("clickToCancel"),i.openConfirm({templateUrl:"../mobile/templates/dialog/checkout2.html",className:"ngdialog-theme-default",scope:e}).then(function(){c.nextDirection("forward"),n(function(){t.go("installationreport")},100),console.log("YES")},function(){console.log("NO")})},e.clickToCheckout3=function(){console.log("clickToCancel"),i.openConfirm({templateUrl:"../mobile/templates/dialog/checkout3.html",className:"ngdialog-theme-default",scope:e}).then(function(){c.nextDirection("forward"),n(function(){t.go("sitesurvey")},100),console.log("YES")},function(){console.log("NO")})},e.clickToCheckout=function(){console.log("clickToCancel"),i.openConfirm({templateUrl:"../mobile/templates/dialog/checkout.html",className:"ngdialog-theme-default",scope:e}).then(function(){c.nextDirection("forward"),n(function(){t.go("reporting")},100),console.log("YES")},function(){console.log("NO")})}}])}();
!function(){"use strict";function t(t,e,n,a,o,i){t.data={username:"",password:""},t.$on("$ionicView.beforeEnter",function(e,n){t.data={username:"",password:"",usertype:""}}),t.login=function(){"proc"==t.data.username&&"123456"==t.data.password?(t.data.usertype="proc",a.set("user",JSON.stringify(t.data)),e.nextDirection("forward"),i(function(){n.go("tab.admindash")},300)):"con"==t.data.username&&"123456"==t.data.password?(t.data.usertype="con",a.set("user",JSON.stringify(t.data)),e.nextDirection("forward"),i(function(){n.go("tab.dash")},300)):o.alert({title:"Invalid Account",template:"Username and Password not match!!!"})}}function e(t,e,n,a){t.sent=function(){a.nextViewOptions({disableBack:!0}),e.nextDirection("forward"),n.go("login")}}angular.module("starter").controller("LoginCtrl",t).controller("sentCtrl",e),e.$inject=["$scope","$ionicViewSwitcher","$state","$ionicHistory"],t.$inject=["$scope","$ionicViewSwitcher","$state","localStorageService","$ionicPopup","$timeout"]}();
!function(){"use strict";function o(o,t,e,n,i,a,r,s,u,l){o.data={},o.inputs=[],o.input=[],o.inputs.start={},o.rates=[],o.weekdays=i.all(),o.rate={},o.groups=[],o.othersList=[],o.others={};for(var c=0;c<1;c++){o.groups[c]={name:c,items:[]};for(var m=0;m<1;m++)o.groups[c].items.push(c+"-"+m)}null==localStorage.getItem("mytodos")?(o.todoList=[{todoText:"Create app",done:!1}],localStorage.setItem("mytodos",angular.toJson(o.todoList))):o.todoList=angular.fromJson(localStorage.getItem("mytodos")),o.clickToCancel=function(){console.log("clickToCancel"),r.openConfirm({templateUrl:"../mobile/templates/dialog/cancel.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},o.clickToterm=function(){console.log("clickToterm"),r.openConfirm({templateUrl:"../mobile/templates/dialog/termandcondition.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},t.fromTemplateUrl("../mobile/templates/dialog/termandcondition.html",{scope:o,animation:"slide-in-up"}).then(function(t){o.modal=t}),o.openModal=function(){o.modal.show()},o.closeModal=function(){o.modal.hide()},o.addOthers=function(t){_.isEmpty(t)||(o.othersList.push(t),o.others={})},o.proFile=function(t){o.popover.hide(),l.nextDirection("forward"),n(function(){s.go("userprofile")},100)},o.removeOther=function(t){o.othersList.splice(t,1)},o.addArea=function(){o.input.push({})},o.addSched=function(){o.inputs.push({})},o.showPopup=function(){var o=e.alert({title:"Terms and Conditions",content:"",buttons:[{text:"Close",type:"button-positive",onTap:function(o){return!0}}]});o.then(function(o){console.log("Thank you for not eating my delicious ice cream cone")})},o.showCancel=function(){e.confirm({title:"",template:"Are you sure you want to cancel application?"}).then(function(o){o?(u.nextViewOptions({disableBack:!0}),l.nextDirection("back"),s.go("login")):console.log("You are not sure")})},o.showConfirm=function(){e.confirm({title:"",template:"Are you sure you want to submit application?"}).then(function(o){o?(u.nextViewOptions({disableBack:!0}),l.nextDirection("forward"),s.go("sent")):console.log("You are not sure")})},o.todoAdd=function(){o.todoList.push({todoText:o.todoInput,done:!1}),o.todoInput="",localStorage.setItem("mytodos",angular.toJson(o.todoList))},o.remove=function(){var t=o.todoList;o.todoList=[],angular.forEach(t,function(t){t.done||o.todoList.push(t)}),localStorage.setItem("mytodos",angular.toJson(o.todoList))},o.update=function(){setTimeout(function(){localStorage.setItem("mytodos",angular.toJson(o.todoList))},100)},o.toggleGroup=function(t){o.isGroupShown(t)?o.shownGroup=null:o.shownGroup=t},o.isGroupShown=function(t){return o.shownGroup===t},null==localStorage.getItem("mytodos")?(o.todoList=[{todoText:"Create app",done:!1}],localStorage.setItem("mytodos",angular.toJson(o.todoList))):o.todoList=angular.fromJson(localStorage.getItem("mytodos")),t.fromTemplateUrl("termcon.html",{scope:o,animation:"slide-in-up"}).then(function(t){o.modal=t}),o.openModal=function(){o.modal.show()},o.closeModal=function(){o.modal.hide()},o.increaseHours=function(){o.time.hours=Number(o.time.hours),12==o.mainObj.format&&(12!=o.time.hours?o.time.hours+=1:o.time.hours=1),24==o.mainObj.format&&(o.time.hours=(o.time.hours+1)%24),o.time.hours=o.time.hours<10?"0"+o.time.hours:o.time.hours};o.openTime=function(t){o.data.created=new Date,a.openTimePicker({callback:function(t){var e=Math.floor(t/60/60),n=t/60%60;o.data.created.setHours(e,n);var i=(o.data.created.getHours(),e>=12?"PM":"AM");e%=12,e=e?e:12,n=n<10?"0"+n:n,o.start=e+":"+n+" "+i},inputTime:60*o.data.created.getHours()*60+60*o.data.created.getMinutes(),format:12})},o.openTime2=function(){var t=new Date;a.openTimePicker({callback:function(e){var n=Math.floor(e/60/60),i=e/60%60;t.setHours(n,i);var a=(t.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,i=i<10?"0"+i:i,o.end=n+":"+i+" "+a},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},o.openTime3=function(o){var t=new Date;a.openTimePicker({callback:function(e){var n=Math.floor(e/60/60),i=e/60%60;t.setHours(n,i);var a=(t.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,i=i<10?"0"+i:i,o.start=n+":"+i+" "+a},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},o.openTime4=function(o){var t=new Date;a.openTimePicker({callback:function(e){var n=Math.floor(e/60/60),i=e/60%60;t.setHours(n,i);var a=(t.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,i=i<10?"0"+i:i,o.end=n+":"+i+" "+a},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},o.addRate=function(t){_.isUndefined(t)||o.rates.push({amount:t.amount,weekday:t.weekday,note:t.note})}}angular.module("starter").controller("AccountCtrl",o),o.$inject=["$scope","$ionicModal","$ionicPopup","$timeout","WeekDays","ionicTimePicker","ngDialog","$state","$ionicHistory","$ionicViewSwitcher"]}();
!function(){"use strict";function o(o,e,l,n,t){o.user={},o.isa=!1,o.duha=!1,o.tulo=!1,o.opat=!1;var a=JSON.parse(e.get("user"));o.user=a,o.groups=[];for(var s=0;s<1;s++){o.groups[s]={name:s,items:[]};for(var i=0;i<1;i++)o.groups[s].items.push(s+"-"+i)}null==localStorage.getItem("mytodos")?(o.todoList=[{todoText:"Create app",done:!1}],localStorage.setItem("mytodos",angular.toJson(o.todoList))):o.todoList=angular.fromJson(localStorage.getItem("mytodos")),o.toggleGroup=function(o){o.show=!o.show},o.isGroupShown=function(o){return o.show},l.fromTemplateUrl("../mobile/templates/dialog/editpro.html",{rootScope:n}).then(function(o){n.popover1=o}),l.fromTemplateUrl("../mobile/templates/dialog/submit.html",{scope:o}).then(function(o){n.mainPopover=o}),n.$on("closeModal",function(){console.log("closetaskmodal"),o.progressModal.hide()}),t.fromTemplateUrl("../mobile/templates/dialog/progress.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.progressModal=e}),o.opendetailsModal=function(){console.log("opendetailsModal"),o.progressModal.show()},o.closeModal=function(){o.progressModal.hide()},n.$on("closetaskinprogressModal",function(){console.log("closetaskmodal"),o.taskinprogressModal.hide()}),t.fromTemplateUrl("../mobile/templates/dialog/taskinprogress.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.taskinprogressModal=e}),o.opentaskinprogressModal=function(){o.taskinprogressModal.show()},o.closetaskinprogressModal=function(){o.taskinprogressModal.hide()},n.$on("closependingModal",function(){o.pendingModal.hide()}),t.fromTemplateUrl("../mobile/templates/dialog/pending.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.pendingModal=e}),o.openpendingModal=function(){console.log("openpendingModal"),o.pendingModal.show()},o.closependingModal=function(){o.pendingModal.hide()},t.fromTemplateUrl("../mobile/templates/dialog/newtask.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.newtaskModal=e}),n.$on("closetaskmodal",function(){console.log("closetaskmodal"),o.newtaskModal.hide()}),o.opennewtaskModal=function(){console.log("opendetailsModal"),o.newtaskModal.show()},o.closenewtaskModal=function(){o.newtaskModal.hide()},t.fromTemplateUrl("../mobile/templates/dialog/completed.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.completedModal=e}),n.$on("closecompletedModal",function(){o.completedModal.hide()}),o.opencompletedModal=function(){console.log("opendetailsModal"),o.completedModal.show()},o.closecompletedModal=function(){o.completedModal.hide()},n.$on("closerecentreportModal",function(){console.log("closetaskmodal"),o.recentreportModal.hide()}),t.fromTemplateUrl("../mobile/templates/dialog/recentlysentreport.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.recentreportModal=e}),o.openrecentreportModal=function(){console.log("opendetailsModal"),o.recentreportModal.show()},o.closerecentreportModal=function(){o.recentreportModal.hide()},n.$on("closemyreportModal",function(){o.myreportModal.hide()}),t.fromTemplateUrl("../mobile/templates/dialog/myreports.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.myreportModal=e}),o.openmyreportModal=function(){console.log("opendetailsModal"),o.myreportModal.show()},o.closemyreportModal=function(){o.myreportModal.hide()}}angular.module("starter").controller("MainCtrl",o),o.$inject=["$scope","localStorageService","$ionicPopover","$rootScope","$ionicModal"]}();
!function(){"use strict";angular.module("starter").controller("ChatsCtrl",["$scope","Chats","$ionicPopover","$state","$timeout","$ionicViewSwitcher","ngDialog","$ionicModal","$ionicPopup",function(o,e,t,n,i,a,c,r,p){o.$on("$ionicView.enter",function(s){o.progressData=[],o.pendingData=[],o.completedData=[],o.contacts=[],console.log("$scope.contacts:",o.contacts),o.chats=e.all(),o.isa=!1,o.duha=!1,o.tulo=!1,o.opat=!1,o.clickable=function(){console.log("padulong diri")},t.fromTemplateUrl("../mobile/templates/dialog/popadmin.html",{scope:o}).then(function(e){o.popover2=e}),o.showPopoveradmin=function(e){o.popover2.show(e)},o.completedTask=function(o){a.nextDirection("forward"),i(function(){n.go("completedtask")},100)},o.clickDecline=function(e){o.popover.hide(),a.nextDirection("back"),i(function(){n.go("tab.tasks")},100)},o.showConfirm=function(){p.confirm({title:"",template:"Are you sure you want to assign the task to Lorem Impatsu?"}).then(function(o){o?(a.nextDirection("forward"),n.go("approve")):console.log("You are not sure")})},o.supportreport=function(e){o.popover.hide(),a.nextDirection("forward"),i(function(){n.go("reporting"),o.popover.remove()},100)},o.editpro=function(e){o.popover.hide(),a.nextDirection("forward"),i(function(){n.go("editpro"),o.popover.remove()},100)},o.editavailability=function(e){o.popover.hide(),a.nextDirection("forward"),i(function(){n.go("editavailability"),o.popover.remove()},100)},o.editrate=function(e){o.popover.hide(),a.nextDirection("forward"),i(function(){n.go("editrate"),o.popover.remove()},100)},o.sitesurvey=function(e){o.popover.hide(),a.nextDirection("forward"),i(function(){n.go("sitesurvey")},100)},o.clickToCheckin=function(){console.log("clickToCheckin"),c.openConfirm({templateUrl:"../mobile/templates/dialog/checkin.html",className:"ngdialog-theme-default",scope:o}).then(function(){console.log("YES")},function(){console.log("NO")})},r.fromTemplateUrl("../mobile/templates/dialog/addmaterial.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.modal=e}),o.openModal=function(){o.modal.show()},o.closeModal=function(){o.modal.hide()},o.createContact=function(e){o.contacts.push({name:e.firstName,description:e.description,rate:e.rate}),o.modal.hide()},_.each(o.chats,function(e){"progress"==e.status?o.progressData.push(e):"pending"==e.status?o.pendingData.push(e):"completed"==e.status&&o.completedData.push(e)}),console.log("$scope.progressData: ",o.progressData),console.log("$scope.pendingData: ",o.pendingData),console.log("$scope.completedData: ",o.completedData)})}])}();
>>>>>>> master2
!function(){"use strict";angular.module("starter").factory("Chats",function(){var e=[{id:0,name:"Digital Ticket Testing",client:"Telstra",date_created:new Date,status:"progress",priority:"normal"},{id:1,name:"Network Setup",client:"7-Eleven",date_created:new Date,status:"progress",priority:"normal"},{id:2,name:"Hardware Installation",client:"Telstra",date_created:new Date,status:"progress",priority:"low"},{id:3,name:"Hardware Installation",client:"7-Evelen",date_created:new Date,status:"pending",priority:"high"},{id:4,name:"Network Setup",client:"BUPA",date_created:new Date,status:"pending",priority:"normal"},{id:5,name:"Hardware Installation",client:"NAB",date_created:new Date,status:"pending",priority:"low"},{id:6,name:"Hardware Installation",client:"Forever New",date_created:new Date,status:"completed",priority:"low"},{id:7,name:"Network Setup",client:"NAB",date_created:new Date,status:"completed",priority:"low"}];return{all:function(){return e},remove:function(t){e.splice(e.indexOf(t),1)},get:function(t){for(var a=0;a<e.length;a++)if(e[a].id===parseInt(t))return e[a];return null}}}).factory("WeekDays",function(){var e=[{id:0,name:"Base Rate",label:"Base Rate"},{id:1,name:"After Hours",label:"After Hours"},{id:2,name:"Weekend",label:"Weekend"}];return{all:function(){return e},get:function(t){for(var a=0;a<e.length;a++)if(e[a].id===parseInt(t))return e[a];return null}}})}();
!function(){"use strict";angular.module("starter").directive("errSrc",function(){return{link:function(o,n,t){o.$watch(function(){return t.ngSrc},function(o){o||n.attr("src",t.errSrc)}),n.bind("error",function(){n.attr("src",t.errSrc)})}}}).directive("validNumber",function(){return{require:"?ngModel",link:function(o,n,t,e){e&&(e.$parsers.push(function(o){if(angular.isUndefined(o))var o="";var n=o.replace(/[^-0-9\.]/g,""),t=n.split("-"),l=n.split(".");return angular.isUndefined(t[1])||(t[1]=t[1].slice(0,t[1].length),n=t[0]+"-"+t[1],t[0].length>0&&(n=t[0])),angular.isUndefined(l[1])||(l[1]=l[1].slice(0,2),n=l[0]+"."+l[1]),o!==n&&(e.$setViewValue(n),e.$render()),n}),n.bind("keypress",function(o){32===o.keyCode&&o.preventDefault()}))}}}).directive("ionFloatingButton",function(){return{restrict:"E",scope:{click:"&?",buttonColor:"@?",buttonClass:"@?",icon:"@?",iconColor:"@?",hasFooter:"=?"},template:'<ul id="floating-button" ng-style="{\'bottom\' : \'{{bottomValue}}\' }"><li ng-class="buttonClass" ng-style="{\'background-color\': buttonColor }"><a ng-click="click()"><i class="icon menu-icon" ng-class="{ \'{{icon}}\' : true}" ng-style="{\'color\': iconColor }"></i></a></li></ul>',replace:!0,transclude:!0,controller:["$scope",function(o){o.buttonColor=o.buttonColor||"#2AC9AA",o.icon=o.icon||"ion-plus",o.iconColor=o.iconColor||"#fff",o.hasFooter=o.hasFooter||!1,o.hasFooter?o.bottomValue="60px":o.bottomValue="20px"}]}}).directive("ionFloatingMenu",function(){return{restrict:"E",scope:{menuOpenColor:"@?",menuOpenIcon:"@?",menuOpenIconColor:"@?",menuColor:"@?",menuIcon:"@?",menuIconColor:"@?",hasFooter:"=?"},template:'<ul id="floating-menu"  \n                            ng-style="{\'bottom\' : \'{{bottomValue}}\'}" \n                            ng-class="{\'active\' : isOpen}" \n                            ng-click="open()"><div ng-transclude></div><span><li class="menu-button icon menu-icon" ng-class="icon" ng-style="{\'background-color\' : buttonColor, \'color\': iconColor}"></li></span></ul>',replace:!0,transclude:!0,link:function(o,n,t,e,l){n.find("div").replaceWith(l())},controller:["$scope",function(o){o.isOpen=!1,o.open=function(){o.isOpen=!o.isOpen,o.isOpen?o.setOpen():o.setClose()},o.setOpen=function(){o.buttonColor=l,o.icon=i,o.iconColor=r},o.setClose=function(){o.buttonColor=n,o.icon=t,o.iconColor=e};var n=o.menuColor||"#2AC9AA",t=o.menuIcon||"ion-plus",e=o.menuIconColor||"#fff",l=o.menuOpenColor||"#2AC9AA",i=o.menuOpenIcon||"ion-minus",r=o.menuOpenIconColor||"#fff";o.setClose(),o.hasFooter=o.hasFooter||!1,o.hasFooter?o.bottomValue="60px":o.bottomValue="20px"}]}}).directive("ionFloatingItem",function(){return{restrict:"E",require:["^ionFloatingMenu"],scope:{click:"&?",icon:"@",buttonColor:"@?",buttonClass:"@?",iconColor:"@?",text:"@?",textClass:"@?"},template:'<li ng-click="click()" ng-class="buttonClass" ng-style="{\'background-color\': buttonColor }"><span ng-if="text" class="label-container"><span class="label" ng-class="textClass" ng-bind="text"></span></span><i class="icon menu-icon" ng-class="{ \'{{icon}}\' : true}" ng-style="{\'color\': iconColor }"></i></li>',replace:!0,controller:["$scope",function(o){o.buttonColor=o.buttonColor||"#2AC9AA",o.iconColor=o.iconColor||"#fff"}]}})}();