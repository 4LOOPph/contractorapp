...
!function(){"use strict";angular.module("starter",["ionic","ionic-timepicker","ng.deviceDetector","ionic-datepicker","LocalStorageModule","angularMoment","ngMessages","ionic-toast","ion-autocomplete"]).config(["$stateProvider","$urlRouterProvider","ionicTimePickerProvider","$ionicConfigProvider","localStorageServiceProvider",function(t,e,o,i,l){var r={inputTime:60*(new Date).getHours()*60+60*(new Date).getMinutes(),format:12,step:1,setLabel:"Set",closeLabel:"Close"};o.configTimePicker(r),i.backButton.text(""),i.backButton.icon("ion-ios-arrow-left"),i.backButton.previousTitleText(""),i.scrolling.jsScrolling(!0),i.tabs.position("bottom"),l.setStorageType("sessionStorage"),t.state("login",{url:"/login",templateUrl:"templates/login.html",controller:"LoginCtrl"}).state("vendorInfo",{url:"/vendorinfo",templateUrl:"./templates/application/vendorInfo.html",controller:"VendorInfoCtrl"}).state("vendorRate",{url:"/vendorrate",templateUrl:"./templates/application/vendorRate.html",controller:"VendorRateCtrl"}).state("qualification",{url:"/qualification",templateUrl:"./templates/application/qualification.html",controller:"VendorQualificationCtrl"}).state("sent",{url:"/sent",templateUrl:"./templates/application/sent.html",controller:"sentCtrl"}).state("certification",{url:"/certification",templateUrl:"templates/certification.html"}).state("certifications",{url:"/certifications",templateUrl:"templates/certifications.html"}),e.otherwise("/login")}])}();
!function(){"use strict";angular.module("starter").config(["$stateProvider",function(t){t.state("tab",{url:"/tab","abstract":!0,templateUrl:"templates/contractor/tabs.html",controller:"MainCtrl"}).state("tab.dash",{url:"/dash",views:{"tab-dash":{templateUrl:"templates/contractor/tab-dash.html",controller:"ChatsCtrl"}}}).state("tab.tasks",{url:"/tasks",views:{"tab-tasks":{templateUrl:"templates/tab-tasks.html",controller:"ChatsCtrl"}}}).state("newdetails",{url:"/newdetails",templateUrl:"templates/newdetails.html",controller:"ChatsCtrl"}).state("detailsH",{url:"/detailsH",templateUrl:"templates/detailsH.html",controller:"ChatsCtrl"}).state("detailsM",{url:"/detailsM",templateUrl:"templates/detailsM.html",controller:"ChatsCtrl"}).state("detailsL",{url:"/detailsL",templateUrl:"templates/detailsL.html",controller:"ChatsCtrl"}).state("adminprogress",{url:"/adminprogress",templateUrl:"templates/adminprogress.html",controller:"ChatsCtrl"}).state("pendingtask",{url:"/pendingtask",templateUrl:"templates/pendingtask.html",controller:"ChatsCtrl"}).state("forapproval",{url:"/forapproval",templateUrl:"templates/forapproval.html",controller:"ChatsCtrl"}).state("completedtask",{url:"/completedtask",templateUrl:"templates/completedtask.html",controller:"ChatsCtrl"}).state("comptask",{url:"/comptask",templateUrl:"templates/comptask.html",controller:"ChatsCtrl"}).state("reportdone",{url:"/reportdone",templateUrl:"templates/reportdone.html",controller:"ChatsCtrl"}).state("reportdone2",{url:"/reportdone2",templateUrl:"templates/reportdone2.html",controller:"ChatsCtrl"}).state("qow",{url:"/qow",templateUrl:"templates/qow.html",controller:"ChatsCtrl"}).state("userprofile",{url:"/userprofile",templateUrl:"templates/profile.html",controller:"ChatsCtrl"})}])}();
!function(){"use strict";angular.module("starter").config(["$stateProvider",function(t){t.state("tab-procure",{url:"/tab","abstract":!0,templateUrl:"templates/procurement/tabs.html",controller:"MainCtrl"}).state("tab-procure.task-detail",{url:"/tasks/:chatId",views:{"tab-tasks":{templateUrl:"templates/procurement/task-detail.html",controller:"ChatDetailCtrl"}}}).state("tab-procure.account",{url:"/account",views:{"tab-account":{templateUrl:"templates/tab-account.html",controller:"DashCtrl"}}}).state("tab-procure.admindash",{url:"/admindash",views:{"tab-admindash":{templateUrl:"templates/tab-admindash.html",controller:"DashCtrl"}}}).state("tab-procure.admintasks",{url:"/admintasks",views:{"tab-admintasks":{templateUrl:"templates/tab-admintask.html",controller:"ChatsCtrl"}}}).state("tab-procure.adminreport",{url:"/adminreport",views:{"tab-adminreport":{templateUrl:"templates/tab-adminreport.html",controller:"DashCtrl"}}}).state("tab-procure.createtask",{url:"/createtask",views:{"tab-create-task":{templateUrl:"templates/tab-createtask.html",controller:"DashCtrl"}}}).state("quotelist",{url:"/quotelist",templateUrl:"templates/quotelist.html",controller:"ChatsCtrl"}).state("quotedetails",{url:"/quotedetails",templateUrl:"templates/qowlist.html",controller:"ChatsCtrl"}).state("approve",{url:"/approve",templateUrl:"templates/approve.html",controller:"ChatsCtrl"}).state("adminprofile",{url:"/adminprofile",templateUrl:"templates/adminprofile.html",controller:"ChatsCtrl"}).state("editpro",{url:"/editpro",templateUrl:"templates/editvendorinfo.html",controller:"ChatsCtrl"}).state("editavailability",{url:"/editavailability",templateUrl:"templates/editavailability.html",controller:"ChatsCtrl"}).state("editrate",{url:"/editrate",templateUrl:"templates/editrate.html",controller:"ChatsCtrl"}).state("reporting",{url:"/supportreport/:id",templateUrl:"templates/supportreport.html",controller:"ChatsCtrl"}).state("installationreport",{url:"/installationreport/:id",templateUrl:"templates/installationreport.html",controller:"ChatsCtrl"}).state("sitesurvey",{url:"/sitesurvey/:id",templateUrl:"templates/sitesurvey.html",controller:"ChatsCtrl"})}])}();
!function(){"use strict";function o(o,t,e,n,r,a,i,c,s,d,l){t.ready(function(){window.cordova&&window.cordova.plugins&&window.cordova.plugins.Keyboard&&(cordova.plugins.Keyboard.hideKeyboardAccessoryBar(!0),cordova.plugins.Keyboard.disableScroll(!0)),window.StatusBar&&StatusBar.styleDefault()});var n=n;n.isDesktop()&&(e.location.href="../desktop.html"),o.dreport=function(){l.alert({title:"",template:"Report has been downloaded"})},o.dimage=function(){l.alert({title:"",template:"Images downloaded"})},o.showPopover=function(t){o.mainPopover.show(t)},o.showPopoveredit=function(t){o.popover1.show(t)},o.myGoBack=function(){console.log("myGoBack"),a.nextDirection("back"),r.goBack()},o.signOut=function(){o.mainPopover.hide(),a.nextDirection("back"),i.remove("user"),c(function(){s.go("login")},100)},o.sign=function(){r.nextViewOptions({disableBack:!0}),a.nextDirection("back"),c(function(){s.go("login")},100)},o.gotToProfile=function(){o.mainPopover.hide(),a.nextDirection("forward"),s.go("userprofile")},o.gotToProf=function(){r.nextViewOptions({disableBack:!0}),a.nextDirection("forward"),s.go("userprofile")},o.comptask=function(){o.$broadcast("closecompletedModal"),a.nextDirection("forward"),s.go("comptask")},o.reportdone=function(){o.$broadcast("closerecentreportModal"),a.nextDirection("forward"),s.go("reportdone")},o.reportdone2=function(){o.$broadcast("closerecentreportModal"),a.nextDirection("forward"),s.go("reportdone2")},o.myreportdone=function(){o.$broadcast("closemyreportModal"),a.nextDirection("forward"),s.go("reportdone")},o.gotoprog=function(t){var e=JSON.parse(i.get("user"));console.log("user: ",e.usertype),o.$broadcast("closetaskinprogressModal"),a.nextDirection("forward"),c(function(){"proc"===e.usertype?(console.log("proc: "),s.go("adminprogress")):(console.log("con: "),s.go("detailsH"))},100)},o.detailsH=function(t){o.$broadcast("closetaskinprogressModal"),o.$broadcast("closetaskmodal"),o.$broadcast("closecompletedModal"),o.$broadcast("closependingModal"),a.nextDirection("forward"),c(function(){s.go("detailsH")},100)},o.detailsM=function(t){o.$broadcast("closetaskinprogressModal"),o.$broadcast("closetaskmodal"),o.$broadcast("closecompletedModal"),o.$broadcast("closependingModal"),a.nextDirection("forward"),c(function(){s.go("detailsM")},100)},o.detailsL=function(t){o.$broadcast("closetaskinprogressModal"),o.$broadcast("closetaskmodal"),o.$broadcast("closecompletedModal"),o.$broadcast("closependingModal"),a.nextDirection("forward"),c(function(){s.go("detailsL")},100)},o.newTask=function(t){o.$broadcast("closetaskmodal"),a.nextDirection("forward"),c(function(){s.go("newdetails")},100)},o.newTaskqow=function(t){o.$broadcast("closetaskmodal"),a.nextDirection("forward"),c(function(){s.go("qow")},100)},o.qowlist=function(t){o.$broadcast("closetaskinprogressModal"),o.$broadcast("closetaskmodal"),a.nextDirection("forward"),c(function(){s.go("quotelist")},100)},o.pendingDetails=function(t){var e=JSON.parse(i.get("user"));console.log("user: ",e.usertype),o.$broadcast("closependingModal"),a.nextDirection("forward"),c(function(){"proc"===e.usertype?(console.log("proc: "),s.go("forapproval")):(console.log("con: "),s.go("pendingtask"))},100)},o.gotToadminProfile=function(){o.mainPopover.hide(),a.nextDirection("forward"),s.go("adminprofile")},o.editProfile=function(){o.popover1.hide(),a.nextDirection("forward"),s.go("editpro")},o.showCheck=function(){l.confirm({title:"",template:"Complete Task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(t){t&&(o.$broadcast("closeModal"),o.$broadcast("closetaskinprogressModal"),a.nextDirection("forward"),s.go("installationreport"))}}]})},o.showCheck2=function(){l.confirm({title:"",template:"Complete Task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(t){t&&(o.$broadcast("closeModal"),o.$broadcast("closetaskinprogressModal"),a.nextDirection("forward"),s.go("reporting"))}}]})},o.showCheck3=function(){l.confirm({title:"",template:"Complete Task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(t){t&&(o.$broadcast("closeModal"),o.$broadcast("closetaskinprogressModal"),a.nextDirection("forward"),s.go("sitesurvey"))}}]})},o.clickCurrentin=function(){l.alert({templateUrl:"../mobile/templates/dialog/currentin.html",rootScope:o})},o.tasksend=function(){l.alert({title:"",template:"Your task has been sent"}).then(function(o){a.nextDirection("back"),s.go("tab.admintasks")})}}angular.module("starter").run(o),o.$inject=["$rootScope","$ionicPlatform","$window","deviceDetector","$ionicHistory","$ionicViewSwitcher","localStorageService","$timeout","$state","$ionicModal","$ionicPopup"]}();
...
!function(){"use strict";angular.module("starter").controller("DashCtrl",["$scope","$ionicPopover","$state","$timeout","$ionicViewSwitcher","ionicDatePicker","ionicTimePicker","$ionicModal","localStorageService","$ionicPopup",function(e,t,o,n,a,i,c,r,l,s){e.$on("$ionicView.beforeEnter",function(t){e.tasklist=angular.fromJson(localStorage.getItem("tasklist")),console.log("$scope.tasklist:",e.tasklist)}),e.clickme=function(){e.model=!0},e.filter={direct:!1,check:!0,check1:!1},e.showModerate=function(){e.filter={direct:!0,check:!1,check1:!1}},e.showHigh=function(){e.filter={direct:!1,check:!0,check1:!1}},e.showLow=function(){e.filter={direct:!1,check:!1,check1:!0}},e.completedTask=function(e){a.nextDirection("forward"),n(function(){o.go("completedtask")},100)},r.fromTemplateUrl("../mobile/templates/dialog/contractorlist.html",{scope:e,animation:"slide-in-up"}).then(function(t){e.modal=t}),e.openModal=function(){e.modal.show()},e.closeModal=function(){e.modal.hide()},e.createContact=function(t){e.contacts.push({name:t.firstName+" "+t.lastName}),e.modal.hide()};({callback:function(e){console.log("Return value from the datepicker popup is : "+e,new Date(e))},disabledDates:[new Date(2016,2,16),new Date(2015,3,16),new Date(2015,4,16),new Date(2015,5,16),new Date("Wednesday, August 12, 2015"),new Date("08-16-2016"),new Date(1439676e6)],from:new Date(2012,1,1),to:new Date(2016,10,30),inputDate:new Date,mondayFirst:!0,disableWeekdays:[0],closeOnSelect:!1,templateType:"popup"});e.openDatePicker=function(){i.openDatePicker({callback:function(t){console.log("Return value from the datepicker popup is sssss: "+t,new Date(t));var o=new Date(t);e.newDate=moment(o).format("MM-DD-YYYY")},disabledDates:[new Date(2016,2,16),new Date(2015,3,16),new Date(2015,4,16),new Date(2015,5,16),new Date("Wednesday, August 12, 2015"),new Date("08-16-2016"),new Date(1439676e6)],from:new Date(2012,1,1),to:new Date(2016,10,30),inputDate:new Date,mondayFirst:!0,disableWeekdays:[0],closeOnSelect:!1,templateType:"popup"})};e.openTime=function(){var t=new Date;c.openTimePicker({callback:function(o){var n=Math.floor(o/60/60),a=o/60%60;t.setHours(n,a);var i=(t.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,a=a<10?"0"+a:a,e.start=n+":"+a+" "+i},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},e.openTime2=function(){var t=new Date;c.openTimePicker({callback:function(o){var n=Math.floor(o/60/60),a=o/60%60;t.setHours(n,a);var i=(t.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,a=a<10?"0"+a:a,e.end=n+":"+a+" "+i},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},e.forApproval=function(e){a.nextDirection("forward"),n(function(){o.go("forapproval")},100)},e.pendingDetails=function(t){e.popover.hide(),a.nextDirection("forward"),n(function(){o.go("pendingtask")},100)},e.createTask=function(e){e.$valid&&console.log("form valid")}}])}();
