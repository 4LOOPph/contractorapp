...
!function(){"use strict";angular.module("ion-autocomplete",[]).directive("ionAutocomplete",["$ionicBackdrop","$ionicScrollDelegate","$document","$q","$parse","$interpolate","$ionicPlatform","$compile","$templateRequest",function(e,t,i,n,o,l,a,s,c){return{require:["ngModel","ionAutocomplete"],restrict:"A",scope:{},bindToController:{ngModel:"=",externalModel:"=",templateData:"=",itemsMethod:"&",itemsClickedMethod:"&",itemsRemovedMethod:"&",modelToItemMethod:"&",cancelButtonClickedMethod:"&",placeholder:"@",cancelLabel:"@",selectItemsLabel:"@",selectedItemsLabel:"@"},controllerAs:"viewModel",controller:["$attrs","$timeout","$scope",function(e,t,i){var n=function(e,t){return e?e:t},o=this;t(function(){o.placeholder=n(o.placeholder,"Click to enter a value..."),o.cancelLabel=n(o.cancelLabel,"Done"),o.selectItemsLabel=n(o.selectItemsLabel,"Select an item..."),o.selectedItemsLabel=n(o.selectedItemsLabel,l("Selected items{{maxSelectedItems ? ' (max. ' + maxSelectedItems + ')' : ''}}:")(o))}),this.maxSelectedItems=n(e.maxSelectedItems,void 0),this.templateUrl=n(e.templateUrl,void 0),this.itemsMethodValueKey=n(e.itemsMethodValueKey,void 0),this.itemValueKey=n(e.itemValueKey,void 0),this.itemViewValueKey=n(e.itemViewValueKey,void 0),this.componentId=n(e.componentId,void 0),this.loadingIcon=n(e.loadingIcon,void 0),this.manageExternally=n(e.manageExternally,"false"),this.ngModelOptions=n(i.$eval(e.ngModelOptions),{}),this.showLoadingIcon=!1,this.searchItems=[],this.selectedItems=[],this.searchQuery=void 0,this.isArray=function(e){return angular.isArray(e)}}],link:function(l,r,d,m){var u=m[0],h=m[1];h.randomCssClass="ion-autocomplete-random-"+Math.floor(1e3*Math.random()+1);var I=['<div class="ion-autocomplete-container '+h.randomCssClass+' modal" style="display: none;">','<div class="bar bar-header item-input-inset">','<label class="item-input-wrapper">','<i class="icon ion-search placeholder-icon"></i>','<input type="search" class="ion-autocomplete-search" ng-model="viewModel.searchQuery" ng-model-options="viewModel.ngModelOptions" placeholder="{{viewModel.placeholder}}"/>',"</label>",'<div class="ion-autocomplete-loading-icon" ng-if="viewModel.showLoadingIcon && viewModel.loadingIcon"><ion-spinner icon="{{viewModel.loadingIcon}}"></ion-spinner></div>','<button class="ion-autocomplete-cancel button button-clear" ng-click="viewModel.cancelClick()">{{viewModel.cancelLabel}}</button>',"</div>",'<ion-content class="has-header">','<ion-item class="item-divider">{{viewModel.selectedItemsLabel}}</ion-item>','<ion-item ng-if="viewModel.isArray(viewModel.selectedItems)" ng-repeat="selectedItem in viewModel.selectedItems track by $index" class="item-icon-left item-icon-right item-text-wrap">','<i class="icon ion-checkmark"></i>',"{{viewModel.getItemValue(selectedItem, viewModel.itemViewValueKey)}}",'<i class="icon ion-trash-a" style="cursor:pointer" ng-click="viewModel.removeItem($index)"></i>',"</ion-item>",'<ion-item ng-if="!viewModel.isArray(viewModel.selectedItems)" class="item-icon-left item-icon-right item-text-wrap">','<i class="icon ion-checkmark"></i>',"{{viewModel.getItemValue(viewModel.selectedItems, viewModel.itemViewValueKey)}}",'<i class="icon ion-trash-a" style="cursor:pointer" ng-click="viewModel.removeItem(0)"></i>',"</ion-item>",'<ion-item class="item-divider" ng-if="viewModel.searchItems.length > 0">{{viewModel.selectItemsLabel}}</ion-item>','<ion-item ng-repeat="item in viewModel.searchItems" item-height="55px" item-width="100%" ng-click="viewModel.selectItem(item)" class="item-text-wrap">',"{{viewModel.getItemValue(item, viewModel.itemViewValueKey)}}","</ion-item>","</ion-content>","</div>"].join("");n.when().then(function(){return h.templateUrl?c(h.templateUrl):I}).then(function(c){var m=s(angular.element(c))(l);i.find("body").append(m),h.getItemValue=function(e,t){if(angular.isArray(e)){var i=[];return angular.forEach(e,function(n){t&&angular.isObject(e)?i.push(o(t)(n)):i.push(n)}),i}return t&&angular.isObject(e)?o(t)(e):e},h.selectItem=function(e){h.searchQuery=void 0,"1"!=h.maxSelectedItems&&angular.isArray(h.selectedItems)&&h.maxSelectedItems==h.selectedItems.length||(M(h.selectedItems,h.itemValueKey,h.getItemValue(e,h.itemValueKey))||("1"==h.maxSelectedItems?h.selectedItems=e:h.selectedItems=h.selectedItems.concat([e])),u.$setViewValue(h.selectedItems),u.$render(),1==h.maxSelectedItems&&h.hideModal(),angular.isDefined(d.itemsClickedMethod)&&h.itemsClickedMethod({callback:{item:e,selectedItems:angular.isArray(h.selectedItems)?h.selectedItems.slice():h.selectedItems,componentId:h.componentId}}))},h.removeItem=function(e){if(angular.isArray(h.selectedItems)){var t=h.selectedItems.splice(e,1)[0];h.selectedItems=h.selectedItems.slice()}else h.selectedItems=[];u.$setViewValue(h.selectedItems),u.$render(),angular.isDefined(d.itemsRemovedMethod)&&h.itemsRemovedMethod({callback:{item:t,selectedItems:angular.isArray(h.selectedItems)?h.selectedItems.slice():h.selectedItems,componentId:h.componentId}})},l.$watch("viewModel.searchQuery",function(e){h.fetchSearchQuery(e,!1)}),h.fetchSearchQuery=function(e,i){if(void 0!==e&&angular.isDefined(d.itemsMethod)){h.showLoadingIcon=!0;var o={query:e,isInitializing:i};h.componentId&&(o={query:e,isInitializing:i,componentId:h.componentId});var l=n.when(h.itemsMethod(o));l.then(function(e){e&&(e&&e.data&&(e=e.data),h.searchItems=h.getItemValue(e,h.itemsMethodValueKey),t.resize(),h.showLoadingIcon=!1)},function(e){return n.reject(e)})}};var I=!1;h.showModal=function(){if(!I){e.retain(),angular.element(i[0].querySelector("div.ion-autocomplete-container."+h.randomCssClass)).css("display","block"),l.$deregisterBackButton=a.registerBackButtonAction(function(){h.hideModal()},300);var n=angular.element(i[0].querySelector("div.ion-autocomplete-container."+h.randomCssClass+" input"));n.length>0&&(n[0].focus(),setTimeout(function(){n[0].focus()},0)),t.resize(),I=!0}},h.hideModal=function(){angular.element(i[0].querySelector("div.ion-autocomplete-container."+h.randomCssClass)).css("display","none"),h.searchQuery=void 0,e.release(),l.$deregisterBackButton&&l.$deregisterBackButton(),I=!1};var v={moved:!1,startX:0,startY:0},g=function(e){v.moved=!1,"undefined"!=typeof e.originalEvent&&(e=e.originalEvent),v.startX=e.touches[0].clientX,v.startY=e.touches[0].clientY},p=function(e){"undefined"!=typeof e.originalEvent&&(e=e.originalEvent),(Math.abs(e.touches[0].clientX-v.startX)>10||Math.abs(e.touches[0].clientY-v.startY)>10)&&(v.moved=!0)},f=function(e){v.moved||(e.preventDefault(),e.stopPropagation(),h.fetchSearchQuery("",!0),h.showModal())},M=function(e,t,i){if(angular.isArray(e))for(var n=0;n<e.length;n++)if(h.getItemValue(e[n],t)===i)return!0;return!1},w=function(e){var t=n.when(h.modelToItemMethod({modelValue:e}));t.then(function(e){h.selectItem(e)},function(e){return n.reject(e)})};"false"==h.manageExternally&&(r.bind("touchstart",g),r.bind("touchmove",p),r.bind("touchend click focus",f)),h.cancelClick=function(){h.hideModal(),angular.isDefined(d.cancelButtonClickedMethod)&&h.cancelButtonClickedMethod({callback:{selectedItems:angular.isArray(h.selectedItems)?h.selectedItems.slice():h.selectedItems,componentId:h.componentId}})},l.$watch("viewModel.externalModel",function(e){return angular.isArray(e)&&0==e.length?(h.selectedItems=[],u.$setViewValue(h.selectedItems),void u.$render()):void(e&&angular.isDefined(d.modelToItemMethod)&&(angular.isArray(e)?(h.selectedItems=[],angular.forEach(e,function(e){w(e)})):w(e)))}),l.$on("$destroy",function(){m.remove()}),u.$render=function(){r.val(h.getItemValue(u.$viewValue,h.itemViewValueKey))},u.$formatters.push(function(e){var t=h.getItemValue(e,h.itemViewValueKey);return void 0==t?"":t}),u.$parsers.push(function(e){return h.getItemValue(e,h.itemValueKey)})})}}}])}();
...
!function(){"use strict";angular.module("starter",["ionic","ionic-timepicker","ng.deviceDetector","ionic-datepicker","LocalStorageModule","angularMoment","ngMessages","ionic-toast","ion-autocomplete"]).config(["$stateProvider","$urlRouterProvider","ionicTimePickerProvider","$ionicConfigProvider","localStorageServiceProvider",function(t,e,o,i,l){var r={inputTime:60*(new Date).getHours()*60+60*(new Date).getMinutes(),format:12,step:1,setLabel:"Set",closeLabel:"Close"};o.configTimePicker(r),i.backButton.text(""),i.backButton.icon("ion-ios-arrow-left"),i.backButton.previousTitleText(""),i.scrolling.jsScrolling(!0),i.tabs.position("bottom"),l.setStorageType("sessionStorage"),t.state("login",{url:"/login",templateUrl:"templates/login.html",controller:"LoginCtrl"}).state("vendorInfo",{url:"/vendorinfo",templateUrl:"./templates/application/vendorInfo.html",controller:"VendorInfoCtrl"}).state("vendorRate",{url:"/vendorrate",templateUrl:"./templates/application/vendorRate.html",controller:"VendorRateCtrl"}).state("qualification",{url:"/qualification",templateUrl:"./templates/application/qualification.html",controller:"VendorQualificationCtrl"}).state("sent",{url:"/sent",templateUrl:"./templates/application/sent.html",controller:"sentCtrl"}).state("certification",{url:"/certification",templateUrl:"templates/certification.html"}).state("certifications",{url:"/certifications",templateUrl:"templates/certifications.html"}).state("userprofile",{url:"/userprofile",templateUrl:"templates/profile.html",controller:"UserProfileCtrl"}),e.otherwise("/login")}])}();
!function(){"use strict";angular.module("starter").config(["$stateProvider",function(t){t.state("tab",{url:"/tab","abstract":!0,templateUrl:"templates/contractor/tabs.html",controller:"ContactorMainCtrl"}).state("tab.dash",{url:"/dash",views:{"tab-dash":{templateUrl:"templates/contractor/tab-dash.html",controller:"ContractorDashCtrl"}}}).state("tab.tasks",{url:"/tasks",views:{"tab-tasks":{templateUrl:"templates/contractor/tab-tasks.html",controller:"ContractorTasksCtrl"}}}).state("tab.reports",{url:"/reports",views:{"tab-reports":{templateUrl:"templates/contractor/tab-report.html",controller:"ContractorReportingCtrl"}}}).state("task-detail",{url:"/tasks/:taskId",templateUrl:"templates/contractor/task-detail.html",controller:"ContractorTaskCtrl"}).state("installationreport",{url:"/installationreport/:taskId",templateUrl:"templates/contractor/installationreport.html",controller:"ContractorReportsCtrl"}).state("sitesurvey",{url:"/sitesurvey/:taskId",templateUrl:"templates/contractor/sitesurvey.html",controller:"ContractorReportsCtrl"}).state("reporting",{url:"/supportreport/:taskId",templateUrl:"templates/contractor/supportreport.html",controller:"ContractorReportsCtrl"}).state("qow",{url:"/qow",templateUrl:"templates/contractor/qow.html",controller:"ContractorQOWCtrl"}).state("reportdone2",{url:"/reportdone2/:reportId",templateUrl:"templates/contractor/reportdone2.html",controller:"ContractorReportingCtrl"}).state("reportdone",{url:"/reportdone",templateUrl:"templates/contractor/reportdone.html",controller:"ContractorReportingCtrl"}).state("newdetails",{url:"/newdetails",templateUrl:"templates/newdetails.html",controller:"ChatsCtrl"}).state("adminprogress",{url:"/adminprogress",templateUrl:"templates/adminprogress.html",controller:"ChatsCtrl"}).state("pendingtask",{url:"/pendingtask",templateUrl:"templates/pendingtask.html",controller:"ChatsCtrl"}).state("forapproval",{url:"/forapproval",templateUrl:"templates/forapproval.html",controller:"ChatsCtrl"}).state("completedtask",{url:"/completedtask",templateUrl:"templates/completedtask.html",controller:"ChatsCtrl"}).state("comptask",{url:"/comptask",templateUrl:"templates/comptask.html",controller:"ChatsCtrl"})}])}();
!function(){"use strict";angular.module("starter").config(["$stateProvider",function(t){t.state("tab-procure",{url:"/tabprocure","abstract":!0,templateUrl:"templates/procurement/tabs.html",controller:"ProcurementMainCtrl"}).state("tab-procure.admindash",{url:"/admindash",views:{"tab-admindash":{templateUrl:"templates/procurement/tab-admindash.html",controller:"ProcurementDashCtrl"}}}).state("tab-procure.admintasks",{url:"/admintasks",views:{"tab-admintasks":{templateUrl:"templates/procurement/tab-admintask.html",controller:"ProcurementTasksCtrl"}}}).state("tab-procure.createtask",{url:"/createtask",views:{"tab-create-task":{templateUrl:"templates/procurement/tab-createtask.html",controller:"ProcurementTaskCtrl"}}}).state("tab-procure.adminreport",{url:"/adminreport",views:{"tab-adminreport":{templateUrl:"templates/procurement/tab-adminreport.html",controller:"ProcurementReportingCtrl"}}}).state("procure_task_detail",{url:"/procuretasks/:taskId",templateUrl:"templates/procurement/task-detail.html",controller:"ProcurementTaskCtrl"}).state("procure_reportdone2",{url:"/procurereportdone2/:reportId",templateUrl:"templates/procurement/reportdone2.html",controller:"ContractorReportingCtrl"}).state("procure_reportdone",{url:"/procurereportdone/:reportId",templateUrl:"templates/procurement/reportdone.html",controller:"ContractorReportingCtrl"}).state("quotelist",{url:"/quotelist/:taskId",templateUrl:"templates/procurement/quotelist.html",controller:"ChatsCtrl"}).state("adminprofile",{url:"/adminprofile",templateUrl:"templates/adminprofile.html",controller:"AdminProfileCtrl"}).state("quotedetails",{url:"/quotedetails",templateUrl:"templates/qowlist.html",controller:"ChatsCtrl"}).state("approve",{url:"/approve",templateUrl:"templates/approve.html",controller:"ChatsCtrl"}).state("editpro",{url:"/editpro",templateUrl:"templates/editvendorinfo.html",controller:"ChatsCtrl"}).state("editavailability",{url:"/editavailability",templateUrl:"templates/editavailability.html",controller:"ChatsCtrl"}).state("editrate",{url:"/editrate",templateUrl:"templates/editrate.html",controller:"ChatsCtrl"})}])}();
!function(){"use strict";function o(o,t,e,n,i,r,a,c,s,l,d){t.ready(function(){window.cordova&&window.cordova.plugins&&window.cordova.plugins.Keyboard&&(cordova.plugins.Keyboard.hideKeyboardAccessoryBar(!0),cordova.plugins.Keyboard.disableScroll(!0)),window.StatusBar&&StatusBar.styleDefault()});var n=n;n.isDesktop()&&(e.location.href="../desktop.html"),o.dimage=function(){d.alert({title:"",template:"Images downloaded"})},o.showPopover=function(t){o.mainPopover.show(t)},o.showPopoveredit=function(t){o.popover1.show(t)},o.myGoBack=function(){console.log("myGoBack"),r.nextDirection("back"),i.goBack()},o.signOut=function(){o.mainPopover.hide(),r.nextDirection("back"),a.remove("user"),c(function(){s.go("login")},100)},o.sign=function(){i.nextViewOptions({disableBack:!0}),r.nextDirection("back"),c(function(){s.go("login")},100)},o.gotToProfile=function(){o.mainPopover.hide(),r.nextDirection("forward"),s.go("userprofile")},o.gotToProf=function(){i.nextViewOptions({disableBack:!0}),r.nextDirection("forward"),s.go("userprofile")},o.comptask=function(){o.$broadcast("closecompletedModal"),r.nextDirection("forward"),s.go("comptask")},o.myreportdone=function(){o.$broadcast("closemyreportModal"),r.nextDirection("forward"),s.go("reportdone")},o.gotoprog=function(t){var e=JSON.parse(a.get("user"));console.log("user: ",e.usertype),o.$broadcast("closetaskinprogressModal"),r.nextDirection("forward"),c(function(){"proc"===e.usertype?(console.log("proc: "),s.go("adminprogress")):(console.log("con: "),s.go("detailsH"))},100)},o.newTask=function(t){o.$broadcast("closetaskmodal"),r.nextDirection("forward"),c(function(){s.go("newdetails")},100)},o.gotToadminProfile=function(){o.mainPopover.hide(),r.nextDirection("forward"),s.go("adminprofile")},o.editProfile=function(){o.popover1.hide(),r.nextDirection("forward"),s.go("editpro")},o.showCheck=function(){d.confirm({title:"",template:"Complete Task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(t){t&&(o.$broadcast("closeModal"),o.$broadcast("closetaskinprogressModal"),r.nextDirection("forward"),s.go("installationreport"))}}]})},o.showCheck2=function(){d.confirm({title:"",template:"Complete Task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(t){t&&(o.$broadcast("closeModal"),o.$broadcast("closetaskinprogressModal"),r.nextDirection("forward"),s.go("reporting"))}}]})},o.showCheck3=function(){d.confirm({title:"",template:"Complete Task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(t){t&&(o.$broadcast("closeModal"),o.$broadcast("closetaskinprogressModal"),r.nextDirection("forward"),s.go("sitesurvey"))}}]})},o.clickCurrentin=function(){d.alert({templateUrl:"./templates/dialog/currentin.html",rootScope:o})}}angular.module("starter").run(o),o.$inject=["$rootScope","$ionicPlatform","$window","deviceDetector","$ionicHistory","$ionicViewSwitcher","localStorageService","$timeout","$state","$ionicModal","$ionicPopup"]}();
!function(){"use strict";function t(t,o,e,n,a,s){t.data={username:"",password:""},t.$on("$ionicView.beforeEnter",function(o,e){t.data={username:"",password:"",usertype:""}}),t.inputType="password",t.showStr="show",t.hideShowPassword=function(){"password"==t.inputType?(t.inputType="text",t.showStr="hide"):(t.inputType="password",t.showStr="show")},t.login=function(i){o.nextDirection("forward"),"proc"==t.data.username&&"123456"==t.data.password?(t.data.usertype="proc",n.set("user",JSON.stringify(t.data)),console.log("tab-procure.admindash"),s(function(){e.go("tab-procure.admindash")},300)):"con"==t.data.username&&"123456"==t.data.password?(t.data.usertype="con",n.set("user",JSON.stringify(t.data)),console.log("tab.dash"),s(function(){e.go("tab.dash")},300)):a.alert({title:"Invalid Account",template:"Username and Password not match!!!"})}}function o(t,o,e,n){t.sent=function(){n.nextViewOptions({disableBack:!0}),o.nextDirection("forward"),e.go("login")}}angular.module("starter").controller("LoginCtrl",t).controller("sentCtrl",o),o.$inject=["$scope","$ionicViewSwitcher","$state","$ionicHistory"],t.$inject=["$scope","$ionicViewSwitcher","$state","localStorageService","$ionicPopup","$timeout"]}();
...
!function(){"use strict";function a(a,t,e,i,r,o,n,c,s,l,u,v,d,m){a.data={},a.data.availabilityArr=[],a.data.coverageArr=[],a.avail={},a.area={},a.weekdays=r.all(),a.countries=n.all(),a.cities=[],a.citiesCopy=[],a.groups=[],a.othersList=[],a.getCountryState=function(t){"AUS"==t?a.states=o.all():a.states=[]},a.getCityState=function(t){console.log("getCityState: ",t),c.all(t).then(function(t){a.cities=t.data;var e=0;_.each(a.cities,function(t){a.citiesCopy.push({id:e,name:t.place_name,view:t.place_name}),e++})})},a.callbackMethod=function(t){if(t){var e=m("filter")(a.citiesCopy,t);return{items:e}}return{items:[]}},a.itemsClicked=function(t){a.data.check_city=t.item.name},a.addArea=function(t){t&&(a.data.coverageArr.push({area:t}),a.area.coverage="")},a.increaseHours=function(){a.time.hours=Number(a.time.hours),12==a.mainObj.format&&(12!=a.time.hours?a.time.hours+=1:a.time.hours=1),24==a.mainObj.format&&(a.time.hours=(a.time.hours+1)%24),a.time.hours=a.time.hours<10?"0"+a.time.hours:a.time.hours},a.openTime=function(t){a.data.created=new Date,s.openTimePicker({callback:function(t){var e=Math.floor(t/60/60),i=t/60%60;a.data.created.setHours(e,i);var r=(a.data.created.getHours(),e>=12?"PM":"AM");e%=12,e=e?e:12,i=i<10?"0"+i:i,a.avail.start=e+":"+i+" "+r},inputTime:60*a.data.created.getHours()*60+60*a.data.created.getMinutes(),format:12})},a.openTime2=function(){var t=new Date;s.openTimePicker({callback:function(e){var i=Math.floor(e/60/60),r=e/60%60;t.setHours(i,r);var o=(t.getHours(),i>=12?"PM":"AM");i%=12,i=i?i:12,r=r<10?"0"+r:r,a.avail.end=i+":"+r+" "+o},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},a.openTime3=function(a){var t=new Date;s.openTimePicker({callback:function(e){var i=Math.floor(e/60/60),r=e/60%60;t.setHours(i,r);var o=(t.getHours(),i>=12?"PM":"AM");i%=12,i=i?i:12,r=r<10?"0"+r:r,a.start=i+":"+r+" "+o},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},a.openTime4=function(a){var t=new Date;s.openTimePicker({callback:function(e){var i=Math.floor(e/60/60),r=e/60%60;t.setHours(i,r);var o=(t.getHours(),i>=12?"PM":"AM");i%=12,i=i?i:12,r=r<10?"0"+r:r,a.end=i+":"+r+" "+o},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},a.addSched=function(t){t&&(a.data.availabilityArr.push({availability:t.availability,start:t.start,end:t.end}),a.avail.availability="",a.avail.start="",a.avail.end="")},a.showCancel=function(){e.confirm({title:"",template:"Are you sure you want to cancel application?"}).then(function(a){a?(u.nextViewOptions({disableBack:!0}),v.nextDirection("back"),l.go("login")):console.log("You are not sure")})},a.vendorinf=function(t){t.$valid&&(a.avail.availability&&(a.data.availabilityArr.push({availability:a.avail.availability,start:a.avail.start,end:a.avail.end}),a.avail.availability="",a.avail.start="",a.avail.end=""),a.area.coverage&&(a.data.coverageArr.push({area:a.area.coverage}),a.area.coverage=""),d.set("vendor",JSON.stringify(a.data)),l.go("vendorRate"))}}angular.module("starter").controller("VendorInfoCtrl",a),a.$inject=["$scope","$ionicModal","$ionicPopup","$timeout","WeekDays","States","Country","CityState","ionicTimePicker","$state","$ionicHistory","$ionicViewSwitcher","localStorageService","$filter"]}();
!function(){"use strict";function t(t,e,n,i,a,o,c,l,r,s,u,m,d,f){console.log("VendorRateCtrl"),t.data={},t.rate={},t.banks=[],t.banksCopy=[],t.currencies=[],t.countries=c.all(),t.cities=[],t.citiesCopy=[],e.fromTemplateUrl("../mobile/templates/dialog/termandcondition.html",{scope:t,animation:"slide-in-up"}).then(function(e){t.modal=e}),a.all().then(function(e){t.banks=e.data,_.each(t.banks,function(e){t.banksCopy.push({id:e.id,name:e.name,view:e.name})})}),o.all().then(function(e){var n=e.data;i(function(){t.$apply(function(){t.currencies=n})},10)}),t.openModal=function(){t.modal.show()},t.closeModal=function(){t.modal.hide()},t.getCountryState=function(e){"AUS"==e?t.states=r.all():t.states=[]},t.getCityState=function(e){l.all(e).then(function(e){t.cities=e.data;var n=0;_.each(t.cities,function(e){t.citiesCopy.push({id:n,name:e.place_name,view:e.place_name}),n++})})},t.callbackMethod=function(e){if(e){var n=f("filter")(t.banksCopy,e);return{items:n}}return{items:[]}},t.callbackCityMethod=function(e){if(e){var n=f("filter")(t.citiesCopy,e);return{items:n}}return{items:[]}},t.itemsCityClicked=function(e){t.data.city=e.item.name},t.itemsClicked=function(e){t.data.bankname=e.item.name},t.callbackMethod=function(e){if(e){var n=f("filter")(t.banksCopy,e);return{items:n}}return{items:[]}},t.itemsClicked=function(e){t.data.bankname=e.item.name},t.showCancel=function(){n.confirm({title:"",template:"Are you sure you want to cancel application?"}).then(function(t){t?(u.nextViewOptions({disableBack:!0}),m.nextDirection("back"),s.go("login")):console.log("You are not sure")})}}angular.module("starter").controller("VendorRateCtrl",t),t.$inject=["$scope","$ionicModal","$ionicPopup","$timeout","Banks","Currencies","Country","CityState","States","$state","$ionicHistory","$ionicViewSwitcher","localStorageService","$filter"]}();
!function(){"use strict";function o(o,e,t,n,i,r,s,u,c){o.data={},o.others={},o.groups=[],o.othersList=[],o.filenames=[];for(var l=0;l<1;l++){o.groups[l]={name:l,items:[]};for(var a=0;a<1;a++)o.groups[l].items.push(l+"-"+a)}o.toggleGroup=function(e){o.isGroupShown(e)?o.shownGroup=null:o.shownGroup=e},o.isGroupShown=function(e){return o.shownGroup===e},o.removeOther=function(e){o.othersList.splice(e,1)},o.addOthers=function(e){_.isEmpty(e)||(o.othersList.push(e),o.others={})},o.uploadFiles=function(e){var t=e.files,i=[];for(l=0;l<t.length;l++)i.push(t[l].name);o.files=t,n(function(){o.$apply(function(){o.filenames=i})},10),console.log(t,i)},o.removetest=function(e){o.filenames.splice(e,1)},o.showCancel=function(){t.confirm({title:"",template:"Are you sure you want to cancel application?"}).then(function(o){o?(r.nextViewOptions({disableBack:!0}),s.nextDirection("back"),i.go("login")):console.log("You are not sure")})},o.showConfirm=function(){t.confirm({title:"",template:"Are you sure you want to submit application?"}).then(function(o){o?(r.nextViewOptions({disableBack:!0}),s.nextDirection("forward"),i.go("sent")):console.log("You are not sure")})}}angular.module("starter").controller("VendorQualificationCtrl",o),o.$inject=["$scope","$ionicModal","$ionicPopup","$timeout","$state","$ionicHistory","$ionicViewSwitcher","localStorageService","$filter"]}();
...
!function(){"use strict";function t(t,e,o,i,n,s){t.selectedTask=t.$parent.tasklist[0],t.showActiveTask=function(e){t.selectedTask=e},t.doDashRefresh=function(){o(function(){t.$broadcast("scroll.refreshComplete")},2e3)},t.checkInOut=function(e){var o=[],i=_.find(t.tasklist,function(t){return"in"==t.Check});_.isUndefined(i)||o.push(i),"in"==e.Check?n.confirm({title:"<h4>Check-out to pause task</h4>",templateUrl:"../mobile/templates/dialog/checkout.html",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(o){o&&(console.log("asdasdasd"),_.map(t.tasklist,function(t){t==e&&(t.Check="out")}),localStorage.setItem("tasklist",angular.toJson(t.tasklist)),s.closeOptionButtons())}}]}):1==o.length?n.alert({template:"You are currently check-in to other task. <br> Please check-out."}):n.confirm({title:"<h4>Check-in to resume task</h4>",templateUrl:"../mobile/templates/dialog/checkin.html",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(o){o&&(_.map(t.tasklist,function(t){t==e&&(t.Check="in")}),localStorage.setItem("tasklist",angular.toJson(t.tasklist)),s.closeOptionButtons())}}]})},t.showCheck=function(t){console.log("showCheck"),"High"==t.Status?n.show({title:"<h4>Check-out to complete task</h4>",templateUrl:"../mobile/templates/dialog/checkout.html",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(o){o&&(s.closeOptionButtons(),i.nextDirection("forward"),e.go("installationreport",{taskId:t.id},{reload:!1}))}}]}):"Medium"==t.Status?n.confirm({title:"<h4>Check-out to complete task</h4>",templateUrl:"../mobile/templates/dialog/checkout.html",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(o){o&&(s.closeOptionButtons(),i.nextDirection("forward"),e.go("reporting",{taskId:t.id},{reload:!1}))}}]}):"Low"==t.Status&&n.confirm({title:"<h4>Check-out to complete task</h4>",templateUrl:"../mobile/templates/dialog/checkout.html",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(o){o?(i.nextDirection("forward"),e.go("sitesurvey",{id:t.id},{reload:!1})):console.log("You are not sure")}}]})},t.deTails=function(t){i.nextDirection("forward"),e.go("task-detail",{taskId:t.id})}}angular.module("starter").controller("ContractorDashCtrl",t),t.$inject=["$scope","$state","$timeout","$ionicViewSwitcher","$ionicPopup","$ionicListDelegate"]}();
!function(){"use strict";function t(t,e,o,n,i,s){t.selectedTask=t.$parent.tasklist[0],t.$on("showTaskInfo",function(e,o){t.$parent.closependingModal(),t.$parent.closenewtaskModal(),t.$parent.closecompleted_ContractorModal(),t.deTails(o.taskId)}),t.$on("startTaskPending",function(e,o){t.startTask(o.taskId)}),t.showActiveTask=function(e){t.selectedTask=e},t.checkInOut=function(e){var o=[],n=_.find(t.tasklist,function(t){return"in"==t.Check});_.isUndefined(n)||o.push(n),"in"==e.Check?i.confirm({title:"<h4>Check-out to pause task</h4>",templateUrl:"../mobile/templates/dialog/checkout.html",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(o){o&&(console.log("asdasdasd"),_.map(t.tasklist,function(t){t==e&&(t.Check="out")}),localStorage.setItem("tasklist",angular.toJson(t.tasklist)),s.closeOptionButtons())}}]}):1==o.length?i.alert({template:"You are currently check-in to other task. <br> Please check-out."}):i.confirm({title:"<h4>Check-in to resume task</h4>",templateUrl:"../mobile/templates/dialog/checkin.html",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(o){o&&(_.map(t.tasklist,function(t){t==e&&(t.Check="in")}),localStorage.setItem("tasklist",angular.toJson(t.tasklist)),s.closeOptionButtons())}}]})},t.completeTask=function(t){console.log("completeTask: ",t),"High"==t.Status?i.show({title:"<h4>Check-out to complete task</h4>",templateUrl:"../mobile/templates/dialog/checkout.html",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(i){i&&(s.closeOptionButtons(),n.nextDirection("forward"),o(function(){e.go("installationreport",{taskId:t.id})},250))}}]}):"Medium"==t.Status?i.confirm({title:"<h4>Check-out to complete task</h4>",templateUrl:"../mobile/templates/dialog/checkout.html",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(i){i&&(s.closeOptionButtons(),n.nextDirection("forward"),o(function(){e.go("reporting",{taskId:t.id})},250))}}]}):"Low"==t.Status&&i.confirm({title:"<h4>Check-out to complete task</h4>",templateUrl:"../mobile/templates/dialog/checkout.html",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(i){i&&(s.closeOptionButtons(),n.nextDirection("forward"),o(function(){e.go("sitesurvey",{taskId:t.id})},250))}}]})},t.showAllPendingTask=function(){t.$parent.openpendingModal(),t.$parent.pendingData=t.pendingData},t.showAllNewTask=function(){t.$parent.opennewtaskModal()},t.completedTask=function(t){n.nextDirection("forward"),o(function(){e.go("completedtask")},100)},t.showConfirm=function(){i.confirm({title:"",template:"Are you sure you want to assign the task to Lorem Impatsu?"}).then(function(t){t&&(n.nextDirection("forward"),e.go("approve"))})},t.clickDecline=function(e){i.confirm({title:"",template:"Are you sure you want to decline task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(e){e&&(t.delete3=!1,s.closeOptionButtons())}}]})},t.deTails=function(t){s.closeOptionButtons(),n.nextDirection("forward"),o(function(){e.go("task-detail",{taskId:t.id})},250)},t.startTask=function(e){var o=_.filter(t.tasklist,function(t){return"progress"==t.Task});o.length>2?i.alert({template:"You are currently check-in to 3 task. <br> Please check-out."}):i.confirm({title:"<h4>Check-in to start task</h4>",templateUrl:"./templates/dialog/checkin.html"}).then(function(o){o&&(_.map(t.tasklist,function(t){t==e&&(t.Task="progress")}),t.pending=_.filter(t.tasklist,function(t){return"pending"==t.Task}),t.tasklist.splice(e,0),s.closeOptionButtons())})},t.newTaskqow=function(i){t.$parent.closenewtaskModal(),n.nextDirection("forward"),s.closeOptionButtons(),o(function(){e.go("qow")},250)},t.$on("submitQOW",function(e,o){t.$parent.closependingModal(),t.newTaskqow(o.taskId)}),t.$on("declineTaskOW",function(e,o){console.log("declineTaskOW"),t.clickDecline(o.taskId)}),t.doTaskRefresh=function(){o(function(){t.$broadcast("scroll.refreshComplete")},2e3)}}angular.module("starter").controller("ContractorTasksCtrl",t),t.$inject=["$scope","$state","$timeout","$ionicViewSwitcher","$ionicPopup","$ionicListDelegate"]}();
...
!function(){"use strict";function t(t,o,a,e,n,s,i){console.log("ContractorReportsCtrl");var l,r;t.selectedTask={},t.tasklist=[],t.signature=void 0,t.tasklist=e.all(),t.$watch("tasklist",function(o){t.selectedTask=_.find(o,{id:parseInt(n.taskId)})}),s.fromTemplateUrl("./templates/dialog/signature.modal.html",{scope:t,animation:"slide-in-up"}).then(function(o){t.signatureModal=o}),t.openSignatureModal=function(){console.log("openSignatureModal"),t.signatureModal.show(),l=document.getElementById("signatureCanvas"),r=new SignaturePad(l),r.minWidth=1,r.maxWidth=1.5,r.dotSize=3,r.backgroundColor="rgb(255, 255, 255)"},t.closeSignatureModal=function(){t.signatureModal.hide()},t.clearCanvas=function(){r.clear()},t.saveCanvas=function(){if(void 0!=r){var o=r.toDataURL("image/png");t.signature=o}},t.$on("$destroy",function(){t.signatureModal.remove(),t.signature=void 0}),t.$on("modal.hidden",function(){t.signature=void 0}),t.complete=function(){console.log("$stateParams:",n.taskId);var o=e.get(n.taskId);console.log("result:",o),o&&i.confirm({title:"",template:"Send report?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(e){e?(console.log("asdasdasd"),_.map(t.tasklist,function(t){t==o&&(t.Task="complete",a.go("tab.tasks"))}),t.progress=_.filter(t.tasklist,function(t){return"progress"==t.Task}),localStorage.setItem("tasklist",angular.toJson(t.tasklist))):console.log("You are not sure")}}]})}}angular.module("starter").controller("ContractorReportsCtrl",t),t.$inject=["$scope","$timeout","$state","Tasks","$stateParams","$ionicModal","$ionicPopup"]}();
...
!function(){"use strict";function o(o,e,t,n,r,i,c,p){o.reportdone2=function(e){o.$parent.closerecentreportModal(),o.$parent.closemyreportModal(),p.closeOptionButtons(),r.nextDirection("forward"),n(function(){t.go("reportdone2",{reportId:e.id})},250)},o.downloadReport=function(o){e.show({template:'<p>Downloading...</p><ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),n(function(){e.hide(),i.alert({title:"",template:"Report has been downloaded"}).then(function(){p.closeOptionButtons()})},2e3)},o.doReportingRefresh=function(){n(function(){o.$broadcast("scroll.refreshComplete")},2e3)},o.$on("showReportInfo",function(e,t){o.reportdone2(t.reportId)}),o.$on("downloadReportInfo",function(e,t){o.downloadReport(t.reportId)}),c.reportId&&(o.doReportRefresh=function(){n(function(){o.$broadcast("scroll.refreshComplete")},2e3)})}angular.module("starter").controller("ContractorReportingCtrl",o),o.$inject=["$scope","$ionicLoading","$state","$timeout","$ionicViewSwitcher","$ionicPopup","$stateParams","$ionicListDelegate"]}();
!function(){"use strict";function o(o,e,t,n,a,s,l,r){o.progressData=[],o.pendingData=[],o.completedData=[],o.newTaskData=[],o.reportsData=[],o.tasklist=s.all(),_.each(o.tasklist,function(e){"progress"==e.Task&&o.progressData.push(e),"pending"==e.Task&&o.pendingData.push(e),""==e.Task&&o.newTaskData.push(e),"completed"==e.Task&&o.completedData.push(e)}),o.reportsData=l.all();var i=JSON.parse(e.get("user"));o.user=i,o.showReportDetails=function(e){console.log("showReportDetails: ",e),o.$broadcast("showReportInfo",{reportId:e})},o.downloadReportDetails=function(e){console.log("downloadReportDetails: ",e),o.$broadcast("downloadReportInfo",{reportId:e})},o.showTaskDetails=function(e){console.log("showTaskDetails"),o.$broadcast("showTaskInfo",{taskId:e})},o.startPendingTask=function(e){o.$broadcast("startTaskPending",{taskId:e})},o.doMyReportsRefresh=function(){r(function(){o.$broadcast("scroll.refreshComplete")},2e3)},o.doCompletedTaskRefresh=function(){r(function(){o.$broadcast("scroll.refreshComplete")},2e3)},o.doNewTaskRefresh=function(){r(function(){o.$broadcast("scroll.refreshComplete")},2e3)},o.doPendingTaskRefresh=function(){r(function(){o.$broadcast("scroll.refreshComplete")},2e3)},o.doReportingRefresh=function(){r(function(){o.$broadcast("scroll.refreshComplete")},2e3)},t.fromTemplateUrl("./templates/dialog/editpro.html",{rootScope:n}).then(function(o){n.popover1=o}),t.fromTemplateUrl("./templates/dialog/submit.html",{scope:o}).then(function(o){n.mainPopover=o}),n.$on("closeModal",function(){console.log("closetaskmodal"),o.progressModal.hide()}),a.fromTemplateUrl("./templates/dialog/progress.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.progressModal=e}),o.opendetailsModal=function(){console.log("opendetailsModal"),o.progressModal.show()},o.closeModal=function(){o.progressModal.hide()},a.fromTemplateUrl("./templates/dialog/contractor_taskinprogress.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.taskinprogressModal=e}),o.opentaskinprogressModal=function(){o.taskinprogressModal.show()},o.closetaskinprogressModal=function(){o.taskinprogressModal.hide()},n.$on("closetaskinprogressModal",function(){console.log("closetaskmodal"),o.taskinprogressModal.hide()}),a.fromTemplateUrl("./templates/dialog/pending.html",{scope:o,animation:"slide-in-up",controller:"ContractorDashCtrl"}).then(function(e){o.pendingModal=e}),o.openpendingModal=function(){o.pendingModal.show()},o.closependingModal=function(){o.pendingModal.hide()},o.$on("closependingModal",function(){o.pendingModal.hide()}),a.fromTemplateUrl("./templates/dialog/contractor_newtask.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.newtaskModal=e}),o.opennewtaskModal=function(){console.log("opendetailsModal"),o.newtaskModal.show()},o.closenewtaskModal=function(){o.newtaskModal.hide()},o.submitQOW=function(e){o.$broadcast("submitQOW",{taskId:e})},o.declineTask=function(e){o.$broadcast("declineTaskOW",{taskId:e})},a.fromTemplateUrl("./templates/dialog/contractor_completed.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.contractor_completed=e}),o.opencompleted_ContactorModal=function(){o.contractor_completed.show()},o.closecompleted_ContractorModal=function(){o.contractor_completed.hide()},a.fromTemplateUrl("./templates/dialog/contractor_recentlysentreport.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.recentreportModal=e}),o.openrecentreportModal=function(){console.log("openrecentreportModal"),o.recentreportModal.show()},o.closerecentreportModal=function(){o.recentreportModal.hide()},a.fromTemplateUrl("./templates/dialog/contractor_myreports.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.myreportModal=e}),o.openmyreportModal=function(){console.log("openmyreportModal"),o.myreportModal.show()},o.closemyreportModal=function(){o.myreportModal.hide()},o.$on("closemyreportModal",function(){o.myreportModal.hide()})}angular.module("starter").controller("ContactorMainCtrl",o),o.$inject=["$scope","localStorageService","$ionicPopover","$rootScope","$ionicModal","Tasks","Reports","$timeout"]}();
!function(){"use strict";function o(o,e,t,n,a,s,l,r){o.progressData=[],o.pendingData=[],o.completedData=[],o.newTaskData=[],o.reportsData=[],o.tasklist=s.all(),_.each(o.tasklist,function(e){"progress"==e.Task&&o.progressData.push(e),"pending"==e.Task&&o.pendingData.push(e),""==e.Task&&o.newTaskData.push(e),"completed"==e.Task&&o.completedData.push(e)}),o.reportsData=l.all();var i=JSON.parse(e.get("user"));o.user=i,o.showReportDetails=function(e){console.log("showReportDetails: ",e),o.$broadcast("showReportInfo",{reportId:e})},o.showReportDetails2=function(e){console.log("showReportDetails: ",e),o.$broadcast("showReportInfo2",{reportId:e})},o.downloadReportDetails=function(e){console.log("downloadReportDetails: ",e),o.$broadcast("downloadReportInfo",{reportId:e})},o.showTaskDetails=function(e){o.$broadcast("showTaskInfo",{taskId:e})},o.showQOWList=function(e){o.$broadcast("showQOWInfo",{taskId:e})},o.closeTaskDetails=function(e){o.$broadcast("closeTaskCompleted",{taskId:e})},o.doAllTaskRefresh=function(){r(function(){o.$broadcast("scroll.refreshComplete")},2e3)},o.doPendingTaskRefresh=function(){r(function(){o.$broadcast("scroll.refreshComplete")},2e3)},o.doReportingRefresh=function(){r(function(){o.$broadcast("scroll.refreshComplete")},2e3)},t.fromTemplateUrl("./templates/dialog/editpro.html",{rootScope:n}).then(function(o){n.popover1=o}),t.fromTemplateUrl("./templates/dialog/submit.html",{scope:o}).then(function(o){n.mainPopover=o}),o.$on("closeModal",function(){console.log("closetaskmodal"),o.progressModal.hide()}),a.fromTemplateUrl("./templates/dialog/progress.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.progressModal=e}),o.opendetailsModal=function(){console.log("opendetailsModal"),o.progressModal.show()},o.closeModal=function(){o.progressModal.hide()},a.fromTemplateUrl("./templates/dialog/procurement_taskinprogress.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.taskinprogressModal=e}),o.opentaskinprogressModal=function(){o.taskinprogressModal.show()},o.closetaskinprogressModal=function(){o.taskinprogressModal.hide()},a.fromTemplateUrl("./templates/dialog/procurement_pending.html",{scope:o,animation:"slide-in-up",controller:"ContractorDashCtrl"}).then(function(e){o.procurement_PendingModal=e}),o.openProcPendingModal=function(){o.procurement_PendingModal.show()},o.closeProcPendingModal=function(){o.procurement_PendingModal.hide()},a.fromTemplateUrl("./templates/dialog/procurement_newtask.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.newtaskModal=e}),o.opennewtaskModal=function(){o.newtaskModal.show()},o.closenewtaskModal=function(){o.newtaskModal.hide()},o.submitQOW=function(e){o.$broadcast("submitQOW",{taskId:e})},o.declineTask=function(e){o.$broadcast("declineTaskOW",{taskId:e})},a.fromTemplateUrl("./templates/dialog/procurement_completed.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.completedTaskModal=e}),o.opencompletedModal=function(){o.completedTaskModal.show()},o.closecompletedModal=function(){o.completedTaskModal.hide()},a.fromTemplateUrl("./templates/dialog/procurement_recentlysentreport.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.recentreportModal=e}),o.openrecentreportModal=function(){console.log("openrecentreportModal"),o.recentreportModal.show()},o.closerecentreportModal=function(){o.recentreportModal.hide()},a.fromTemplateUrl("./templates/dialog/procurement_myreports.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.myreportModal=e}),o.openmyreportModal=function(){o.myreportModal.show()},o.closemyreportModal=function(){o.myreportModal.hide()}}angular.module("starter").controller("ProcurementMainCtrl",o),o.$inject=["$scope","localStorageService","$ionicPopover","$rootScope","$ionicModal","Tasks","Reports","$timeout"]}();
!function(){"use strict";function o(o,e,t,n,c,i,a,r,s){o.selectedTask=o.$parent.tasklist[0],o.showActiveTask=function(e){o.selectedTask=e},o.deTails=function(o){s.closeOptionButtons(),c.nextDirection("forward"),n(function(){t.go("procure_task_detail",{taskId:o.id})},250)},o.$on("showTaskInfo",function(e,t){s.closeOptionButtons(),o.$parent.closetaskinprogressModal(),o.deTails(t.taskId)}),o.doTaskRefresh=function(){n(function(){o.$broadcast("scroll.refreshComplete")},2e3)},o.clickme=function(){o.model=!0},o.filter={direct:!1,check:!0,check1:!1},o.showModerate=function(){o.filter={direct:!0,check:!1,check1:!1}},o.showHigh=function(){o.filter={direct:!1,check:!0,check1:!1}},o.showLow=function(){o.filter={direct:!1,check:!1,check1:!0}},o.completedTask=function(o){c.nextDirection("forward"),n(function(){t.go("completedtask")},100)},i.fromTemplateUrl("../mobile/templates/dialog/contractorlist.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.modal=e}),o.openModal=function(){o.modal.show()},o.closeModal=function(){o.modal.hide()},o.createContact=function(e){o.contacts.push({name:e.firstName+" "+e.lastName}),o.modal.hide()},o.forApproval=function(o){c.nextDirection("forward"),n(function(){t.go("forapproval")},100)},o.pendingDetails=function(e){o.popover.hide(),c.nextDirection("forward"),n(function(){t.go("pendingtask")},100)},o.createTask=function(o){o.$valid&&console.log("form valid")}}angular.module("starter").controller("ProcurementDashCtrl",o),o.$inject=["$scope","$ionicPopover","$state","$timeout","$ionicViewSwitcher","$ionicModal","localStorageService","$ionicPopup","$ionicListDelegate"]}();
!function(){"use strict";function e(e,t,a,n,i,o,s,r,c){i.taskId&&(e.selectedTask={},e.tasklist=[],e.tasklist=n.all(),e.$watch("tasklist",function(t){e.selectedTask=_.find(t,{id:parseInt(i.taskId)})})),e.openDatePicker=function(){o.openDatePicker({callback:function(t){console.log("Return value from the datepicker popup is sssss: "+t,new Date(t));var a=new Date(t);e.newDate=moment(a).format("MM-DD-YYYY")},disabledDates:[new Date(2016,2,16),new Date(2015,3,16),new Date(2015,4,16),new Date(2015,5,16),new Date("Wednesday, August 12, 2015"),new Date("08-16-2016"),new Date(1439676e6)],from:new Date(2012,1,1),to:new Date(2016,10,30),inputDate:new Date,mondayFirst:!0,disableWeekdays:[0],closeOnSelect:!1,templateType:"popup"})},e.openTime=function(){var t=new Date;s.openTimePicker({callback:function(a){var n=Math.floor(a/60/60),i=a/60%60;t.setHours(n,i);var o=(t.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,i=i<10?"0"+i:i,e.start=n+":"+i+" "+o},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},e.openTime2=function(){var t=new Date;s.openTimePicker({callback:function(a){var n=Math.floor(a/60/60),i=a/60%60;t.setHours(n,i);var o=(t.getHours(),n>=12?"PM":"AM");n%=12,n=n?n:12,i=i<10?"0"+i:i,e.end=n+":"+i+" "+o},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},e.tasksend=function(){r.alert({title:"",template:"Your task has been sent"}).then(function(e){c.nextDirection("back"),a.go("tab-procure.admintasks")})}}angular.module("starter").controller("ProcurementTaskCtrl",e),e.$inject=["$scope","$timeout","$state","Tasks","$stateParams","ionicDatePicker","ionicTimePicker","$ionicPopup","$ionicViewSwitcher"]}();
!function(){"use strict";function t(t,o,e,n,s,a,i){t.doTaskRefresh=function(){o(function(){t.$broadcast("scroll.refreshComplete")},2e3)},t.$on("showTaskInfo",function(o,e){s.closeOptionButtons(),t.$parent.closetaskinprogressModal(),t.$parent.closeProcPendingModal(),t.$parent.closenewtaskModal(),t.$parent.closecompletedModal(),t.deTails(e.taskId)}),t.$on("startTaskPending",function(o,e){t.startTask(e.taskId)}),t.$on("showQOWInfo",function(o,e){s.closeOptionButtons(),t.$parent.closenewtaskModal(),t.qowlist(e.taskId)}),t.$on("closeTaskCompleted",function(o,e){s.closeOptionButtons(),t.closeTask(e.taskId)}),t.startTask=function(o){var e=_.filter(t.tasklist,function(t){return"progress"==t.Task});e.length>2?i.alert({template:"You are currently check-in to 3 task. <br> Please check-out."}):i.confirm({title:"<h4>Check-in to start task</h4>",templateUrl:"./templates/dialog/checkin.html"}).then(function(e){e&&(_.map(t.tasklist,function(t){t==o&&(t.Task="progress")}),t.pending=_.filter(t.tasklist,function(t){return"pending"==t.Task}),t.tasklist.splice(o,0),s.closeOptionButtons())})},t.deTails=function(t){s.closeOptionButtons(),a.nextDirection("forward"),o(function(){e.go("task-detail",{taskId:t.id})},250)},t.qowlist=function(t){s.closeOptionButtons(),a.nextDirection("forward"),o(function(){e.go("quotelist",{taskId:t.id})},250)},t.closeTask=function(o){i.confirm({title:"",template:"Are you sure you want to close task?",buttons:[{text:"NO"},{text:"YES",type:"button-positive",onTap:function(o){o&&(s.closeOptionButtons(),t.$parent.closecompletedModal())}}]})}}angular.module("starter").controller("ProcurementTasksCtrl",t),t.$inject=["$scope","$timeout","$state","$stateParams","$ionicListDelegate","$ionicViewSwitcher","$ionicPopup"]}();
!function(){"use strict";function o(o,e,t,n,r,i,c,p,d,a,l){o.reportdone2=function(e){o.$parent.closerecentreportModal(),o.$parent.closemyreportModal(),l.closeOptionButtons(),r.nextDirection("forward"),n(function(){t.go("procure_reportdone2",{reportId:e.id})},250)},o.reportdone=function(){o.$parent.closerecentreportModal(),o.$parent.closemyreportModal(),l.closeOptionButtons(),r.nextDirection("forward"),t.go("procure_reportdone")},o.downloadReport=function(o){e.show({template:'<p>Downloading...</p><ion-spinner icon="android" class="spinner-positive"></ion-spinner>'}),n(function(){e.hide(),c.alert({title:"",template:"Report has been downloaded"}).then(function(){l.closeOptionButtons()})},2e3)},o.doReportingRefresh=function(){n(function(){o.$broadcast("scroll.refreshComplete")},2e3)},o.$on("showReportInfo2",function(e,t){o.reportdone2(t.reportId)}),o.$on("showReportInfo",function(e,t){o.reportdone(t.reportId)}),o.$on("downloadReportInfo",function(e,t){o.downloadReport(t.reportId)}),a.reportId&&(o.doReportRefresh=function(){n(function(){o.$broadcast("scroll.refreshComplete")},2e3)})}angular.module("starter").controller("ProcurementReportingCtrl",o),o.$inject=["$scope","$ionicLoading","$state","$timeout","$ionicViewSwitcher","$ionicModal","$ionicPopup","$filter","localStorageService","$stateParams","$ionicListDelegate"]}();
!function(){"use strict";angular.module("starter").factory("Tasks",function(){var e=[{id:1,Title:"Network Setup",Description:"7-Eleven",Status:"High",Task:"progress",Check:"out",location:"Sydney CDB",deadline:"2016-01-01",client:"7-Eleven"},{id:2,Title:"AV-Installation",Description:"Telstra,Melbourne",Status:"Medium",Task:"progress",Check:"out",location:"Sydney CDB",deadline:"2016-01-01",client:"7-Eleven"},{id:3,Title:"Hardware Installation",Description:"Telstra,Melbourne",Status:"Low",Task:"progress",Check:"out",location:"Sydney CDB",deadline:"2016-01-01",client:"7-Eleven"},{id:4,Title:"Network Setup",Description:"7-Eleven",Status:"High",Task:"completed",Check:"out",location:"Sydney CDB",deadline:"2016-01-01",client:"7-Eleven"},{id:5,Title:"AV-Installation",Description:"Telstra,Melbourne",Status:"Medium",Task:"pending",Check:"out",location:"Sydney CDB",deadline:"2016-01-01",client:"7-Eleven"},{id:6,Title:"Hardware Installation",Description:"Telstra,Melbourne",Status:"Low",Task:"pending",Check:"out",location:"Sydney CDB",deadline:"2016-01-01",client:"7-Eleven"},{id:7,Title:"luckzuu Installation",Description:"Telstra,Melbourne",Status:"Low",Task:"",location:"Sydney CDB",deadline:"2016-01-01",client:"7-Eleven"},{id:8,Title:"luckzuu Setup",Description:"Telstra,Melbourne",Status:"Low",Task:"",location:"Sydney CDB",deadline:"2016-01-01",client:"7-Eleven"},{id:9,Title:"luckzuu Setup",Description:"Telstra,Melbourne",Status:"Low",Task:"pending",location:"Sydney CDB",deadline:"2016-01-01",client:"7-Eleven"}];return{all:function(){return e},remove:function(n){e.splice(e.indexOf(n),1)},get:function(n){for(var t=0;t<e.length;t++)if(e[t].id===parseInt(n))return e[t];return null}}}).factory("Reports",function(){var e=[{id:1,Title:"Network Setup",Description:"7-Eleven",Status:"High",location:"Sydney CDB",datecompleted:"2016-01-01",client:"7-Eleven"},{id:2,Title:"AV-Installation",Description:"Telstra,Melbourne",Status:"Medium",location:"Sydney CDB",datecompleted:"2016-01-01",client:"7-Eleven"},{id:2,Title:"Hardware-Installation",Description:"Telstra,Melbourne",Status:"Medium",location:"Sydney CDB",datecompleted:"2016-01-01",client:"7-Eleven"}];return{all:function(){return e}}}).factory("WeekDays",function(){var e=[{id:1,name:"Sunday",abbr:"SUN"},{id:2,name:"Monday",abbr:"MON"},{id:3,name:"Tuesday",abbr:"TUE"},{id:4,name:"Wednesday",abbr:"WED"},{id:5,name:"Thursday",abbr:"THU"},{id:6,name:"Friday",abbr:"FRI"},{id:7,name:"Saturday",abbr:"SAT"}];return{all:function(){return e},get:function(n){for(var t=0;t<e.length;t++)if(e[t].id===parseInt(n))return e[t];return null}}}).factory("States",function(){var e=[{id:1,code:"ACT",name:"Australian Capital Territory"},{id:2,code:"NSW",name:"New South Wales"},{id:3,code:"NT",name:"Northern Territory"},{id:4,code:"QLD",name:"Queensland"},{id:5,code:"SA",name:"South Australia"},{id:6,code:"TAS",name:"Tasmania"},{id:7,code:"VIC",name:"Victoria"},{id:8,code:"WA",name:"Western Australia"}];return{all:function(){return e},get:function(n){for(var t=0;t<e.length;t++)if(e[t].id===parseInt(n))return e[t];return null}}}).factory("Country",function(){var e=[{id:1,code:"AUS",name:"Australia"},{id:2,code:"NZ",name:"New Zealand"}];return{all:function(){return e},get:function(n){for(var t=0;t<e.length;t++)if(e[t].id===parseInt(n))return e[t];return null}}}).factory("CityState",["$http",function(e){return{all:function(n){return"ACT"==n?(console.log("state: ",n),e.get("./data/act.json").success(function(e){return e})):"NSW"==n?e.get("./data/nsw.json").success(function(e){return e}):"NT"==n?e.get("./data/nt.json").success(function(e){return e}):"QLD"==n?e.get("./data/qld.json").success(function(e){return e}):"SA"==n?e.get("./data/sa.json").success(function(e){return e}):"VIC"==n?e.get("./data/vic.json").success(function(e){return e}):"WA"==n?e.get("./data/wa.json").success(function(e){return e}):void 0},get:function(e){}}}]).factory("Banks",["$http",function(e){return{all:function(){return e.get("./data/bank.json").success(function(e){return e})},get:function(n){return e.get("./data/bank.json").success(function(e){return e})}}}]).factory("Currencies",["$http",function(e){return{all:function(){return e.get("./data/currency.json").success(function(e){return e})},get:function(n){return e.get("./data/bank.json").success(function(e){return e})}}}])}();
!function(){"use strict";angular.module("starter").directive("errSrc",function(){return{link:function(n,o,e){n.$watch(function(){return e.ngSrc},function(n){n||o.attr("src",e.errSrc)}),o.bind("error",function(){o.attr("src",e.errSrc)})}}}).directive("validNumber",function(){return{require:"?ngModel",link:function(n,o,e,t){t&&(t.$parsers.push(function(n){if(angular.isUndefined(n))var n="";var o=n.replace(/[^-0-9\.]/g,""),e=o.split("-"),i=o.split(".");return angular.isUndefined(e[1])||(e[1]=e[1].slice(0,e[1].length),o=e[0]+"-"+e[1],e[0].length>0&&(o=e[0])),angular.isUndefined(i[1])||(i[1]=i[1].slice(0,2),o=i[0]+"."+i[1]),n!==o&&(t.$setViewValue(o),t.$render()),o}),o.bind("keypress",function(n){32===n.keyCode&&n.preventDefault()}))}}}).directive("ionFloatingButton",function(){return{restrict:"E",scope:{click:"&?",buttonColor:"@?",buttonClass:"@?",icon:"@?",iconColor:"@?",hasFooter:"=?"},template:'<ul id="floating-button" ng-style="{\'bottom\' : \'{{bottomValue}}\' }"><li ng-class="buttonClass" ng-style="{\'background-color\': buttonColor }"><a ng-click="click()"><i class="icon menu-icon" ng-class="{ \'{{icon}}\' : true}" ng-style="{\'color\': iconColor }"></i></a></li></ul>',replace:!0,transclude:!0,controller:["$scope",function(n){n.buttonColor=n.buttonColor||"#2AC9AA",n.icon=n.icon||"ion-plus",n.iconColor=n.iconColor||"#fff",n.hasFooter=n.hasFooter||!1,n.hasFooter?n.bottomValue="60px":n.bottomValue="20px"}]}}).directive("ionFloatingMenu",function(){return{restrict:"E",scope:{menuOpenColor:"@?",menuOpenIcon:"@?",menuOpenIconColor:"@?",menuColor:"@?",menuIcon:"@?",menuIconColor:"@?",hasFooter:"=?"},template:'<ul id="floating-menu"  \n                            ng-style="{\'bottom\' : \'{{bottomValue}}\'}" \n                            ng-class="{\'active\' : isOpen}" \n                            ng-click="open()"><div ng-transclude></div><span><li class="menu-button icon menu-icon" ng-class="icon" ng-style="{\'background-color\' : buttonColor, \'color\': iconColor}"></li></span></ul>',replace:!0,transclude:!0,link:function(n,o,e,t,i){o.find("div").replaceWith(i())},controller:["$scope",function(n){n.isOpen=!1,n.open=function(){n.isOpen=!n.isOpen,n.isOpen?n.setOpen():n.setClose()},n.setOpen=function(){n.buttonColor=i,n.icon=r,n.iconColor=c},n.setClose=function(){n.buttonColor=o,n.icon=e,n.iconColor=t};var o=n.menuColor||"#2AC9AA",e=n.menuIcon||"ion-plus",t=n.menuIconColor||"#fff",i=n.menuOpenColor||"#2AC9AA",r=n.menuOpenIcon||"ion-minus",c=n.menuOpenIconColor||"#fff";n.setClose(),n.hasFooter=n.hasFooter||!1,n.hasFooter?n.bottomValue="60px":n.bottomValue="20px"}]}}).directive("ionFloatingItem",function(){return{restrict:"E",require:["^ionFloatingMenu"],scope:{click:"&?",icon:"@",buttonColor:"@?",buttonClass:"@?",iconColor:"@?",text:"@?",textClass:"@?"},template:'<li ng-click="click()" ng-class="buttonClass" ng-style="{\'background-color\': buttonColor }"><span ng-if="text" class="label-container"><span class="label" ng-class="textClass" ng-bind="text"></span></span><i class="icon menu-icon" ng-class="{ \'{{icon}}\' : true}" ng-style="{\'color\': iconColor }"></i></li>',replace:!0,controller:["$scope",function(n){n.buttonColor=n.buttonColor||"#2AC9AA",n.iconColor=n.iconColor||"#fff"}]}}).directive("ionProfilePicture",["$ionicTemplateLoader","$ionicBackdrop","$q","$timeout","$rootScope","$document",function(n,o,e,t,i,r){return{require:"?ngModel",restrict:"E",template:'<div class="ion-profile-picture no-picture"><input type="file" accept="image/*" capture /></div>',replace:!0,link:function(n,o,e,t){var i=angular.element(o.find("input")),r=void 0;if(!t)return console.error("ion-profile-picture:","Need to set ng-model"),!1;var c=function(n){i[0].click()},l=function(o){var e=new FileReader;e.onload=function(o){n.$apply(function(){t.$setViewValue(o.target.result),t.$render()})},r=o.target.files[0],r&&e.readAsDataURL(r)};t.$formatters.unshift(function(n){return n?n:""}),t.$parsers.unshift(function(n){return n}),t.$render=function(){var n=t.$viewValue;n?(n.match(/^data:.*?;base64,/i)||(n="data:image/jpg;base64,"+n),o.css({"background-image":"url("+n+")"}),o.removeClass("no-picture")):(o.css({"background-image":"none"}),o.addClass("no-picture"))},o.on("click",c),i.on("change",l)}}}]).directive("onValidSubmit",["$parse","$timeout",function(n,o){return{require:"^form",restrict:"A",link:function(o,e,t,i){i.$submitted=!1;var r=n(t.onValidSubmit);e.on("submit",function(n){o.$apply(function(){e.addClass("ng-submitted"),i.$submitted=!0,i.$valid&&"function"==typeof r&&r(o,{$event:n})})})}}}]).directive("validated",["$parse","ionicToast",function(n,o){return{restrict:"AEC",require:"^form",link:function(n,e,t,i){for(var r=e.find("*"),c=0,l=0;l<r.length;l++)!function(t){var r=t.attributes;if(void 0!=r.getNamedItem("ng-model")&&void 0!=r.getNamedItem("name")){var l=i[r.name.value];void 0!=l&&n.$watch(function(){return i.$submitted+"_"+l.$valid},function(){if(1==i.$submitted){var n=angular.element(t);n.hasClass("ng-invalid")?(e.removeClass("has-success"),e.addClass("has-error"),c++,c>0&&o.show("Field are required!","top",!0,2500)):e.removeClass("has-error").addClass("has-success")}})}}(r[l])}}}])}();