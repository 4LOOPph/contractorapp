...
!function(){"use strict";angular.module("starter").config(["$stateProvider",function(t){t.state("tab-procure",{url:"/tabprocure","abstract":!0,templateUrl:"templates/procurement/tabs.html",controller:"ProcurementMainCtrl"}).state("tab-procure.admindash",{url:"/admindash",views:{"tab-admindash":{templateUrl:"templates/procurement/tab-admindash.html",controller:"ProcurementDashCtrl"}}}).state("tab-procure.admintasks",{url:"/admintasks",views:{"tab-admintasks":{templateUrl:"templates/procurement/tab-admintask.html",controller:"ProcurementTasksCtrl"}}}).state("tab-procure.createtask",{url:"/createtask",views:{"tab-create-task":{templateUrl:"templates/procurement/tab-createtask.html",controller:"ProcurementTaskCtrl"}}}).state("tab-procure.adminreport",{url:"/adminreport",views:{"tab-adminreport":{templateUrl:"templates/procurement/tab-adminreport.html",controller:"ProcurementReportingCtrl"}}}).state("procure_task_detail",{url:"/procuretasks/:taskId",templateUrl:"templates/procurement/task-detail.html",controller:"ProcurementTaskCtrl"}).state("procure_reportdone2",{url:"/procurereportdone2/:reportId",templateUrl:"templates/procurement/reportdone2.html",controller:"ProcurementReportsCtrl"}).state("procure_reportdone",{url:"/procurereportdone/:reportId",templateUrl:"templates/procurement/reportdone.html",controller:"ProcurementReportsCtrl"}).state("quotelist",{url:"/quotelist/:taskId",templateUrl:"templates/procurement/quotelist.html",controller:"ProcurementQoutesCtrl"}).state("quotedetails",{url:"/quotedetails",templateUrl:"templates/procurement/qowlist.html",controller:"ChatsCtrl"}).state("approve",{url:"/approve",templateUrl:"templates/procurement/approve.html",controller:"ProcurementQoutesCtrl"}).state("editpro",{url:"/editpro",templateUrl:"templates/editvendorinfo.html",controller:"ChatsCtrl"}).state("editavailability",{url:"/editavailability",templateUrl:"templates/editavailability.html",controller:"ChatsCtrl"}).state("editrate",{url:"/editrate",templateUrl:"templates/editrate.html",controller:"ChatsCtrl"})}])}();
!function(){"use strict";function o(o,e,r,t,i,n,c,a,s,d,l){e.ready(function(){window.cordova&&window.cordova.plugins&&window.cordova.plugins.Keyboard&&(cordova.plugins.Keyboard.hideKeyboardAccessoryBar(!0),cordova.plugins.Keyboard.disableScroll(!0)),window.StatusBar&&StatusBar.styleDefault()});var t=t;t.isDesktop()&&(r.location.href="../desktop.html"),o.showPopover=function(e){o.mainPopover.show(e)},o.showPopoveredit=function(e){o.popover1.show(e)},o.myGoBack=function(){console.log("myGoBack"),n.nextDirection("back"),r.history.back()},o.signOut=function(){o.mainPopover.hide(),n.nextDirection("back"),c.remove("user"),a(function(){s.go("login")},100)},o.gotToProf=function(){i.nextViewOptions({disableBack:!0}),n.nextDirection("forward"),s.go("userprofile")},o.comptask=function(){o.$broadcast("closecompletedModal"),n.nextDirection("forward"),s.go("comptask")},o.myreportdone=function(){o.$broadcast("closemyreportModal"),n.nextDirection("forward"),s.go("reportdone")},o.gotoprog=function(e){var r=JSON.parse(c.get("user"));console.log("user: ",r.usertype),o.$broadcast("closetaskinprogressModal"),n.nextDirection("forward"),a(function(){"proc"===r.usertype?(console.log("proc: "),s.go("adminprogress")):(console.log("con: "),s.go("detailsH"))},100)},o.newTask=function(e){o.$broadcast("closetaskmodal"),n.nextDirection("forward"),a(function(){s.go("newdetails")},100)},o.gotToadminProfile=function(){o.mainPopover.hide(),n.nextDirection("forward"),s.go("adminprofile")},o.editProfile=function(){o.popover1.hide(),n.nextDirection("forward"),s.go("editpro")},o.clickCurrentin=function(){l.alert({templateUrl:"./templates/dialog/currentin.html",rootScope:o})}}angular.module("starter").run(o),o.$inject=["$rootScope","$ionicPlatform","$window","deviceDetector","$ionicHistory","$ionicViewSwitcher","localStorageService","$timeout","$state","$ionicNavBarDelegate","$ionicPopup"]}();
!function(){"use strict";function t(t,o,e,n,a,i,r,s){t.data={username:"",password:""},t.$on("$ionicView.beforeEnter",function(o,e){t.data={username:"",password:"",usertype:""},s.showBackButton(!1)}),t.inputType="password",t.showStr="show",t.hideShowPassword=function(){"password"==t.inputType?(t.inputType="text",t.showStr="hide"):(t.inputType="password",t.showStr="show")},t.login=function(r){o.nextDirection("forward"),"proc"==t.data.username&&"123456"==t.data.password?(t.data.usertype="proc",n.set("user",JSON.stringify(t.data)),console.log("tab-procure.admindash"),i(function(){e.go("tab-procure.admindash")},300)):"con"==t.data.username&&"123456"==t.data.password?(t.data.usertype="con",n.set("user",JSON.stringify(t.data)),console.log("tab.dash"),i(function(){e.go("tab.dash")},300)):a.alert({title:"Invalid Account",template:"Username and Password not match!!!"})},t.applyAsContractor=function(){o.nextDirection("forward"),e.go("vendorInfo")}}function o(t,o,e,n){t.sent=function(){n.nextViewOptions({disableBack:!0}),o.nextDirection("forward"),e.go("login")}}angular.module("starter").controller("LoginCtrl",t).controller("sentCtrl",o),o.$inject=["$scope","$ionicViewSwitcher","$state","$ionicHistory"],t.$inject=["$scope","$ionicViewSwitcher","$state","localStorageService","$ionicPopup","$timeout","$ionicHistory","$ionicNavBarDelegate"]}();
...
!function(){"use strict";function a(a,t,e,i,o,r,n,c,s,l,u,v,d,m){a.data={},a.data.availabilityArr=[],a.data.coverageArr=[],a.avail={},a.area={},a.weekdays=o.all(),a.countries=n.all(),a.cities=[],a.citiesCopy=[],a.groups=[],a.othersList=[],a.goBackLogin=function(){u.nextViewOptions({disableBack:!0}),v.nextDirection("back"),l.go("login")},a.getCountryState=function(t){"AUS"==t?a.states=r.all():a.states=[]},a.getCityState=function(t){console.log("getCityState: ",t),c.all(t).then(function(t){a.cities=t.data;var e=0;_.each(a.cities,function(t){a.citiesCopy.push({id:e,name:t.place_name,view:t.place_name}),e++})})},a.callbackMethod=function(t){if(t){var e=m("filter")(a.citiesCopy,t);return{items:e}}return{items:[]}},a.itemsClicked=function(t){a.data.check_city=t.item.name},a.addArea=function(t){t&&(a.data.coverageArr.push({area:t}),a.area.coverage="")},a.increaseHours=function(){a.time.hours=Number(a.time.hours),12==a.mainObj.format&&(12!=a.time.hours?a.time.hours+=1:a.time.hours=1),24==a.mainObj.format&&(a.time.hours=(a.time.hours+1)%24),a.time.hours=a.time.hours<10?"0"+a.time.hours:a.time.hours},a.openTime=function(t){a.data.created=new Date,s.openTimePicker({callback:function(t){var e=Math.floor(t/60/60),i=t/60%60;a.data.created.setHours(e,i);var o=(a.data.created.getHours(),e>=12?"PM":"AM");e%=12,e=e?e:12,i=i<10?"0"+i:i,a.avail.start=e+":"+i+" "+o},inputTime:60*a.data.created.getHours()*60+60*a.data.created.getMinutes(),format:12})},a.openTime2=function(){var t=new Date;s.openTimePicker({callback:function(e){var i=Math.floor(e/60/60),o=e/60%60;t.setHours(i,o);var r=(t.getHours(),i>=12?"PM":"AM");i%=12,i=i?i:12,o=o<10?"0"+o:o,a.avail.end=i+":"+o+" "+r},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},a.openTime3=function(a){var t=new Date;s.openTimePicker({callback:function(e){var i=Math.floor(e/60/60),o=e/60%60;t.setHours(i,o);var r=(t.getHours(),i>=12?"PM":"AM");i%=12,i=i?i:12,o=o<10?"0"+o:o,a.start=i+":"+o+" "+r},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},a.openTime4=function(a){var t=new Date;s.openTimePicker({callback:function(e){var i=Math.floor(e/60/60),o=e/60%60;t.setHours(i,o);var r=(t.getHours(),i>=12?"PM":"AM");i%=12,i=i?i:12,o=o<10?"0"+o:o,a.end=i+":"+o+" "+r},inputTime:60*t.getHours()*60+60*t.getMinutes(),format:12})},a.addSched=function(t){t&&(a.data.availabilityArr.push({availability:t.availability,start:t.start,end:t.end}),a.avail.availability="",a.avail.start="",a.avail.end="")},a.showCancel=function(){e.confirm({title:"",template:"Are you sure you want to cancel application?"}).then(function(a){a?(u.nextViewOptions({disableBack:!0}),v.nextDirection("back"),l.go("login")):console.log("You are not sure")})},a.vendorinf=function(t){t.$valid&&(a.avail.availability&&(a.data.availabilityArr.push({availability:a.avail.availability,start:a.avail.start,end:a.avail.end}),a.avail.availability="",a.avail.start="",a.avail.end=""),a.area.coverage&&(a.data.coverageArr.push({area:a.area.coverage}),a.area.coverage=""),d.set("vendor",JSON.stringify(a.data)),l.go("vendorRate"))}}angular.module("starter").controller("VendorInfoCtrl",a),a.$inject=["$scope","$ionicModal","$ionicPopup","$timeout","WeekDays","States","Country","CityState","ionicTimePicker","$state","$ionicHistory","$ionicViewSwitcher","localStorageService","$filter"]}();
...
!function(){"use strict";function o(o,e,t,n,i,r,s,u,c,a){o.data={},o.others={},o.groups=[],o.othersList=[],o.filenames=[],a.showBackButton(!0);for(var l=0;l<1;l++){o.groups[l]={name:l,items:[]};for(var p=0;p<1;p++)o.groups[l].items.push(l+"-"+p)}o.toggleGroup=function(e){o.isGroupShown(e)?o.shownGroup=null:o.shownGroup=e},o.isGroupShown=function(e){return o.shownGroup===e},o.removeOther=function(e){o.othersList.splice(e,1)},o.addOthers=function(e){_.isEmpty(e)||(o.othersList.push(e),o.others={})},o.uploadFiles=function(e){var t=e.files,i=[];for(l=0;l<t.length;l++)i.push(t[l].name);o.files=t,n(function(){o.$apply(function(){o.filenames=i})},10),console.log(t,i)},o.removetest=function(e){o.filenames.splice(e,1)},o.showCancel=function(){t.confirm({title:"",template:"Are you sure you want to cancel application?"}).then(function(o){o?(r.nextViewOptions({disableBack:!0}),s.nextDirection("back"),i.go("login")):console.log("You are not sure")})},o.showConfirm=function(){t.confirm({title:"",template:"Are you sure you want to submit application?"}).then(function(o){o?(r.nextViewOptions({disableBack:!0}),s.nextDirection("forward"),i.go("sent")):console.log("You are not sure")})}}angular.module("starter").controller("VendorQualificationCtrl",o),o.$inject=["$scope","$ionicModal","$ionicPopup","$timeout","$state","$ionicHistory","$ionicViewSwitcher","localStorageService","$filter","$ionicNavBarDelegate"]}();
