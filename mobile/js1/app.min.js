...
!function(){"use strict";angular.module("starter",["ionic","ionic-timepicker","ng.deviceDetector","ngMask","ngDialog","ngFileUpload","angularFileUpload"]).run(["$ionicPlatform","$window","deviceDetector",function(t,o,e){t.ready(function(){window.cordova&&window.cordova.plugins&&window.cordova.plugins.Keyboard&&(cordova.plugins.Keyboard.hideKeyboardAccessoryBar(!0),cordova.plugins.Keyboard.disableScroll(!0)),window.StatusBar&&StatusBar.styleDefault()});var e=e;console.log("deviceDetector: ",e),e.isDesktop()&&(o.location.href="../desktop.html")}]).config(["$stateProvider","$urlRouterProvider","ionicTimePickerProvider","$ionicConfigProvider",function(t,o,e,n){var l={inputTime:60*(new Date).getHours()*60+60*(new Date).getMinutes(),format:12,step:15,setLabel:"Set",closeLabel:"Close"};e.configTimePicker(l),n.backButton.text("").icon("ion-ios-arrow-left"),n.tabs.position("bottom"),t.state("login",{url:"/login",templateUrl:"templates/login.html",controller:"LoginCtrl"}).state("vendorInfo",{url:"/vendorInfo",templateUrl:"templates/vendorInfo.html",controller:"AccountCtrl"}).state("vendorcontactInfo",{url:"/vendorcontactinfo",templateUrl:"templates/vendorcontactinfo.html"}).state("vendorRate",{url:"/vendorrate",templateUrl:"templates/vendorRate.html",controller:"AccountCtrl"}).state("sent",{url:"/sent",templateUrl:"templates/sent.html",controller:"AccountCtrl"}).state("qualification",{url:"/qualification",templateUrl:"templates/qualification.html",controller:"AccountCtrl"}).state("certification",{url:"/certification",templateUrl:"templates/certification.html"}).state("certifications",{url:"/certifications",templateUrl:"templates/certifications.html"}).state("tab",{url:"/tab","abstract":!0,templateUrl:"templates/tabs.html"}).state("tab.dash",{url:"/dash",views:{"tab-dash":{templateUrl:"templates/tab-dash.html",controller:"DashCtrl"}}}).state("tab.tasks",{url:"/tasks",views:{"tab-tasks":{templateUrl:"templates/tab-tasks.html",controller:"ChatsCtrl"}}}).state("tab.task-detail",{url:"/tasks/:chatId",views:{"tab-tasks":{templateUrl:"templates/task-detail.html",controller:"ChatDetailCtrl"}}}).state("tab.account",{url:"/account",views:{"tab-account":{templateUrl:"templates/tab-account.html",controller:"AccountCtrl"}}}),o.otherwise("/login")}]).directive("ionFloatingButton",function(){return{restrict:"E",scope:{click:"&?",buttonColor:"@?",buttonClass:"@?",icon:"@?",iconColor:"@?",hasFooter:"=?"},template:'<ul id="floating-button" ng-style="{\'bottom\' : \'{{bottomValue}}\' }"><li ng-class="buttonClass" ng-style="{\'background-color\': buttonColor }"><a ng-click="click()"><i class="icon menu-icon" ng-class="{ \'{{icon}}\' : true}" ng-style="{\'color\': iconColor }"></i></a></li></ul>',replace:!0,transclude:!0,controller:["$scope",function(t){t.buttonColor=t.buttonColor||"#2AC9AA",t.icon=t.icon||"ion-plus",t.iconColor=t.iconColor||"#fff",t.hasFooter=t.hasFooter||!1,t.hasFooter?t.bottomValue="60px":t.bottomValue="20px"}]}}).directive("ionFloatingMenu",function(){return{restrict:"E",scope:{menuOpenColor:"@?",menuOpenIcon:"@?",menuOpenIconColor:"@?",menuColor:"@?",menuIcon:"@?",menuIconColor:"@?",hasFooter:"=?"},template:'<ul id="floating-menu"  \n                            ng-style="{\'bottom\' : \'{{bottomValue}}\'}" \n                            ng-class="{\'active\' : isOpen}" \n                            ng-click="open()"><div ng-transclude></div><span><li class="menu-button icon menu-icon" ng-class="icon" ng-style="{\'background-color\' : buttonColor, \'color\': iconColor}"></li></span></ul>',replace:!0,transclude:!0,link:function(t,o,e,n,l){o.find("div").replaceWith(l())},controller:["$scope",function(t){t.isOpen=!1,t.open=function(){t.isOpen=!t.isOpen,t.isOpen?t.setOpen():t.setClose()},t.setOpen=function(){t.buttonColor=l,t.icon=a,t.iconColor=r},t.setClose=function(){t.buttonColor=o,t.icon=e,t.iconColor=n};var o=t.menuColor||"#2AC9AA",e=t.menuIcon||"ion-plus",n=t.menuIconColor||"#fff",l=t.menuOpenColor||"#2AC9AA",a=t.menuOpenIcon||"ion-minus",r=t.menuOpenIconColor||"#fff";t.setClose(),t.hasFooter=t.hasFooter||!1,t.hasFooter?t.bottomValue="60px":t.bottomValue="20px"}]}}).directive("ionFloatingItem",function(){return{restrict:"E",require:["^ionFloatingMenu"],scope:{click:"&?",icon:"@",buttonColor:"@?",buttonClass:"@?",iconColor:"@?",text:"@?",textClass:"@?"},template:'<li ng-click="click()" ng-class="buttonClass" ng-style="{\'background-color\': buttonColor }"><span ng-if="text" class="label-container"><span class="label" ng-class="textClass" ng-bind="text"></span></span><i class="icon menu-icon" ng-class="{ \'{{icon}}\' : true}" ng-style="{\'color\': iconColor }"></i></li>',replace:!0,controller:["$scope",function(t){t.buttonColor=t.buttonColor||"#2AC9AA",t.iconColor=t.iconColor||"#fff"}]}})}();
!function(){"use strict";angular.module("starter").controller("DashCtrl",["$scope","$ionicPopover",function(o,t){t.fromTemplateUrl("../mobile/templates/dialog/submit.html",{scope:o}).then(function(t){o.popover=t}),o.demo="ios",o.setPlatform=function(t){document.body.classList.remove("platform-ios"),document.body.classList.remove("platform-android"),document.body.classList.add("platform-"+t),o.demo=t}}]).controller("ChatsCtrl",["$scope","Chats",function(o,t){o.$on("$ionicView.enter",function(e){o.progressData=[],o.pendingData=[],o.completedData=[],o.chats=t.all(),_.each(o.chats,function(t){"progress"==t.status?o.progressData.push(t):"pending"==t.status?o.pendingData.push(t):"completed"==t.status&&o.completedData.push(t)}),console.log("$scope.progressData: ",o.progressData),console.log("$scope.pendingData: ",o.pendingData),console.log("$scope.completedData: ",o.completedData)})}]).controller("ChatDetailCtrl",["$scope","$stateParams","Chats",function(o,t,e){console.log("ChatDetailCtrl "),o.chat=e.get(t.chatId)}]).controller("HomeCtrl",["$scope","ionicTimePicker",function(o,t){}])}();
